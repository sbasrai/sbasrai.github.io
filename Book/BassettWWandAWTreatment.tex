...
\node[inner sep=0pt] (background) at (current page.center) {\includegraphics[width=\paperwidth]{BassettCoverWWT.png}};
%
...
\noindent \textit{Revision Date: February 2023} % Printing/edition date
