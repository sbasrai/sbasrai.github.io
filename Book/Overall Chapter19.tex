\chapterimage{OCSDHeadworksScrubbers.jpg} % Chapter heading image
...
\begin{center}
\includegraphics[scale=.75]{OdorControl}
\end{center}
\section{Liquid phase odor control}\index{Liquid phase odor control}
\begin{itemize}
...
\section{Vapor phase odor control}\index{Vapor phase odor control}
\begin{itemize}
...
\begin{center}
\includegraphics[scale=1]{OdorPackedTowerScrubber1}\\
...
\includegraphics[scale=0.3]{AmmoniaAmmoniumEquilibrium}\\
