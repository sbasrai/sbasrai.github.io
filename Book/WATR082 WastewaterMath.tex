...
\chapter{Units and Unit Conversion}
...
\chapter{Process Removal Efficiency}
...
% \end{snugshade*}
\section{Calculating volume pumped given the pump flow rate}\index{Calculating volume pumped given the pump flow rate}
...
\end{itemize}
\section{Calculating time to pump a certain volume}\index{Calculating time to pump a certain volume}
% \begin{snugshade*}
