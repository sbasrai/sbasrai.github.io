...
\input{WaterTreatment Structure Weekly.tex} % Insert the commands.tex file which contains the majority of the structure behind the template
...
\input{Water Math Week 1.tex}
\input{Week1 Assessment.tex}
\part{Week 2}
\input{Water Properties and Laboratory Analysis.tex}
\input{Water Math Week 2.tex}
\input{Week2 Assessment.tex}
\part{Week 3}
\input{Water Regulations Revised2.tex}
\input{Water Math Week 3.tex}
\input{Week3 Assessment.tex}
\part{Week 4}
\input{Water Treatment1.tex}
\input{Water Disinfection.tex}
\input{Water Math Week 4.tex}
\input{Week4 Assessment.tex}
\part{Week 5}
\input{Pumping Systems.tex}
\input{Water Math Week 5.tex}
\input{Week5 Assessment.tex}
\part{Week 6}
\input{Water Distribution1.tex}
\input{Water Safety.tex}
\input{Week6 Assessment.tex}
\input{WaterTreatmentandDistributionWeeklyAssessmentSolutions.tex}
\end{document}
