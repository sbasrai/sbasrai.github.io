...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(x,u){return"function"==typeof x?function(t){try{m(x(t))}catch(r){q(r)}}:u}var m,q,p=new f(function(x,u){m=x;q=u});this.callWhenSettled_(l(h,m),l(k,q));return p};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
q){function p(t){return function(r){x[t]=r;u--;0==u&&m(x)}}var x=[],u=0;do x.push(void 0),u++,d(l.value).callWhenSettled_(p(x.length-1),q),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
58:58:phoneTemplateArea.getBottomHeight():0},getHeight:function(){return this.getTopHeight()+this.getBottomHeight()},getWidth:function(){return this.getLeftWidth()+this.getRightWidth()}};/*
...
"{anonymous}()@"):"Unknown Stack Trace";var E=b.console&&(b.console.warn||b.console.log);E&&E.call(b.console,B,C);return n.apply(this,arguments)}}function l(n,w,y){w=w.prototype;var B=n.prototype=Object.create(w);B.constructor=n;B._super=w;y&&Z(B,y)}function m(n,w){return function(){return n.apply(w,arguments)}}function q(n,w){return"function"==typeof n?n.apply(w?w[0]||e:e,w):n}function p(n,w,y){h(t(w),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,y,!1):n.attachEvent(B,y)})}
function x(n,w,y){h(t(w),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,y,!1):n.detachEvent(B,y,!1)})}function u(n,w){for(;n;){if(n==w)return!0;n=n.parentNode}return!1}function t(n){return n.trim().split(/\s+/g)}function r(n,w,y){if(n.indexOf&&!y)return n.indexOf(w);for(var B=0;B<n.length;){if(y&&n[B][y]==w||!y&&n[B]===w)return B;B++}return-1}function v(n){return Array.prototype.slice.call(n,0)}function z(n,w,y){for(var B=[],C=[],E=0;E<n.length;){var H=w?n[E][w]:n[E];
0>r(C,H)&&B.push(n[E]);C[E]=H;E++}y&&(B=w?B.sort(function(N,V){return N[w]>V[w]}):B.sort());return B}function A(n,w){if(w&&w[0]){for(var y,B=w[0].toUpperCase()+w.slice(1),C=0;C<sa.length;){y=(y=sa[C])?y+B:w;if(y in n)return y;C++}return e}}function F(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function D(n,w){var y=this;this.manager=n;this.callback=w;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){q(n.options.enable,[n])&&y.handler(B)};this.init()}
...
this.evTarget,this.domHandler);this.evWin&&p(F(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&x(this.element,this.evEl,this.domHandler);this.evTarget&&x(this.target,this.evTarget,this.domHandler);this.evWin&&x(F(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},Aa="mousedown",Ba="mousemove mouseup";l(J,D,{handler:function(n){var w=Ja[n.type];w&1&&0===n.button&&(this.pressed=!0);w&2&&1!==n.which&&(w=4);this.pressed&&(w&4&&(this.pressed=
...
n.pointerType,E="touch"==C,H=r(w,n.pointerId,"pointerId");B&1&&(0===n.button||E)?0>H&&(w.push(n),H=w.length-1):B&12&&(y=!0);0>H||(w[H]=n,this.callback(this.manager,B,{pointers:w,changedPointers:[n],pointerType:C,srcEvent:n}),y&&w.splice(H,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(U,D,{handler:function(n){var w=Ma[n.type];1===w&&(this.started=!0);if(this.started){var y=v(n.touches);var B=v(n.changedTouches);w&12&&(y=z(y.concat(B),"identifier",!0));y=[y,B];w&12&&0===y[0].length-
...
n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var w=this.simultaneous;n=aa(n,this);w[n.id]||(w[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=aa(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;var w=this.requireFail;n=aa(n,this);-1===r(w,n)&&(w.push(n),n.requireFailure(this));
return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=aa(n,this);n=r(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function w(C){y.manager.emit(C,n)}var y=this,B=this.state;8>B&&w(y.options.event+ja(B));w(y.options.event);n.additionalEvent&&w(n.additionalEvent);8<=B&&w(y.options.event+ja(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);
this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=Z({},n);q(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};l(R,P,{defaults:{pointers:1},attrTest:function(n){var w=this.options.pointers;return 0===w||n.pointers.length===w},
...
Recognizer:P,AttrRecognizer:R,Tap:la,Pan:fa,Swipe:ca,Pinch:ka,Rotate:X,Press:ba,on:p,off:x,each:h,merge:Ga,extend:xa,assign:Z,inherit:l,bindFn:m,prefixed:A});("undefined"!==typeof b?b:"undefined"!==typeof self?self:{}).Hammer=Y;"function"===typeof define&&define.amd?define(function(){return Y}):"undefined"!=typeof module&&module.exports?module.exports=Y:b[d]=Y})(window,document,"Hammer");
...
f.parameters.zoomFlag=!1;f.parameters.zoomOut=!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,q=0,p=0;f.animateInterval=function(x,u){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,f.parameters.height*
(g-1),20);q=$.easing.swing(null,m,f.parameters.left,f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);p=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:q+"px",top:p+"px"});for(var t=0;t<f.side.pageArray.length;t++)if(f.side.pageArray[t])f.side.pageArray[t].onResize(k/2,l);m++;if(20<=m||x>=u){f.animateInterval.stop();
...
100;var q=e*h,p=e*k,x=0,u=0,t=0,r=0;toolBar&&(x=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,u=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,t=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,r=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(q>windowWidth){var v=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-r;l=-l-h*e*d.parameters.zoomArea.left/100+t}else v=-l-h*e*d.parameters.zoomArea.left/100+t,l=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-
r;p>windowHeight?(h=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-u,d=-m-k*e*d.parameters.zoomArea.top/100+x):(h=-m-k*e*d.parameters.zoomArea.top/100+x,d=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-u);g=Number.between(g,v,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
...
$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(q,p){m(q,p,"Sine")}).animation(this,300)}.bind(this),m=function(q,p,x){if(q<p){x=k(null,q,this.parameters.tran.x,e.x-this.parameters.tran.x,p);var u=k(null,q,this.parameters.tran.y,e.y-this.parameters.tran.y,p);q=k(null,q,this.parameters.scale,d-this.parameters.scale,p);p={};p.scale=
q;p.tran={x:x,y:u};x=transformCSS(p);this.css(x)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(q){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=
...
$.fn.changeButtonColor=function(b,c,d){var e=this;if("none"!=this.css("display")){var f=this;0<this.children().length&&(f=this.find("img:first"));if(window.ActiveXObject){if("complete"!=f[0].readyState){$(f).on("load",function(){try{e.changeButtonColor(b,c,d)}catch(r){}});return}}else if(!f[0].complete){$(f).on("load",function(){try{e.changeButtonColor(b,c,d)}catch(r){}});return}if(void 0!=f[0]){try{var g=$("<canvas></canvas>")[0];var h=g.getContext("2d")}catch(r){return}var k=f.width(),l=f.height();
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),q=getHost();if(m&&q!==m){if(g=f.src.replace(m,q),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(r){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var p=h.getImageData(0,0,k,l),x=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&p){var u=Color(b).split();k=0;for(var t=p.data.length;k<t;k+=4)0<x.data[k+3]&&(p.data[k]!=u.r&&(x.data[k]=p.data[k]/255*u.r),p.data[k+1]!=u.g&&(x.data[k+1]=
p.data[k+1]/255*u.g),p.data[k+2]!=u.b&&(x.data[k+2]=p.data[k+2]/255*u.b));h.putImageData(x,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(r){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(v){}})}}}}};
...
$.fn.speed=function(b){function c(t){t=void 0==t.originalEvent.touches?[t]:t.originalEvent.touches;if(1<t.length)return p=!0;f=h=t[0].pageX;g=k=t[0].pageY;l=new Date;-1!=q&&window.clearInterval(q);q=window.setInterval(function(){f=h;g=k;l=new Date},300)}function d(t){if(-1==q||1==p)return!0;t=void 0==t.originalEvent.touches?[t]:t.originalEvent.touches;h=t[0].pageX;k=t[0].pageY}function e(t){if(-1==q)return!0;t=void 0!=t.originalEvent.touches==0?[t]:t.originalEvent.touches;if(1==p)return p=1<t.length,
!0;m=new Date;t=(m-l)/20;var r=h-f,v=k-g;0==t?u=x=0:(x=r/t,u=v/t);void 0!=b&&b(x,u);window.clearInterval(q);q=-1}var f,g,h,k,l,m,q=-1,p=!1,x=0,u=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(t){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(t){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",q=-1,p,x,u,t=k.length-l;++q<t;)p=k.charCodeAt(q)<<
16,x=k.charCodeAt(++q)<<8,u=k.charCodeAt(++q),p=p+x+u,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p&63);2==l?(p=k.charCodeAt(q)<<8,x=k.charCodeAt(++q),p+=x,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p<<2&63)+"="):1==l&&(p=k.charCodeAt(q),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,q,p,x="",u=-1;++u<l;)p="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(u)),
q=m%4?64*q+p:p,m++%4&&(x+=String.fromCharCode(255&q>>(-2*m&6)));return x},version:"0.1.0"};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return g});else if(c&&!c.nodeType)if(d)d.exports=g;else for(var h in g)g.hasOwnProperty(h)&&(c[h]=g[h]);else b.base64=g})(this);function parsHexToNormalString(b){for(var c="";2<=b.length;)c+=String.fromCharCode(parseInt(b.substring(0,2),16)),b=b.substring(2,b.length);return c}
...
(function(b){function c(u,t){var r=(u&65535)+(t&65535);return(u>>16)+(t>>16)+(r>>16)<<16|r&65535}function d(u,t,r,v,z,A){u=c(c(t,u),c(v,A));return c(u<<z|u>>>32-z,r)}function e(u,t,r,v,z,A,F){return d(t&r|~t&v,u,t,z,A,F)}function f(u,t,r,v,z,A,F){return d(t&v|r&~v,u,t,z,A,F)}function g(u,t,r,v,z,A,F){return d(r^(t|~v),u,t,z,A,F)}function h(u,t){u[t>>5]|=128<<t%32;u[(t+64>>>9<<4)+14]=t;var r=1732584193,v=-271733879,z=-1732584194,A=271733878;for(t=0;t<u.length;t+=16){var F=r;var D=v;var L=z;var M=A;
r=e(r,v,z,A,u[t],7,-680876936);A=e(A,r,v,z,u[t+1],12,-389564586);z=e(z,A,r,v,u[t+2],17,606105819);v=e(v,z,A,r,u[t+3],22,-1044525330);r=e(r,v,z,A,u[t+4],7,-176418897);A=e(A,r,v,z,u[t+5],12,1200080426);z=e(z,A,r,v,u[t+6],17,-1473231341);v=e(v,z,A,r,u[t+7],22,-45705983);r=e(r,v,z,A,u[t+8],7,1770035416);A=e(A,r,v,z,u[t+9],12,-1958414417);z=e(z,A,r,v,u[t+10],17,-42063);v=e(v,z,A,r,u[t+11],22,-1990404162);r=e(r,v,z,A,u[t+12],7,1804603682);A=e(A,r,v,z,u[t+13],12,-40341101);z=e(z,A,r,v,u[t+14],17,-1502002290);
v=e(v,z,A,r,u[t+15],22,1236535329);r=f(r,v,z,A,u[t+1],5,-165796510);A=f(A,r,v,z,u[t+6],9,-1069501632);z=f(z,A,r,v,u[t+11],14,643717713);v=f(v,z,A,r,u[t],20,-373897302);r=f(r,v,z,A,u[t+5],5,-701558691);A=f(A,r,v,z,u[t+10],9,38016083);z=f(z,A,r,v,u[t+15],14,-660478335);v=f(v,z,A,r,u[t+4],20,-405537848);r=f(r,v,z,A,u[t+9],5,568446438);A=f(A,r,v,z,u[t+14],9,-1019803690);z=f(z,A,r,v,u[t+3],14,-187363961);v=f(v,z,A,r,u[t+8],20,1163531501);r=f(r,v,z,A,u[t+13],5,-1444681467);A=f(A,r,v,z,u[t+2],9,-51403784);
z=f(z,A,r,v,u[t+7],14,1735328473);v=f(v,z,A,r,u[t+12],20,-1926607734);r=d(v^z^A,r,v,u[t+5],4,-378558);A=d(r^v^z,A,r,u[t+8],11,-2022574463);z=d(A^r^v,z,A,u[t+11],16,1839030562);v=d(z^A^r,v,z,u[t+14],23,-35309556);r=d(v^z^A,r,v,u[t+1],4,-1530992060);A=d(r^v^z,A,r,u[t+4],11,1272893353);z=d(A^r^v,z,A,u[t+7],16,-155497632);v=d(z^A^r,v,z,u[t+10],23,-1094730640);r=d(v^z^A,r,v,u[t+13],4,681279174);A=d(r^v^z,A,r,u[t],11,-358537222);z=d(A^r^v,z,A,u[t+3],16,-722521979);v=d(z^A^r,v,z,u[t+6],23,76029189);r=d(v^
z^A,r,v,u[t+9],4,-640364487);A=d(r^v^z,A,r,u[t+12],11,-421815835);z=d(A^r^v,z,A,u[t+15],16,530742520);v=d(z^A^r,v,z,u[t+2],23,-995338651);r=g(r,v,z,A,u[t],6,-198630844);A=g(A,r,v,z,u[t+7],10,1126891415);z=g(z,A,r,v,u[t+14],15,-1416354905);v=g(v,z,A,r,u[t+5],21,-57434055);r=g(r,v,z,A,u[t+12],6,1700485571);A=g(A,r,v,z,u[t+3],10,-1894986606);z=g(z,A,r,v,u[t+10],15,-1051523);v=g(v,z,A,r,u[t+1],21,-2054922799);r=g(r,v,z,A,u[t+8],6,1873313359);A=g(A,r,v,z,u[t+15],10,-30611744);z=g(z,A,r,v,u[t+6],15,-1560198380);
v=g(v,z,A,r,u[t+13],21,1309151649);r=g(r,v,z,A,u[t+4],6,-145523070);A=g(A,r,v,z,u[t+11],10,-1120210379);z=g(z,A,r,v,u[t+2],15,718787259);v=g(v,z,A,r,u[t+9],21,-343485551);r=c(r,F);v=c(v,D);z=c(z,L);A=c(A,M)}return[r,v,z,A]}function k(u){var t,r="",v=32*u.length;for(t=0;t<v;t+=8)r+=String.fromCharCode(u[t>>5]>>>t%32&255);return r}function l(u){var t,r=[];r[(u.length>>2)-1]=void 0;for(t=0;t<r.length;t+=1)r[t]=0;var v=8*u.length;for(t=0;t<v;t+=8)r[t>>5]|=(u.charCodeAt(t/8)&255)<<t%32;return r}function m(u){return k(h(l(u),
8*u.length))}function q(u,t){var r=l(u),v=[],z=[];v[15]=z[15]=void 0;16<r.length&&(r=h(r,8*u.length));for(u=0;16>u;u+=1)v[u]=r[u]^909522486,z[u]=r[u]^1549556828;t=h(v.concat(l(t)),512+8*t.length);return k(h(z.concat(t),640))}function p(u){var t="",r;for(r=0;r<u.length;r+=1){var v=u.charCodeAt(r);t+="0123456789abcdef".charAt(v>>>4&15)+"0123456789abcdef".charAt(v&15)}return t}function x(u,t,r){t?r?u=q(unescape(encodeURIComponent(t)),unescape(encodeURIComponent(u))):(u=q(unescape(encodeURIComponent(t)),
unescape(encodeURIComponent(u))),u=p(u)):u=r?m(unescape(encodeURIComponent(u))):p(m(unescape(encodeURIComponent(u))));return u}"function"===typeof define&&define.amd?define(function(){return x}):"object"===typeof module&&module.exports?module.exports=x:b.md5=x})(this);String.prototype.MD5=function(b){return md5(this)};
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this;k=d(h);var m=void 0!==k&&null!==k?k:"__default__";e[m]&&clearTimeout(e[m]);return new Promise(function(q,p){f[m]||(f[m]=[]);f[m].push({resolve:q,reject:p});e[m]=setTimeout(function(){var x,u,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){switch(r.nextAddress){case 1:return x=f[m],r.setCatchFinallyBlocks(2,3),r.yield(b.apply(l,
h),5);case 5:u=r.yieldResult,x&&x.forEach(function(v){return v.resolve(u)});case 3:r.enterFinallyBlock();delete e[m];delete f[m];r.leaveFinallyBlock(0);break;case 2:t=r.enterCatchBlock(),x&&x.forEach(function(v){return v.reject(t)}),r.jumpTo(3)}})},c)})}}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d",{willReadFrequently:!0});l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var q=m.getImageData(0,0,l.width,l.height),p=q.data,x=c?e(c):null,u=d?e(d):{r:0,g:0,b:0,a:0},t=0;t<p.length;t+=4){var r=p[t+3];0===r?(p[t]=u.r,p[t+1]=u.g,p[t+2]=u.b,p[t+3]=void 0!==u.a?u.a:0):0<r&&255>r?x&&(p[t]=Math.round((x.r*r+u.r*(255-r))/255),p[t+1]=Math.round((x.g*r+u.g*(255-r))/255),p[t+2]=Math.round((x.b*r+u.b*(255-r))/255),
p[t+3]=255):x&&(p[t]=x.r,p[t+1]=x.g,p[t+2]=x.b,p[t+3]=void 0!==x.a?x.a:255)}m.putImageData(q,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}var getRandomColor=function(){return"#"+Math.floor(1118481+14540253*Math.random()).toString(16)};function normalizeUrl(b){return b&&"string"===typeof b?b.replace(/\\\//g,"/"):b}
...
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(p,x){var u=c();try{var t=x&&"object"===typeof x?Object.assign({},x):x;if(t&&"object"===typeof t){t.page=Number(p+1);var r=u[p];r&&r.positions&&t.positions?t.positions=r.positions.concat(t.positions):r&&r.positions&&(t.positions=r.positions);null!=l?t.realPage=Number(l):r&&r.realPage&&(t.realPage=r.realPage);r&&Object.keys(r).forEach(function(v){"page"===v||"realPage"===v||"positions"===
v||v in t||(t[v]=r[v])})}u[p]=t;return!0}catch(v){return console.error("writeToTarget error",v),!1}}function e(p,x,u){if(!p||0===p.length)return null;for(var t=p[0].left,r=p[0].top,v=p[0].right,z=p[0].bottom,A="",F=0;F<p.length;F++){var D=p[F];t=Math.min(t,D.left);r=Math.min(r,D.top);v=Math.max(v,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=t/x;r/=u;v/=x;u=z/u;u=[F,u,v,u,v,r,F,r];z=[];for(F=0;F<p.length;F++)z.push(p[F].width/x);if(!A||0===A.trim().length)return null;p=u.concat(z);return{w:A,p:p}}
function f(p){b._pageReaderExtracted||(b._pageReaderExtracted={});p=Array.isArray(p)?p:[p];for(var x=0,u=0;u<p.length;u++){var t=p[u];if(t&&!(1>t)&&!b._pageReaderExtracted[t])if(b._pageReaderExtracted[t]=!0,window._getPage&&"function"===typeof window._getPage)try{var r=window._getPage(t-1);if(r){var v=null;if(r.items&&Array.isArray(r.items)){v=r.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<v.length;D++){var L=v[D];if(L&&"text"===L.type&&
...
la)}else console.warn("PageTextExtractor: window._getPage \u65b9\u6cd5\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u63d0\u53d6\u6587\u672c\u914d\u7f6e")}return x}function g(p){var x,u,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(!p||1>p)return r.return(!1);b._positionScriptLoaded||(b._positionScriptLoaded={});b._positionScriptLoadPromises||(b._positionScriptLoadPromises={});x=b.getSearchRealPageIndex(p);if(0>=x||-1===x||b._positionScriptLoaded[x])return r.return(!1);if(u=b._positionScriptLoadPromises[x])return r.return(u);
t=function(){var v,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.setCatchFinallyBlocks(2,3),v=String.format(bookConfig.searchPositionJS,x),1<x&&(v=v.replace("[1]","["+x+"]")),z=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi,A=/\.*\/?(\w+\/)*\w+?\.js/gi,v.match(z)||v.match(A)?D.yield(getArticleImage(fixURLValue(v)),5):D.return(!1);case 5:return(v=D.yieldResult)?D.yield(h(p,v,x),6):D.return(!1);case 6:return b._positionScriptLoaded[x]=!0,D.return(!0);
case 3:D.enterFinallyBlock();delete b._positionScriptLoadPromises[x];D.leaveFinallyBlock(0);break;case 2:return F=D.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),D.return(!1)}})}();b._positionScriptLoadPromises[x]=t;return r.return(t)})}function h(p,x,u){var t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){t=function(){var v,z,A,F,D,L,M,I;return $jscomp.asyncExecutePromiseGeneratorProgram(function(G){switch(G.nextAddress){case 1:k=p;l=u;if(v=
"undefined"!==typeof location&&"file:"===location.protocol){G.jumpTo(2);break}G.setCatchFinallyBlocks(3);return G.yield(fetch(x),5);case 5:z=G.yieldResult;if(!z.ok){console.warn("fetch returned non-ok",z.status,x);G.jumpTo(6);break}return G.yield(z.text(),7);case 7:return A=G.yieldResult,F=A.match(/positionForPages\[(\d+)\]/),D=A,F&&(D=D.replace(new RegExp("positionForPages\\["+F[1]+"\\]","g"),"positionForPages["+(p-1)+"]")),D=D.replace(/("page"\s*:\s*)"?\d+"?/g,"$1"+p),L="undefined"!==typeof window?
window:"undefined"!==typeof b?b:null,L&&L.document?G.yield(new Promise(function(O,K){var J="";try{var Q=new Blob([D],{type:"application/javascript;charset=utf-8"});J=URL.createObjectURL(Q)}catch(U){l=k=null;K(U);return}Q=L.document.createElement("script");Q.dataset.positionSource=x;Q.onload=function(){if(J)try{URL.revokeObjectURL(J)}catch(U){}setTimeout(function(){l=k=null;O()},0)};Q.onerror=function(){if(J)try{URL.revokeObjectURL(J)}catch(U){}l=k=null;K(Error("Blob script load failed: "+x))};Q.src=
...
x;J.onload=function(){setTimeout(function(){l=k=null;O()},0)};J.onerror=function(Q){l=k=null;console.log("Script load failed:",x,Q);K(Error("Script load failed: "+x))};J.src=x;I.document.head.appendChild(J)}),0):(console.log("\u65e0\u6cd5\u627e\u5230 window \u6216 global \u5bf9\u8c61"),G.return())}})};m=m.then(function(){return t()}).catch(function(v){console.log("queue error:",v&&v.message)});return r.return(m)})}"undefined"!==typeof b&&null==b.pageTextPositions&&(b.pageTextPositions=[]);var k=null,
l=null,m=Promise.resolve(),q=new Proxy({},{get:function(p,x){var u=c();return"string"===typeof x&&/^\d+$/.test(x)?u[Number(x)]:"length"===x?u.length:"function"===typeof Array.prototype[x]?Array.prototype[x].bind(u):p[x]},set:function(p,x,u){return"string"===typeof x&&/^\d+$/.test(x)?(p=Number(x),null!=k?d(k-1,u):d(p,u),!0):!1},has:function(p,x){var u=c();return"string"===typeof x&&/^\d+$/.test(x)?Number(x)in u:x in p},ownKeys:function(){var p=c();return Object.keys(p).concat(Object.getOwnPropertyNames(Object.prototype))},
getOwnPropertyDescriptor:function(p,x){var u=c();return"string"===typeof x&&/^\d+$/.test(x)?{configurable:!0,enumerable:!0,value:u[Number(x)],writable:!0}:Object.getOwnPropertyDescriptor(p,x)}});"undefined"!==typeof window?Object.defineProperty(window,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q}):"undefined"!==typeof b&&Object.defineProperty(b,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q});"undefined"!==typeof b&&null==b._positionScriptLoadPromises&&
(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(p){var x,u,t,r,v,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),x=Array.isArray(p)?p:[p],u=[],t=!1,r=0;case 2:if(!(r<x.length)){D.jumpTo(4);break}v=x[r];if(!v||1>v){D.jumpTo(3);break}z={pageIndex:v,hasText:!1,
positionCount:0};D.setCatchFinallyBlocks(5);return D.yield(g(v),7);case 7:b._pageReaderExtracted[v]||f(v);(A=c()[v-1])&&A.page===v&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,t=!0);D.leaveTryBlock(6);break;case 5:F=D.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+v+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:u.push(z);case 3:r++;D.jumpTo(2);break;case 4:return D.return({hasText:t,pageResults:u})}})};
b.hasPageText=function(p){b.pageTextPositions||(b.pageTextPositions=[]);var x=!Array.isArray(p),u=[],t=!1;p=$jscomp.makeIterator(x?[p]:p);for(var r=p.next();!r.done;r=p.next())if(r=r.value,!r||1>r)x||u.push({pageIndex:r,hasText:!1,positionCount:0});else{var v={pageIndex:r,hasText:!1,positionCount:0},z=r-1;(z=c()[z])&&z.page===r&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(v.hasText=!0,v.positionCount=z.positions.length,t=!0);if(x)return v.hasText;u.push(v)}return{hasText:t,pageResults:u}};
...
function isRecastiaDomain(){return/recastia/i.test(window.location.hostname)}function isRecastiaFreeUser(){var b;return 0===Number(null==(b=window.userInfo)?void 0:b.c)}function getRecastiaAppLogoIcon(){return"https://"+(/test|dev/.test(window.location.hostname)?"test.recastia.net":"recastia.net")+"/resourceFiles/slide/h5/assets/recastia.svg"}function getRecastiaAppLogoLinkURL(){return/test|dev/.test(window.location.hostname)?"https://test.recastia.com":"https://recastia.com"}
...
function checkBookConfigRestrictedKey(b,c){var d,e,f,g,h,k=function(){return(null==(d=window.tmpBookConfig)?void 0:null==(e=d.power_info)?void 0:e.power)||(null==(f=window.bookConfig)?void 0:null==(g=f.power_info)?void 0:g.power)||(null==(h=window.userInfo)?void 0:h.power)||null},l=function(r){var v;if(!("appLogoIcon"===b&&0<Number(null==(v=window.userInfo)?void 0:v.ai))){if(checkPermission(b,r))return specialHandlers[b]?specialHandlers[b]():c;if(isRecastiaDomain()&&isRecastiaFreeUser()){if("appLogoIcon"===
b)return getRecastiaAppLogoIcon();if("appLogoLinkURL"===b)return getRecastiaAppLogoLinkURL()}if("appLogoIcon"===b&&(r=String(window.bookConfig&&window.bookConfig.appLogoIcon||window.tmpBookConfig&&window.tmpBookConfig.appLogoIcon||("undefined"!==typeof c?c:"")).trim(),"string"==typeof r&&(r=r.replaceAll("\\/","/",!0),r=r.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(r)))return""}},m,q,p,x,u,t=(null==(m=window.tmpBookConfig)?void 0:null==(q=m.power_info)?void 0:q.power)||(null==
(p=window.bookConfig)?void 0:null==(x=p.power_info)?void 0:x.power)||(null==(u=window.userInfo)?void 0:u.power);if(!t&&isRecastiaDomain()&&window.userInfo&&"c"in window.userInfo)return l(k());if(!t&&window.eventEmitter&&"function"===typeof window.eventEmitter.on)window.eventEmitter.on("loadUserInfo",function(r){return l(k())});return l(k())}checkReportConfig=function(){changeBookConfigValue("EnableReportButton",getConfigValue("EnableReportButton",!1))};var tmpBookConfig={};
function runDecryptedScript(b){return new Promise(function(c,d){var e=new Blob([b],{type:"application/javascript"}),f=URL.createObjectURL(e);e=document.createElement("script");e.src=f;e.onload=function(){URL.revokeObjectURL(f);c()};e.onerror=function(){URL.revokeObjectURL(f);d(Error("runDecryptedScript: script load failed"))};document.head.appendChild(e)})}
...
"");if(tmpBookConfig.power_info&&"string"===typeof tmpBookConfig.power_info)try{tmpBookConfig.power_info=JSON.parse(tmpBookConfig.power_info)}catch(m){console.error("Security: Failed to parse power_info JSON, possibly malformed or malicious data",m),tmpBookConfig.power_info=null}tmpBookConfig.clickBlankToFlip=getConfigValue("clickBlankToFlip",!0);tmpBookConfig.PageModeButtonVisible=getConfigValue("PageModeButtonVisible",!1);tmpBookConfig.isAnnotationCustomIconEnabled=getConfigValue("isAnnotationCustomIconEnabled",
...
"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase())tmpBookConfig.flipshortcutbutton=!1;if("slide"==tmpBookConfig.FlipStyle&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase()||isPhone()||isPad())tmpBookConfig.flipshortcutbutton=!1;void 0===tmpBookConfig.isFirstLastShortcutVisible&&(tmpBookConfig.isFirstLastShortcutVisible=!!tmpBookConfig.flipshortcutbutton);if(global.videoList&&1<=global.videoList.length)for(f=0;f<videoList.length;f++)videoList[f].id||(videoList[f].id=""),videoList[f].description||
(videoList[f].description=""),videoList[f].thumbnail||(videoList[f].thumbnail=""),videoList[f].title||(videoList[f].title=""),videoList[f].type||(videoList[f].type="");try{window.localStorage||(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&(global.pageEditor.setting.shoppingCartHTML=!1))}catch(m){tmpBookConfig.BookMarkButtonVisible=
...
tmpBookConfig.delayToFlipFirst=getConfigValue("delayToFlipFirst",!1);tmpBookConfig.timeToFlipFirst=getConfigValue("timeToFlipFirst",10);tmpBookConfig.printBackgroundPosition=getConfigValue("printBackgroundPosition","fit");try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(f=0;f<window.ignoreModuleArray.bookConfig.length;f++)g=window.ignoreModuleArray.bookConfig[f],void 0!=tmpBookConfig[g]&&(tmpBookConfig[g]=!1)}catch(m){}checkFlipStyleConfig();return"issuu"==tmpBookConfig.FlipStyle?
l.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/issuubook.min.css"),7):l.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/flipbook.min.css"),7);case 7:return checkPageEditorConfig(),recordError(),h=Module._getVerifyString(),k=UTF8ToString(h),Module._free(h),l.yield(runDecryptedScript(k),0)}})};
...
(function(){function b(f,g){f=Number(f);return isNaN(f)?g:f}function c(){try{if(!global.staticAd||!global.staticAd.haveAd||"Chinese"==UserGroups||isPhone()||isPad())return!1;var f=parseInt(global.staticAd.adPosition);return 1!==f&&2!==f?!1:!0}catch(g){return!1}}function d(f){f=f||{};try{var g=b(tmpBookConfig.ORIGIN_TOP_MARGIN,b(tmpBookConfig.topMargin,10)),h=b(tmpBookConfig.ORIGIN_BOTTOM_MARGIN,b(tmpBookConfig.bottomMargin,10)),k=g,l=h,m;for(m in e.contributions)if(e.contributions.hasOwnProperty(m)){var q=
e.contributions[m]||{};null!=q.topReq&&(k=Math.max(k,b(q.topReq,k)));null!=q.bottomReq&&(l=Math.max(l,b(q.bottomReq,l)))}if(c()){var p=b(global.staticAd.height,90),x=parseInt(global.staticAd.adPosition);2===x&&(k=Math.max(k,g+p+20));1===x&&(l=Math.max(l,h+p+20))}tmpBookConfig.topMargin=k;tmpBookConfig.bottomMargin=l;var u=e.lastApplied.topMargin!==tmpBookConfig.topMargin||e.lastApplied.bottomMargin!==tmpBookConfig.bottomMargin;e.lastApplied.topMargin=tmpBookConfig.topMargin;e.lastApplied.bottomMargin=
tmpBookConfig.bottomMargin;try{u&&BookEvent&&BookEvent.trigger&&BookEvent.trigger("layoutMarginChanged",[{topMargin:tmpBookConfig.topMargin,bottomMargin:tmpBookConfig.bottomMargin,reason:e.pendingReason||f.reason||""}])}catch(t){}f.disableResize||e.pendingDisableResize||!u||"function"!=typeof global.onStageResize||onStageResize()}catch(t){console.log("LayoutMarginManager.computeAndApply error",t)}}if(!global.LayoutMarginManager){var e={contributions:{},lastApplied:{topMargin:void 0,bottomMargin:void 0},
...
UserGroups?".yunzhan365.com":".fliphtml5.com")+";path=/")}function d(){for(var l={},m=window.location.search.substring(1).split("&"),q=0;q<m.length;q++){var p=m[q].split("="),x=decodeURIComponent(p[0]);p=p[1]?decodeURIComponent(p[1]):null;l[x]=p}return l}function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){var m=16*Math.random()|0;return("x"===l?m:m&3|8).toString(16)})}try{var f=b("first_visit_channel_source");if(!f||!f.uuid){var g=e(),h={channel:"",referer:document.referrer,
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026072901",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
function getArticleEditor(){function b(r){if(window.isExecuteGetInverseEditor)var v=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(v),r()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),r(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(z){d(z,r)},r,"")}function c(r,v,z,A,F){var D=new XMLHttpRequest;D.responseType=
void 0===A?"json":A;D.open("GET",r);D.send();D.onreadystatechange=function(){4===D.readyState&&(200===D.status||304===D.status?v&&v(D):"bookinfo"===F&&v?v():z&&z(v))};D.error=function(){z&&z(v)}}function d(r,v){t&&(clearTimeout(t),t=null);if(window.Module.isReady){var z=allocateUTF8(r.responseText),A=Module._DeString(z),F=UTF8ToString(A);F=eval(F);Module._free(z);Module._FreeMemory(A);e(F);v();window.runArticleEditor&&delete window.runArticleEditor}else t=setTimeout(function(){d(r,v)},100)}function e(r){(window.articleListConfig=
r)?g(r):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&q(function(r){window.articleConfig=r.response})}function g(r){for(var v=[],z=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],F=0;F<z;F++){for(var D=A&&A.length&&A[F]?A[F].index:F,L=[],M=0;M<r.length;M++)(r[M].articles?r[M].articles:[]).forEach(function(I){if(I.isShowLinkSplited){if(I.articleTextList&&
...
x:G.rect.x,y:G.rect.y,width:G.rect.width,height:G.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:G.rect.pageWidth,pageHeight:G.rect.pageHeight}:""}G&&I.articleTextList&&I.articleTextList.length&&(I=k(I),K=h(I,G),L.push(K))}});v.push(L)}console.log("currentPageEditor",JSON.parse(JSON.stringify(v)));window.inverseEditor=v}function h(r,v){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
downColor:"#4997ee",outColor:"#4997ee",overAlpha:"0.3",downAlpha:"0.5",outAlpha:"0"});var z=window.articleConfig.hotArea;return{action:{triggerEventType:"mouseDown",actionType:"com.mobiano.flipbook.pageeditor.TAnnoActionShowArticle",articleConfig:r,linkTarget:"showArticle"},annotype:"com.mobiano.flipbook.pageeditor.TAnnoLink",annoId:"202211710188056",isInverse:!0,alpha:"1",overColor:z.overColor,downColor:z.downColor,outColor:z.outColor,overAlpha:z.overAlpha,downAlpha:z.downAlpha,outAlpha:z.outAlpha,
pageViewedBool:"true",ellipseH:"0",ellipseW:"0",location:v,hint:{hintShapeColor:"0",hintShapeColor2:"8388736",hintShapeAlpha:"1",hintW:"0",hintH:"0",hintAuto:"true",hintShapeType:"2",text:""},shadow:{hasDropShadow:"false",shadowDistance:"4",shadowAngle:"270",shadowColor:"0",shadowAlpha:"0.6",shadowBlurX:"4",shadowBlurY:"4"},highlightsBool:"false",linkStatus:"1",mouseOver:"false",borderColor:"16737792"}}function k(r){r=JSON.parse(JSON.stringify(r));r.articleTextList.map(function(v){"text"===v.type&&
(v.text=v.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return v});return{articleId:r.articleId,newTime:r.newTime,title:r.title,subTitle:r.subTitle,author:r.author,categoryId:r.categoryId,articleTextList:r.articleTextList}}function l(r,v){var z=[];r.forEach(function(A){-1!==v&&(A.pageIndex===v||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===v}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,v),A.length&&(z=[].concat($jscomp.arrayFromIterable(z),$jscomp.arrayFromIterable(A)))):
z.push(A.rect))});return z}function m(r,v){var z="";r.forEach(function(A){if(-1!==v&&(A.pageIndex===v||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(D){return D.pageIndex===v}).length))if(""===z)z=A.mergeList&&A.mergeList.length?m(A.mergeList,v):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var F=[z].concat(A.mergeList);z=m(F,v)}z.rect.x>A.rect.x&&(z.rect.x=A.rect.x);z.rect.y>A.rect.y&&(z.rect.y=A.rect.y);z.rect.endX<A.rect.endX&&(z.rect.endX=A.rect.endX);z.rect.endY<
A.rect.endY&&(z.rect.endY=A.rect.endY);z.rect.width=z.rect.endX-z.rect.x;z.rect.height=z.rect.endY-z.rect.y}});return z}function q(r){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,r,p):p(r)}function p(r){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,r,x):x(r)}function x(r){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var v=bookConfig.periodsConfigPath;v=v.replace("%periodicalId%",window.book_visit.periodicalId);c(v,r,u)}else u(r)}
function u(r){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,r):r&&r()}var t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){return r.return(new Promise(function(v,z){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?v():window.runArticleEditor||window.inverseEditor?v():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(z=bookConfig.bookBaseURL)?(z.endsWith("/")||(z+="/"),c(z+"bookinfo.js",function(A){A&&A.response&&
...
x=0;x<canvasData[b].resources.length;x++)if(1!=canvasData[b].resources[x].type)p++,p>=canvasData[b].resources.length&&k();else{var u=new Image;u.src=getResource(b,x);u.alt="";globalImages[b][x]=u;u.onload=function(){p++;p>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
...
e&&e(c,c,k,b)};x.jumpToEnd()})},noneLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){h=$("<div style='width:100%;height:100%;background:"+bookConfig.pageBackgroundColor+";'></div>");e&&e(c,c,h,b);return k.return()})},jsLoad=function(b,c,d,e,f,g){var h,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){h=function(p,x){return!p||passwardType()&&bookConfig.excludeFrontPages&&x>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),q.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),m=$("<img alt='' src='"+l+"'/>"),m[0].onload=function(){e&&e(l,c,this,b)},q.return();loadJavascript(c,function(p){var x=dataBase64Str(b,d,p);$("<img alt='' src='"+x+"'/>")[0].onload=function(){e&&e(x,c,this,b)}},
function(){});return q.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(!window.printLoadStack)return q.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;m=new PdfLoadingTask(b,d,k,l,function(p){var x=p.toDataURL("image/png"),u=$("<img alt='' src='"+x+"'/>");u[0].onload=function(){e&&e(x,x,u,b)}}.bind(h));window.printLoadStack.push(m);return q.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
function(){this.create(b,c,d)}.bind(h),function(){}),p.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return m=dataBase64Str(b,c),h.$image=$("<img alt='' src='"+m+"'/>"),h.$image[0].onload=function(){d&&d(m,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),p.return();q=h;loadJavascript(k,function(x){var u=dataBase64Str(b,c,x);q.$image=$("<img alt='' src='"+
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),q=b.getContext("2d",{willReadFrequently:!0}),p=q.getImageData(0,0,f,g),x=q.createImageData(c,d);p=p.data;for(var u=x.data,t=0;t<d;t++)for(var r=0;r<c;r++){for(var v=4*(r+t*c),z,A=0,F=0,D=0,L=0,M=0,I=0,G=(t+.5)*k,O=Math.ceil((t+1)*k),K=Math.floor(t*k);K<O;K++){var J=Math.abs(G-(K+.5))/m,Q=(r+.5)*h;J*=J;for(var U=Math.ceil((r+1)*h),T=Math.floor(r*h);T<U;T++)if(z=
Math.abs(Q-(T+.5))/l,z=Math.sqrt(J+z*z),!(1<=z)){z=2*z*z*z-3*z*z+1;var S=4*(T+K*f);I+=z*p[S+3];F+=z;255>p[S+3]&&(z=z*p[S+3]/250);D+=z*p[S];L+=z*p[S+1];M+=z*p[S+2];A+=z}}u[v]=D/A;u[v+1]=L/A;u[v+2]=M/A;u[v+3]=I/F}!0===e?(b.width=c,b.height=d):q.clearRect(0,0,f,g);q.putImageData(x,0,0)}
...
!0;this.page=m;this.renderCanvas(this.pageWidth,this.pageHeight).then(function(q){this.rendered=!0;this.callback&&this.callback(q);d(q)}.bind(this))}.bind(this))}.bind(this))}.bind(f));h.jumpToEnd()})}.bind(this))},renderCanvas:function(b,c){this.rendered=!1;return new Promise(function(d,e){this.renderWidth=b;this.renderHeight=c;this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);var f=$("<canvas><canvas/>")[0],g=f.getContext("2d"),h=window.devicePixelRatio||1,k=this.page,l=k.getViewport({scale:1});
l=fitPageWidthHeight(b,c,l.width,l.height).x/l.width;l=k.getViewport({scale:l});var m=l.width,q=l.height;isPC()||(m>q?3E3<m*h&&(h=3E3/m):3E3<q*h&&(h=3E3/q));f.width=m*h;f.height=q*h;1==h?(f.style.width=f.width+"px",f.style.height=f.height+"px"):(f.style.width=m+"px",f.style.height=q+"px");g={canvasContext:g,transform:1!==h?[h,0,0,h,0,0]:null,viewport:l};try{this.renderTask=k.render(g),this.renderTask.promise.then(function(){this.rendered=!0;d(f)}.bind(this))}catch(p){e(p)}}.bind(this))},remove:function(){},
...
this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),ImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;q=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(q=q.removeStartFrom("?"));m.imageURL=
...
function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);bookConfig.textSharpening&&(p="-webkit-optimize-contrast",_agent_.browser.firefox&&(p="-moz-crisp-edges"),_agent_.browser.opera&&(p="-o-crisp-edges"),m.$image.css({"image-rendering":p,"-ms-interpolation-mode":"nearest-neighbor"}));x.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&
...
2-c.width/2,b.canvas.height/2-c.height/2,c.rotation,c)):(e=function(k,l,m,q,p){p=void 0===p?!1:p;var x=h[m],u=Math.abs(l-k);if(!(0>=u)){q=q?x.width:x.height;l=0;if(u>=q)for(l=Math.floor((u+c.spacing)/(q+c.spacing));0<l&&!(l*q+(l-1)*c.spacing<=u);)l--;if(!(0>=l)){u=1<l?(u-l*q)/(l-1):0;for(var t=0;t<l;t++){var r=p?k-t*(q+u):k+t*(q+u),v=void 0,z=void 0;switch(m){case "top":v=r+(x.width-c.width)/2;z=(x.height-c.height)/2+f;break;case "right":v=b.canvas.width-(c.width+x.width)/2-f;z=r+(x.height-c.height)/
2;break;case "bottom":v=r+(x.width-c.width)/2;z=b.canvas.height-(c.height+x.height)/2-f;break;case "left":v=(x.width-c.width)/2+f,z=r+(x.height-c.height)/2}WatermarkStrategy.prototype.drawSingleWatermark.call(d,b,v,z,g[m],c,p)}}}},e(f,b.canvas.width-h.right.width-f,"top",!0,!1),e(f,b.canvas.height-h.bottom.height-f,"right",!1,!1),e(h.left.width,b.canvas.width-f,"bottom",!0,!1),e(h.top.height,b.canvas.height-f,"left",!1,!1))};var WatermarkStrategyFactory=function(){};
...
b;this.flippingTime=1E3*bookConfig.flippingTime},flipIntervalTmp:function(b,c,d,e){if(b){this.book.flipping=!0;b.flipping=!0;var f=.05;if(isIE()||isFirefox())f=0;b.setFlipOriginPoint(e);b.coordinate||(b.coordinate=b.startPoint);var g=b.coordinate.x,h=b.coordinate.y,k,l=this.flippingTime;l=l*Math.abs(b.toPoint.x-g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var q=0;k=function(){m(q,25,"Sine");q++}.interval(this,l/25)}.bind(this):function(){k=
function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,x){if(!b)return!1;var u=b.pageWidth,t=b.pageHeight,r=$.easing["easeInOut"+x],v=$.easing["easeOut"+x];x=v(null,q,g,b.toPoint.x-g,p);v=v(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(x=r(null,q,g,b.toPoint.x-g,p),v=bookConfig.FlipDirection?f*Math.sqrt(t*t-x*x):t-f*Math.sqrt(u*u-x*x));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:v}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",
...
!1;this.flipPageManager.checkFlipping()?this.flipping=!0:(this.refreshBookMiniFullscreenForCoverSpread(),this.startAnimation(),this.flipToDirection="",this.loading())},refreshBookMiniFullscreenForCoverSpread:function(){this.bookAttachments&&this.bookAttachments.Items&&(0<=BookInfo.getPagesByIndex(this.currentPageIndex).indexOf(1)?this.bookAttachments.Items.find("BookMiniFullscreen").each(function(b){b.init()}):this.bookAttachments.Items.find("BookMiniFullscreen").each(function(b){b.remove()}))},followToPoint:function(b,
...
c?void 0:null==(d=c.pageArray[b])?void 0:d.page)?void 0:null==(f=e.pageAttachments)?void 0:null==(g=f.pageAnnotation)?void 0:g.pageAnnotation;if(!h){var k,l,m,q,p;h=null==c?void 0:null==(k=c.pageArray[b])?void 0:null==(l=k.pageArray)?void 0:null==(m=l[b])?void 0:null==(q=m.pageAttachments)?void 0:null==(p=q.pageAnnotation)?void 0:p.pageAnnotation}return h}}}),FlipHistory=Class({create:function(){this.array=[];this.currentIndex=0},backward:function(){var b=this.currentIndex-1;void 0!=this.array[b]&&
...
!0:!1},hasReaderItems:function(){var b=window.readerConfig.pages[this.pageIndex-1];return b&&0!==Object.values(b).filter(function(c){return Array.isArray(c)&&c.length}).length},loading:function(){if("restrict"!=BookRestrict.isRestrictPage(this.pageIndex)){if(this.originalImageLoaded)if(this.hasReader()){if(this.pageReaderLoaded)return}else return;this.removeLoad||(this.loadingImage||(this.loadingImage=$("<div class='loadingOuter'><img alt='loadingOuter' width='auto' height='auto' class='loadingImage' src='"+
bookConfig.pageLoadingUrl+"'/></div>")),this.sideContent.append(this.loadingImage))}},unLoading:function(b){this.hasReader()&&!b||!this.loadingImage||(this.loadingImage.css({display:"none"}),this.loadingImage.remove(),this.loadingImage=null)},restrict:function(){if(!this.restrictImage){this.restrictImage=$("<div class='loadingOuter'></div>");var b=1==this.pageIndex?getMeta("og:image"):bookConfig.pageRestrictUrl;this.restrictImage.css({"background-image":"url("+b+")"});1==this.pageIndex?this.restrictImage.css({"background-size":"contain"}):
...
$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),e.clearSideImageContent(),e.sideImage.append(d);else{e.clearSideImageContent();for(f=0;f<d.length;f++)isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),e.sideImage.append(d[f]);e.imageWidth=d[0][0].naturalWidth;e.imageHeight=d[0][0].naturalHeight}g=fitPageWidthHeight(e.pageWidth,e.pageHeight,
e.imageWidth,e.imageHeight);!bookConfig.isSingleBookFullWindowOnMobile||1!=e.bookType||!isPhone()&&!isPad()||e.imageWidth||e.imageHeight||(g=fitPageWidthHeight(e.pageWidth,e.pageHeight,bookConfig.largePageWidth,bookConfig.largePageHeight),h=bookConfig.largePageWidth/bookConfig.largePageHeight,k=e.pageWidth/e.pageHeight,.01>h-k&&-.01<h-k&&(g.x=e.pageWidth,g.y=e.pageHeight),e.imageWidth=g.x,e.imageHeight=g.y);e.pageAttachments||(e.pageAttachments=new IssuuPageAttachmentsParser(e.sideContent,e.pageWidth,
e.pageHeight,e.pageWidth,e.pageHeight,e.pageIndex,e.bookType,e,function(){if(this.onPageLoaded)this.onPageLoaded(this.pageIndex)}.bind(e)));l.jumpToEnd()})},isReaderConfigLoaded:function(b){try{var c=function(){try{b&&b()}catch(e){}};(window.readerConfig||window.readerConfigLoaded)&&c();var d=window.setInterval(function(){window.readerConfigLoaded&&(window.clearInterval(d),c())},100)}catch(e){}},onPageLoaded:function(){this.pageReaderLoaded=!0;this.unLoading(!0);var b=this.pageIndex;BookInfo.getBook().getRealBookIndex&&
(b=BookInfo.getBook().getRealBookIndex(this.pageIndex));BookInfo.getBook().onBookPageLoaded(b)},enterSide:function(){this._pageEnterTime=Date.now();this.pageAttachments&&this.pageAttachments.enterSide();this.pageBackground&&this.pageBackground.enterSide();window.vuePopDom&&window.vuePopDom.enterPage&&window.vuePopDom.enterPage()},leaveSide:function(){if(null!=this._pageEnterTime){var b=Date.now()-this._pageEnterTime;this._pageEnterTime=void 0;BookEvent.trigger("customEvent",["time_on_page_"+this.pageIndex+
"_"+b/1E3])}this.pageAttachments&&this.pageAttachments.leaveSide();this.pageBackground&&this.pageBackground.leaveSide();window.vuePopDom&&window.vuePopDom.leavePage&&window.vuePopDom.leavePage()},initSelectTextEvent:function(){this.pageAttachments&&this.pageAttachments.select()},destroySelect:function(){this.pageAttachments&&this.pageAttachments.destroySelect()},initMagnifierEvent:function(){this.pageAttachments&&this.pageAttachments.initMagnifierEvent()},destroyMagnifier:function(){this.pageAttachments&&
...
$(d).css({"pointer-events":"none"}),this.sideImage.append(d[b]);this.imageWidth=d[b][0].naturalWidth;this.imageHeight=d[b][0].naturalHeight}},resizeSvg:function(b,c){try{this.pageBackground.resizeSvg(b,c)}catch(d){}}}).extend(Side);bdor[30]=function(b,c){return bdor[b]-c};bdor[38]=function(){return bdor[30](37,40)}();
...
var IssuuImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;q=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(q=q.removeStartFrom("?"));m.imageURL=q;m.imageObject=new ImageObject;m.imageObject.alt(m.index);
m.imageObject.src(m.imageURL);m.imageObject.css({"z-index":0});m.$image=m.imageObject.$image;bookConfig.EnableRecognizeQRcodePressOnMobile&&m.imageObject.css({"-webkit-touch-callout":"default"});m.loaded=!1;m.$image[0].onload=function(){this.loaded=!0;this.callback&&this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(m);m.$image[0].onerror=function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);
bookConfig.textSharpening&&(p="-webkit-optimize-contrast",_agent_.browser.firefox&&(p="-moz-crisp-edges"),_agent_.browser.opera&&(p="-o-crisp-edges"),m.$image.css({"image-rendering":p,"-ms-interpolation-mode":"nearest-neighbor"}));x.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&isPC()?this.switchNormalImage(b,c):(isPhone()||isPad())&&this.resize()},
...
c,this.width,this.height),this.scale(b.x,b.y)}}),IssuuImageArrayLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,m,q,p,x;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(1==u.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,h.callback=d,h.$images=[],h.loadArray=[],u.yield(getPageDir(b,c,originTotalPageCount),2);k=u.yieldResult;h.imagesURL=k;l=
0;m=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);q=function(t){l++;this.$images.removeElement(t);this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);for(p=0;p<k.length;p++)x=-1<k[p].indexOf(".svg")?new IssuuImageArrayLoadSvg(b,k[p],c,m,q,e,f,g,p):new IssuuImageArrayLoadImage(b,k[p],c,m,q,e,f,g,p),h.$images.push(x.$image),h.loadArray.push(x);u.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&
...
f.jumpToEnd()})},setImageCss:function(b){this.imageObject&&this.imageObject.css(b);this.largeImageObject&&this.largeImageObject.css(b)}}),IssuuPdfLoad=Class({index:0,pageWidth:0,pageHeight:0,create:function(b,c,d,e,f,g,h){var k=this,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return k.index=b,k.type=c,k.pageWidth=e,k.pageHeight=f,k.renderWidth=e,k.renderHeight=f,k.callback=d,k.parent=h,l=k,q.yield(getPageDir(b,c,originTotalPageCount),2);if(3!=q.nextAddress)return l.imageURL=
q.yieldResult,m=k,q.yield(getPageDir(b,"thumb",originTotalPageCount),3);m.thumbUrl=q.yieldResult;k.$content=$("<div style='position:absolute;left:0;top:0;width:100%;height:100%;'></div>");k.pdfLoadingTask=new PdfLoadingTask(k.index,k.type,e,f,k.loaded.bind(k));window.pdfLoadStack||(window.pdfLoadStack=new PdfLoadArray(3));window.pdfLoadStack&&pdfLoadStack.push(k.pdfLoadingTask);q.jumpToEnd()})},enterSide:function(){this.enter=!0},leaveSide:function(){this.enter=!1;this.pdfLoadingTask&&this.pdfLoadingTask.leaveSide()},
...
pdfLoadStack.pop(this.pdfLoadingTask),this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),IsuuPageBackground=Class({create:function(b,c,d,e,f,g,h){var k=this,l,m,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress){if(!b||!c)return p.return();k.type=c;k.pageWidth=e;k.pageHeight=f;return p.yield(getPageDir(b,c,originTotalPageCount),2)}l=p.yieldResult;m=getPageSize(b,c);k.imageURL=l;k.load=null;k.parent=h;q=k.getUrlType(l,m);k.urlType=q;switch(q){case 0:k.load=
...
l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,x){if(!b)return!1;var u=b.pageWidth,t=b.pageHeight,r=$.easing["easeInOut"+x],v=$.easing["easeOut"+x];x=v(null,q,g,b.toPoint.x-g,p);v=v(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(x=r(null,q,g,b.toPoint.x-g,p),v=bookConfig.FlipDirection?f*Math.sqrt(t*t-x*x):t-f*Math.sqrt(u*u-x*x));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:v}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){try{var m=1,q=1;m=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);q=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);for(c=0;c<b.length;c++){var p=this.pageArray[b[c]];if(p){var x=transformCSS({tran:l?l:{x:0,y:0},scale:{x:m,y:q},origin:g});this.isCoverPage(b[c])&&(p.tran=l?l:{x:0,y:0},p.scale=
{x:m,y:q},p.rotateY?(p.$page[0].style.removeProperty("transform-origin"),d=void 0,x=transformCSS({scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})):(d=void 0,x=transformCSS({origin:g,scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})));p.setCSSByStyle(x);if(p.page.pageFlipShadow){var u=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});p.page.pageFlipShadow&&p.page.pageFlipShadow.setCSSByStyle(u)}}}return{x:m,y:q}}catch(t){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},
...
this.pageBackArray[d]&&(this.pageBackArray[d].page.setCSSByName("flip-side"),this.pageBackArray[d].page.side.addClass("boxShadow"));return[this.pageArray[d],this.pageBackArray[d]]},getMovedXByIndex:function(b){var c=this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){var m=this;try{var q=1,p=1;q=$.easing.easeInOutSine(null,c,1,f.x/e.x-
1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(u){if(u){var t=transformCSS({tran:l?l:{x:0,y:0},scale:{x:q,y:p},origin:g});if(m.isCoverPage(u.pageIndex))if(u.tran=l?l:{x:0,y:0},u.scale={x:q,y:p},u.rotateY){u.$page[0].style.removeProperty("transform-origin");var r;t=transformCSS({scale:{x:q,y:p},perspective:6E3,rotateY:null!=(r=u.rotateY)?r:0})}else{var v;t=transformCSS({origin:g,scale:{x:q,y:p},perspective:6E3,rotateY:null!=(v=u.rotateY)?v:0})}u.setCSSByStyle(t);t=h?transformCSS({scale:{x:k.x/
q,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});u.page.pageFlipShadow&&u.page.pageFlipShadow.setCSSByStyle(t)}};for(d=0;d<b.length;d++){var x=this.pageBackArray[b[d]];c(this.pageArray[b[d]]);c(x)}return{x:q,y:p}}catch(u){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&
...
window.getWidth(),windowHeight=c=window.getHeight(),windowWidth=b,e.yield(checkFliphtml5PagesConfig(),2);case 2:return e.yield(checkBookConfig(),3);case 3:return e.yield(selectLanguage(bookConfig.language),4);case 4:return e.yield(validateDomainAccess(),5);case 5:d=e.yieldResult;if(!d)return e.return();initImageBaseUrl();global.onBookLoad=new LoadingBook(tmpContainer,bookConfig.loadingBackground);if("article4"===global.templeteName){e.jumpTo(6);break}return e.yield(initToolBarBrand(),6);case 6:delayLoading();
var f=document.getElementById("aria-page-title-header");if(f)var g=document.getElementById("aria-page-title");else f=document.createElement("header"),f.id="aria-page-title-header",f.setAttribute("aria-hidden","true"),f.style.cssText="position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);",g=document.createElement("h1"),g.id="aria-page-title",f.appendChild(g),document.body.appendChild(f);g&&(g.textContent=document.title);e.jumpToEnd()}})}
...
(function(b){function c(h,k){h=h.querySelectorAll("canvas");var l=k.querySelectorAll("canvas"),m=[];h.forEach(function(q,p){var x=l[p];if(x){x.width=q.width;x.height=q.height;q=q.toDataURL();var u=new Image;p=new Promise(function(t){u.onload=function(){x.getContext("2d").drawImage(u,0,0);t()};u.onerror=function(){return t()}});u.src=q;m.push(p)}});return Promise.all(m).then(function(){})}var d=0,e={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},f={};b.fn.printArea=function(h){b.extend(f,e,h);d++;b("[id^=printArea_]").remove();f.id="printArea_"+d;var k=b(this),l=g.getPrintWindow();g.write(l.doc,k);c(b(this)[0],l.doc).then(function(){function m(){p&&p();g.print(l)}var q=b(l.doc).find("img"),p=h&&"function"===typeof h.onReady?h.onReady:null;if(0===q.length)m();else{var x=0;q.each(function(u,t){if(t.complete)x++,x===q.length&&m();else b(t).on("load error",function(){x++;x===q.length&&
