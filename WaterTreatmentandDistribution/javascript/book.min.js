...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(v,r){return"function"==typeof v?function(t){try{m(v(t))}catch(u){p(u)}}:r}var m,p,q=new f(function(v,r){m=v;p=r});this.callWhenSettled_(l(h,m),l(k,p));return q};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
p){function q(t){return function(u){v[t]=u;r--;0==r&&m(v)}}var v=[],r=0;do v.push(void 0),r++,d(l.value).callWhenSettled_(q(v.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
window.templateArea={logoHeight:0,setLogoHeight:function(b){this.logoHeight=b},getLeftWidth:function(){return 0},getRightWidth:function(){return 0},getTopHeight:function(){return MiniStyle.isMini()||NeatStyle.isNeat()||!bookConfig.ToolBarVisible?0:isPC()?bookConfig.appLogoIcon?this.logoHeight:0:phoneTemplateArea.getTopHeight()},getBottomHeight:function(){return MiniStyle.isMini()?0:NeatStyle.isNeat()?40:bookConfig.ToolBarVisible?isPC()?window.thumbnail&&window.thumbnail.visible?thumbnail.getBottomHeight()+
58:58:phoneTemplateArea.getBottomHeight():0},getHeight:function(){return this.getTopHeight()+this.getBottomHeight()},getWidth:function(){return this.getLeftWidth()+this.getRightWidth()}};var yunzhanCMapUrl="https://book.yunzhan365.com/resourceFiles/pdfjs-dist/cmaps/",qqEmailLinkUrl="https://mail.qq.com/",reportUrl="https://www.yunzhan365.com/hostInfo/report-book-online.php",yunzhanUrl="https://www.yunzhan365.com/",yunzhanActivityUrl="https://www.yunzhan365.com/activity618/",yunzhanExploreUrl="https://www.yunzhan365.com/explore/",fliphtml5ExploreUrl="https://fliphtml5.com/exploring/?utm_source=expiredbook&utm_medium=button&utm_campaign=paid&utm_term",googletagmanagerUrl="https://www.googletagmanager.com",
fliphtml5Url="http://www.fliphtml5.com",baiduUrl="https://hm.baidu.com/hm.js",yunzhanMainDomainList=["www.yunzhan365.com","test.yunzhan365.com"],yunzhanBookDomainList="book.yunzhan365.com test2.yunzhan365.com book.asflip.com bookh.yunzhan365.com online.fliphtml5.com t.flipbuilder.com".split(" "),logoBrandDomainList=["yunzhan365","fliphtml5"],brandHostRegex=/fliphtml5|yunzhan365|anyflip|pubhtml5/,fliphtml5HostRegex=/fliphtml5/,facebookBrandDomains=["fliphtml5.com","pubhtml5.com","anyflip.com","flipbuilder.com"],
shareTitleBrandSuffix=" on FlipHTML5",shareTitleBrandDomains=["fliphtml5.com"],facebookAppIdFliphtml5="759223277462081",facebookAppIdPubhtml5="552959651503135",facebookAppIdAnyflipShare="3188867394510608",facebookAppIdFlipbuilder="506045156879233",yunzhanBrandDomain="yunzhan365.com",fliphtml5BrandDomain="fliphtml5.com",fliphtml5OnlineDomain="online.fliphtml5.com",yunzhanCookieDomain=".yunzhan365.com",fliphtml5CookieDomain=".fliphtml5.com",chatbotDefaultDomain="https://fliphtml5.com";
function getTarget(){var b=1,c=window.location.host;var d=window.location.pathname;var e="",f="";if(window.yz_temp_link)e=window.yz_temp_uLink,f=window.yz_temp_bLink;else{if(yunzhanMainDomainList.some(function(k){return c.match(k)})){if(yunzhanMainDomainList[0]&&c.match(yunzhanMainDomainList[0]+"/view"))return;b=d.indexOf("/",1)+1;var g=d.indexOf("/",b);var h=d.indexOf("/",g+1);e=d.substring(b,g);f=d.substring(g+1,h)}else 0<=yunzhanBookDomainList.indexOf(c)&&(g=d.indexOf("/",1),h=d.indexOf("/",g+
1),e=d.substring(b,g),f=d.substring(g+1,h));try{/^https?:\/\/[^/]+\/books(?:\/|$)/.test(location.href)&&(g=d.indexOf("/",1),h=d.indexOf("/",g+1),e=window.userInfo.d,f=d.substring(g+1,h))}catch(k){}return{uLink:e,bLink:f}}};/*
 Hammer.JS - v2.0.8 - 2016-04-23
 http://hammerjs.github.io/

 Copyright (c) 2016 Jorik Tangelder;
 Licensed under the MIT license  http://mths.be/base64 v0.1.0 by @mathias | MIT license */
("undefined"!==typeof window?window:"undefined"!==typeof global?global:this).bdor=[];var _agent_={};
...
window.bdor||((this||(0,eval)("(this)")).bdor=[]);window.bdor[1]="p";var global=function(){return"undefined"!==typeof globalThis?globalThis:"undefined"!==typeof window?window:"undefined"!==typeof global?global:this}(),virtual_function=function(){};function getPackageByName(b){if(void 0==b||""==b)return global;var c=global;b=b.split(".");for(var d=0;d<b.length;d++){var e=b[d];c[e]||(c[e]={IS_PACKAGE_OBJECT:!0});c=c[e]}return c}
...
Instance.JSON(b[d]);c.push(e);c.push(", ")}1<c.length&&c.pop();c.push("}");return c.join("")}},parse:function(b,c){if(!b||"undefined"===b||"null"===b||""===b)return c;try{return JSON.parse(b)}catch(d){return c}}};Object.create=Object.create||function(){function b(){}return function(c){if(1!=arguments.length)throw Error("Object.create implementation only accepts one parameter.");b.prototype=c;return new b}}();
...
function getEditorEventName(){return bookConfig.productName&&bookConfig.productName.toLocaleLowerCase().match(/flip[ ]*pdf/)?"flip_pdf_editor_":bookConfig.productName&&bookConfig.productName.toLocaleLowerCase().match(/fliphtml5/)?"page_editor_":""}
function DeString(b,c){if(""==b)return"";c&&""!=c||(console.warn("Security: DeString called without password, using insecure default. Please provide a password."),c="fb5");c=escape(c);if(null==b||8>b.length)alert("A salt value could not be extracted from the encrypted message because it's length is too short. The message cannot be decrypted.");else if(null==c||0>=c.length)alert("Please enter a password with which to decrypt the message.");else{for(var d="",e=0;e<c.length;e++)d+=c.charCodeAt(e).toString();
var f=Math.floor(d.length/5);f=parseInt(d.charAt(f)+d.charAt(2*f)+d.charAt(3*f)+d.charAt(4*f)+d.charAt(5*f),10);c=Math.round(c.length/2);var g=Math.pow(2,31)-1;e=parseInt(b.substring(b.length-8,b.length),16);b=b.substring(0,b.length-8);for(d+=e;10<d.length;)d=(parseInt(d.substring(0,10),10)+parseInt(d.substring(10,d.length),10)).toString();d=(f*d+c)%g;var h="";for(e=0;e<b.length;e+=2){var k=parseInt(parseInt(b.substring(e,e+2),16)^Math.floor(d/g*255),10);h+=String.fromCharCode(k);d=(f*d+c)%g}return unescape(h)}}
...
default:return document[this.prefix+"FullScreen"]}},b.requestFullScreen=function(f){f[this.prefix+"RequestFullScreen"]()},b.cancelFullScreen=function(f){return""===this.prefix?document.cancelFullScreen():document[this.prefix+"CancelFullScreen"]()});window.fullScreenApi=b})();function showFullscreenPolicyBlockedTooltip(){MessageBox.error(getLanguage("msgFullscreenPolicyBlocked","Fullscreen is restricted by the host site's security policy. Please contact your administrator."))}
(function(){"undefined"!==typeof document&&document.addEventListener&&document.addEventListener("securitypolicyviolation",function(b){0<=(b.effectiveDirective||b.violatedDirective||"").toString().indexOf("fullscreen")&&showFullscreenPolicyBlockedTooltip()},!0)})();
function invokeRequestFullscreen(b,c){function d(){e||(e=!0,"function"===typeof c&&c())}var e=!1;if("function"===typeof b.requestFullscreen)try{var f=b.requestFullscreen();if(f&&"function"===typeof f.then){f.then(function(){}).catch(function(){d()});return}setTimeout(function(){fullScreenApi.isFullScreen()||d()},450);return}catch(h){d();return}try{if(fullScreenApi.prefix){var g=fullScreenApi.prefix+"RequestFullScreen";if("function"===typeof b[g]){b[g]();setTimeout(function(){fullScreenApi.isFullScreen()||
d()},450);return}}}catch(h){d();return}d()}
...
function onFullscreenEvent(b){fullScreenApi.srcElement=b.srcElement||b.target;b=isPhone()||isPad()?"PhoneFullscreenButton":"FullscreenButton";StateSynchronous.instance().findButtons(b).each(function(c){fullScreenApi.isFullScreen()?c.setAsExitFullScreen():c.setAsFullScreen();c.executeCallback()});b="*";if(window.parent!==window)try{b=window.parent.location.origin||"*"}catch(c){console.warn("Security: Cross-origin iframe detected, postMessage using wildcard origin"),b="*"}window.parent.postMessage({trigger:"fullScreen",
value:fullScreenApi.isFullScreen()},b);fullScreenApi.isFullScreen()?MiniStyle.hide():MiniStyle.show();(function(){if(global.toolBar&&global.toolBar.onResize)toolBar.onResize()}).delay(100)}
function fullscreenFun(){var b=$("body")[0],c=!1;if(fullScreenApi.supportsFullScreen)if(fullScreenApi.isFullScreen())fullScreenApi.cancelFullScreen();else{var d=document.fullscreenEnabled,e=document.webkitFullscreenEnabled,f=document.mozFullScreenEnabled;"undefined"!==typeof d&&!1===d||"undefined"!==typeof e&&!1===e||"undefined"!==typeof f&&!1===f?(showFullscreenPolicyBlockedTooltip(),c=!0):invokeRequestFullscreen(b,showFullscreenPolicyBlockedTooltip)}if(!c&&b.webkitSupportsFullscreen)try{b.webkitEnterFullscreen(Element.ALLOW_KEYBOARD_INPUT)}catch(g){showFullscreenPolicyBlockedTooltip()}}
(function(b,c,d,e){function f(n,w,y){return setTimeout(m(n,y),w)}function g(n,w,y){return Array.isArray(n)?(h(n,y[w],y),!0):!1}function h(n,w,y){var B;if(n)if(n.forEach)n.forEach(w,y);else if(n.length!==e)for(B=0;B<n.length;)w.call(y,n[B],B,n),B++;else for(B in n)n.hasOwnProperty(B)&&w.call(y,n[B],B,n)}function k(n,w,y){var B="DEPRECATED METHOD: "+w+"\n"+y+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var E=b.console&&(b.console.warn||b.console.log);E&&E.call(b.console,B,C);return n.apply(this,arguments)}}function l(n,w,y){w=w.prototype;var B=n.prototype=Object.create(w);B.constructor=n;B._super=w;y&&Z(B,y)}function m(n,w){return function(){return n.apply(w,arguments)}}function p(n,w){return"function"==typeof n?n.apply(w?w[0]||e:e,w):n}function q(n,w,y){h(t(w),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,y,!1):n.attachEvent(B,y)})}
function v(n,w,y){h(t(w),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,y,!1):n.detachEvent(B,y,!1)})}function r(n,w){for(;n;){if(n==w)return!0;n=n.parentNode}return!1}function t(n){return n.trim().split(/\s+/g)}function u(n,w,y){if(n.indexOf&&!y)return n.indexOf(w);for(var B=0;B<n.length;){if(y&&n[B][y]==w||!y&&n[B]===w)return B;B++}return-1}function x(n){return Array.prototype.slice.call(n,0)}function z(n,w,y){for(var B=[],C=[],E=0;E<n.length;){var H=w?n[E][w]:n[E];
0>u(C,H)&&B.push(n[E]);C[E]=H;E++}y&&(B=w?B.sort(function(N,V){return N[w]>V[w]}):B.sort());return B}function A(n,w){if(w&&w[0]){for(var y,B=w[0].toUpperCase()+w.slice(1),C=0;C<sa.length;){y=(y=sa[C])?y+B:w;if(y in n)return y;C++}return e}}function F(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function D(n,w){var y=this;this.manager=n;this.callback=w;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){p(n.options.enable,[n])&&y.handler(B)};this.init()}
function L(n,w,y){var B=y.pointers.length,C=y.changedPointers.length;var E=w&1&&0===B-C;y.isFirst=!!E;y.isFinal=!!(w&12&&0===B-C);E&&(n.session={});y.eventType=w;w=n.session;B=y.pointers;C=B.length;w.firstInput||(w.firstInput=M(y));1<C&&!w.firstMultiple?w.firstMultiple=M(y):1===C&&(w.firstMultiple=!1);E=w.firstInput;var H=(C=w.firstMultiple)?C.center:E.center;var N=y.center=I(B);y.timeStamp=qa();y.deltaTime=y.timeStamp-E.timeStamp;y.angle=K(H,N);y.distance=O(H,N);E=y.center;H=w.offsetDelta||{};N=
w.prevDelta||{};var V=w.prevInput||{};if(1===y.eventType||4===V.eventType)N=w.prevDelta={x:V.deltaX||0,y:V.deltaY||0},H=w.offsetDelta={x:E.x,y:E.y};y.deltaX=N.x+(E.x-H.x);y.deltaY=N.y+(E.y-H.y);y.offsetDirection=G(y.deltaX,y.deltaY);H=y.deltaTime;E=y.deltaX/H||0;H=y.deltaY/H||0;y.overallVelocityX=E;y.overallVelocityY=H;y.overallVelocity=da(E)>da(H)?E:H;C?(E=C.pointers,E=O(B[0],B[1],oa)/O(E[0],E[1],oa)):E=1;y.scale=E;C?(C=C.pointers,B=K(B[1],B[0],oa)+K(C[1],C[0],oa)):B=0;y.rotation=B;y.maxPointers=
w.prevInput?y.pointers.length>w.prevInput.maxPointers?y.pointers.length:w.prevInput.maxPointers:y.pointers.length;H=w.lastInterval||y;B=y.timeStamp-H.timeStamp;8!=y.eventType&&(25<B||H.velocity===e)?(E=y.deltaX-H.deltaX,H=y.deltaY-H.deltaY,N=E/B||0,V=H/B||0,B=N,C=V,N=da(N)>da(V)?N:V,E=G(E,H),w.lastInterval=y):(N=H.velocity,B=H.velocityX,C=H.velocityY,E=H.direction);y.velocity=N;y.velocityX=B;y.velocityY=C;y.direction=E;w=n.element;r(y.srcEvent.target,w)&&(w=y.srcEvent.target);y.target=w;n.emit("hammer.input",
y);n.recognize(y);n.session.prevInput=y}function M(n){for(var w=[],y=0;y<n.pointers.length;)w[y]={clientX:ha(n.pointers[y].clientX),clientY:ha(n.pointers[y].clientY)},y++;return{timeStamp:qa(),pointers:w,center:I(w),deltaX:n.deltaX,deltaY:n.deltaY}}function I(n){var w=n.length;if(1===w)return{x:ha(n[0].clientX),y:ha(n[0].clientY)};for(var y=0,B=0,C=0;C<w;)y+=n[C].clientX,B+=n[C].clientY,C++;return{x:ha(y/w),y:ha(B/w)}}function G(n,w){return n===w?1:da(n)>=da(w)?0>n?2:4:0>w?8:16}function O(n,w,y){y||
(y=ta);var B=w[y[0]]-n[y[0]];n=w[y[1]]-n[y[1]];return Math.sqrt(B*B+n*n)}function K(n,w,y){y||(y=ta);return 180*Math.atan2(w[y[1]]-n[y[1]],w[y[0]]-n[y[0]])/Math.PI}function J(){this.evEl=Aa;this.evWin=Ba;this.pressed=!1;D.apply(this,arguments)}function Q(){this.evEl=ua;this.evWin=va;D.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function U(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;D.apply(this,arguments)}function T(){this.evTarget=
Ca;this.targetIds={};D.apply(this,arguments)}function S(n,w){var y=x(n.touches),B=this.targetIds;if(w&3&&1===y.length)return B[y[0].identifier]=!0,[y,y];n=x(n.changedTouches);var C=[],E=this.target;var H=y.filter(function(N){return r(N.target,E)});if(1===w)for(y=0;y<H.length;)B[H[y].identifier]=!0,y++;for(y=0;y<n.length;)B[n[y].identifier]&&C.push(n[y]),w&12&&delete B[n[y].identifier],y++;if(C.length)return[z(H.concat(C),"identifier",!0),C]}function ia(){D.apply(this,arguments);var n=m(this.handler,
this);this.touch=new T(this.manager,n);this.mouse=new J(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function W(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var w={x:n.clientX,y:n.clientY};this.lastTouches.push(w);var y=this.lastTouches;setTimeout(function(){var B=y.indexOf(w);-1<B&&y.splice(B,1)},2500)}}function ea(n,w){this.manager=n;this.set(w)}function ma(n){if(-1<n.indexOf("none"))return"none";var w=-1<n.indexOf("pan-x"),y=-1<n.indexOf("pan-y");return w&&y?"none":
w||y?w?"pan-x":"pan-y":-1<n.indexOf("manipulation")?"manipulation":"auto"}function P(n){this.options=Z({},this.defaults,n||{});this.id=Da++;this.manager=null;n=this.options.enable;this.options.enable=n===e?!0:n;this.state=1;this.simultaneous={};this.requireFail=[]}function ja(n){return n&16?"cancel":n&8?"end":n&4?"move":n&2?"start":""}function na(n){return 16==n?"down":8==n?"up":2==n?"left":4==n?"right":""}function aa(n,w){return(w=w.manager)?w.get(n):n}function R(){P.apply(this,arguments)}function fa(){R.apply(this,
arguments);this.pY=this.pX=null}function ka(){R.apply(this,arguments)}function ba(){P.apply(this,arguments);this._input=this._timer=null}function X(){R.apply(this,arguments)}function ca(){R.apply(this,arguments)}function la(){P.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function Y(n,w){w=w||{};var y=w.recognizers;w.recognizers=y===e?Y.defaults.preset:y;return new ra(n,w)}function ra(n,w){this.options=Z({},Y.defaults,w||{});this.options.inputTarget=this.options.inputTarget||
n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new ia(this,L);this.touchAction=new ea(this,this.options.touchAction);wa(this,!0);h(this.options.recognizers,function(y){var B=this.add(new y[0](y[1]));y[2]&&B.recognizeWith(y[2]);y[3]&&B.requireFailure(y[3])},this)}function wa(n,w){var y=n.element;if(y.style){var B;h(n.options.cssProps,function(C,E){B=A(y.style,E);w?(n.oldCssProps[B]=y.style[B],y.style[B]=C):y.style[B]=n.oldCssProps[B]||""});w||(n.oldCssProps=
{})}}function Ea(n,w){var y=c.createEvent("Event");y.initEvent(n,!0,!0);y.gesture=w;w.target.dispatchEvent(y)}var sa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),ha=Math.round,da=Math.abs,qa=Date.now;var Z="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var w=Object(n),y=1;y<arguments.length;y++){var B=arguments[y];if(B!==e&&null!==B)for(var C in B)B.hasOwnProperty(C)&&(w[C]=B[C])}return w}:Object.assign;
var xa=k(function(n,w,y){for(var B=Object.keys(w),C=0;C<B.length;){if(!y||y&&n[B[C]]===e)n[B[C]]=w[B[C]];C++}return n},"extend","Use `assign`."),Ga=k(function(n,w){return xa(n,w,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var ta=["x","y"],oa=["clientX","clientY"];D.prototype={handler:function(){},init:function(){this.evEl&&q(this.element,this.evEl,this.domHandler);this.evTarget&&q(this.target,
this.evTarget,this.domHandler);this.evWin&&q(F(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&v(this.element,this.evEl,this.domHandler);this.evTarget&&v(this.target,this.evTarget,this.domHandler);this.evWin&&v(F(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},Aa="mousedown",Ba="mousemove mouseup";l(J,D,{handler:function(n){var w=Ja[n.type];w&1&&0===n.button&&(this.pressed=!0);w&2&&1!==n.which&&(w=4);this.pressed&&(w&4&&(this.pressed=
!1),this.callback(this.manager,w,{pointers:[n],changedPointers:[n],pointerType:"mouse",srcEvent:n}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},ua="pointerdown",va="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(ua="MSPointerDown",va="MSPointerMove MSPointerUp MSPointerCancel");l(Q,D,{handler:function(n){var w=this.store,y=!1,B=n.type.toLowerCase().replace("ms","");B=Ka[B];var C=La[n.pointerType]||
n.pointerType,E="touch"==C,H=u(w,n.pointerId,"pointerId");B&1&&(0===n.button||E)?0>H&&(w.push(n),H=w.length-1):B&12&&(y=!0);0>H||(w[H]=n,this.callback(this.manager,B,{pointers:w,changedPointers:[n],pointerType:C,srcEvent:n}),y&&w.splice(H,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(U,D,{handler:function(n){var w=Ma[n.type];1===w&&(this.started=!0);if(this.started){var y=x(n.touches);var B=x(n.changedTouches);w&12&&(y=z(y.concat(B),"identifier",!0));y=[y,B];w&12&&0===y[0].length-
y[1].length&&(this.started=!1);this.callback(this.manager,w,{pointers:y[0],changedPointers:y[1],pointerType:"touch",srcEvent:n})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ca="touchstart touchmove touchend touchcancel";l(T,D,{handler:function(n){var w=Na[n.type],y=S.call(this,n,w);y&&this.callback(this.manager,w,{pointers:y[0],changedPointers:y[1],pointerType:"touch",srcEvent:n})}});l(ia,D,{handler:function(n,w,y){var B="mouse"==y.pointerType;if(!(B&&y.sourceCapabilities&&y.sourceCapabilities.firesTouchEvents)){if("touch"==
y.pointerType)w&1?(this.primaryTouch=y.changedPointers[0].identifier,W.call(this,y)):w&12&&W.call(this,y);else{if(B)a:{B=y.srcEvent.clientX;for(var C=y.srcEvent.clientY,E=0;E<this.lastTouches.length;E++){var H=this.lastTouches[E],N=Math.abs(C-H.y);if(25>=Math.abs(B-H.x)&&25>=N){B=!0;break a}}B=!1}if(B)return}this.callback(n,w,y)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var ya=A(Fa.style,"touchAction"),za=ya!==e,pa=function(){if(!za)return!1;var n={},w=b.CSS&&b.CSS.supports;
"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(y){n[y]=w?b.CSS.supports("touch-action",y):!0});return n}();ea.prototype={set:function(n){"compute"==n&&(n=this.compute());za&&this.manager.element.style&&pa[n]&&(this.manager.element.style[ya]=n);this.actions=n.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var n=[];h(this.manager.recognizers,function(w){p(w.options.enable,[w])&&(n=n.concat(w.getTouchAction()))});return ma(n.join(" "))},
preventDefaults:function(n){var w=n.srcEvent,y=n.offsetDirection;if(this.manager.session.prevented)w.preventDefault();else{var B=this.actions,C=-1<B.indexOf("none")&&!pa.none,E=-1<B.indexOf("pan-y")&&!pa["pan-y"];B=-1<B.indexOf("pan-x")&&!pa["pan-x"];if(C){var H=2>n.distance,N=250>n.deltaTime;if(1===n.pointers.length&&H&&N)return}if(!B||!E)if(C||E&&y&6||B&&y&24)return this.preventSrc(w)}},preventSrc:function(n){this.manager.session.prevented=!0;n.preventDefault()}};P.prototype={defaults:{},set:function(n){Z(this.options,
n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var w=this.simultaneous;n=aa(n,this);w[n.id]||(w[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=aa(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;var w=this.requireFail;n=aa(n,this);-1===u(w,n)&&(w.push(n),n.requireFailure(this));
return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=aa(n,this);n=u(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function w(C){y.manager.emit(C,n)}var y=this,B=this.state;8>B&&w(y.options.event+ja(B));w(y.options.event);n.additionalEvent&&w(n.additionalEvent);8<=B&&w(y.options.event+ja(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);
this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=Z({},n);p(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};l(R,P,{defaults:{pointers:1},attrTest:function(n){var w=this.options.pointers;return 0===w||n.pointers.length===w},
process:function(n){var w=this.state,y=n.eventType,B=w&6;n=this.attrTest(n);return B&&(y&8||!n)?w|16:B||n?y&4?w|8:w&2?w|4:2:32}});l(fa,R,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,w=[];n&6&&w.push("pan-y");n&24&&w.push("pan-x");return w},directionTest:function(n){var w=this.options,y=!0,B=n.distance,C=n.direction,E=n.deltaX,H=n.deltaY;C&w.direction||(w.direction&6?(C=0===E?1:0>E?2:4,y=E!=this.pX,B=Math.abs(n.deltaX)):(C=0===
H?1:0>H?8:16,y=H!=this.pY,B=Math.abs(n.deltaY)));n.direction=C;return y&&B>w.threshold&&C&w.direction},attrTest:function(n){return R.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var w=na(n.direction);w&&(n.additionalEvent=this.options.event+w);this._super.emit.call(this,n)}});l(ka,R,{defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,
n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(ba,P,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var w=this.options,y=n.pointers.length===w.pointers,B=n.distance<w.threshold,C=n.deltaTime>w.time;this._input=n;if(!B||!y||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),
this._timer=f(function(){this.state=8;this.tryEmit()},w.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=qa(),this.manager.emit(this.options.event,this._input)))}});l(X,R,{defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.rotation)>
this.options.threshold||this.state&2)}});l(ca,R,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return fa.prototype.getTouchAction.call(this)},attrTest:function(n){var w=this.options.direction;if(w&30)var y=n.overallVelocity;else w&6?y=n.overallVelocityX:w&24&&(y=n.overallVelocityY);return this._super.attrTest.call(this,n)&&w&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&da(y)>this.options.velocity&&
n.eventType&4},emit:function(n){var w=na(n.offsetDirection);w&&this.manager.emit(this.options.event+w,n);this.manager.emit(this.options.event,n)}});l(la,P,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var w=this.options,y=n.pointers.length===w.pointers,B=n.distance<w.threshold,C=n.deltaTime<w.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(B&&C&&y){if(4!=
n.eventType)return this.failTimeout();y=this.pTime?n.timeStamp-this.pTime<w.interval:!0;B=!this.pCenter||O(this.pCenter,n.center)<w.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=B&&y?this.count+1:1;this._input=n;if(0===this.count%w.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},w.interval,this),2):8}return 32},failTimeout:function(){this._timer=f(function(){this.state=32},this.options.interval,this);return 32},reset:function(){clearTimeout(this._timer)},
emit:function(){8==this.state&&(this._input.tapCount=this.count,this.manager.emit(this.options.event,this._input))}});Y.VERSION="2.0.8";Y.defaults={domEvents:!1,touchAction:"compute",enable:!0,inputTarget:null,inputClass:null,preset:[[X,{enable:!1}],[ka,{enable:!1},["rotate"]],[ca,{direction:6}],[fa,{direction:6},["swipe"]],[la],[la,{event:"doubletap",taps:2},["tap"]],[ba]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};
ra.prototype={set:function(n){Z(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var w=this.session;if(!w.stopped){this.touchAction.preventDefaults(n);var y=this.recognizers,B=w.curRecognizer;if(!B||B&&B.state&8)B=w.curRecognizer=null;for(var C=0;C<y.length;){var E=y[C];2===w.stopped||B&&E!=B&&!E.canRecognizeWith(B)?E.reset():
E.recognize(n);!B&&E.state&14&&(B=w.curRecognizer=E);C++}}},get:function(n){if(n instanceof P)return n;for(var w=this.recognizers,y=0;y<w.length;y++)if(w[y].options.event==n)return w[y];return null},add:function(n){if(g(n,"add",this))return this;var w=this.get(n.options.event);w&&this.remove(w);this.recognizers.push(n);n.manager=this;this.touchAction.update();return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var w=this.recognizers;n=u(w,n);-1!==n&&(w.splice(n,1),this.touchAction.update())}return this},
on:function(n,w){if(n!==e&&w!==e){var y=this.handlers;h(t(n),function(B){y[B]=y[B]||[];y[B].push(w)});return this}},off:function(n,w){if(n!==e){var y=this.handlers;h(t(n),function(B){w?y[B]&&y[B].splice(u(y[B],w),1):delete y[B]});return this}},emit:function(n,w){this.options.domEvents&&Ea(n,w);var y=this.handlers[n]&&this.handlers[n].slice();if(y&&y.length)for(w.type=n,w.preventDefault=function(){w.srcEvent.preventDefault()},n=0;n<y.length;)y[n](w),n++},destroy:function(){this.element&&wa(this,!1);
this.handlers={};this.session={};this.input.destroy();this.element=null}};Z(Y,{INPUT_START:1,INPUT_MOVE:2,INPUT_END:4,INPUT_CANCEL:8,STATE_POSSIBLE:1,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:1,DIRECTION_LEFT:2,DIRECTION_RIGHT:4,DIRECTION_UP:8,DIRECTION_DOWN:16,DIRECTION_HORIZONTAL:6,DIRECTION_VERTICAL:24,DIRECTION_ALL:30,Manager:ra,Input:D,TouchAction:ea,TouchInput:T,MouseInput:J,PointerEventInput:Q,TouchMouseInput:ia,SingleTouchInput:U,
Recognizer:P,AttrRecognizer:R,Tap:la,Pan:fa,Swipe:ca,Pinch:ka,Rotate:X,Press:ba,on:q,off:v,each:h,merge:Ga,extend:xa,assign:Z,inherit:l,bindFn:m,prefixed:A});("undefined"!==typeof b?b:"undefined"!==typeof self?self:{}).Hammer=Y;"function"===typeof define&&define.amd?define(function(){return Y}):"undefined"!=typeof module&&module.exports?module.exports=Y:b[d]=Y})(window,document,"Hammer");
...
this.onPan=function(f){if(!(this.parameters.resize||this.parameters.eventCancel||this.parameters.zoomming||this.parameters.blockUiPan)&&f&&f.pointers&&1==f.pointers.length&&(this.swipeInterval&&this.swipeInterval.stop(),this.animateInterval&&this.animateInterval.stop(),this.parameters.zoomFlag&&(this.panForMove(this,f.deltaX,f.deltaY,!0),this.options&&this.options.onPan)))this.options.onPan()};this.onDoubleTap=function(f){if(!(BookEvent.trigger("beforeDoubleTap",[f])||BookInfo.getBook().status_resize||
BookInfo.getBook().flipping||(BookInfo.getBook().endFlip(),global.windowTapInterval&&window.clearTimeout(global.windowTapInterval),this.parameters.resize||this.parameters.eventCancel||this.parameters.zoomming)))if(this.status_zoom=!0,!this.parameters.zoomFlag)this.zoomIn(this),this.parameters.zoomOut=!1,this.animateToScale(this,this.middleScale,f);else if(this.parameters.zoomFlag){var g=this.parameters.naturalWidth/this.parameters.width;this.parameters.zoomOut=!0;this.animateToScale(this,g,f)}};this.zoomIn=
function(f){f.parameters.left=parseInt($(f).css("left"));f.parameters.top=parseInt($(f).css("top"));f.parameters.naturalLeft=f.parameters.left;f.parameters.naturalTop=f.parameters.top;f.parameters.width=$(f).width();f.parameters.height=$(f).height();f.parameters.naturalWidth=$(f).width();f.parameters.naturalHeight=$(f).height();f.parameters.zoomFlag=!0;f.parameters.zoomOut=!1;f.options&&f.options.zoomIn&&f.options.zoomIn()};this.zoomOut=function(f){f.swipeInterval&&f.swipeInterval.stop();f.animateInterval&&
f.animateInterval.stop();f.parameters.zoomFlag=!1;f.parameters.zoomOut=!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,p=0,q=0;f.animateInterval=function(v,r){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,
f.parameters.height*(g-1),20);p=$.easing.swing(null,m,f.parameters.left,f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);q=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:q+"px"});for(var t=0;t<f.side.pageArray.length;t++)if(f.side.pageArray[t])f.side.pageArray[t].onResize(k/2,l);m++;if(20<=m||v>=r){f.animateInterval.stop();
f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100;f.parameters.top=f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100;f.parameters.width*=g;f.parameters.height*=g;f.css({width:f.parameters.width+"px",height:f.parameters.height+"px",left:f.parameters.left+"px",top:f.parameters.top+"px"});for(t=0;t<f.side.pageArray.length;t++)if(f.side.pageArray[t])f.side.pageArray[t].onResize(f.parameters.width/2,f.parameters.height);f.parameters.zoomming=
...
this.parameters.eventCancel||this.parameters.zoomming||this.parameters.blockUiPan)&&d&&d.pointers&&1==d.pointers.length&&(this.swipeInterval&&this.swipeInterval.stop(),this.animateInterval&&this.animateInterval.stop(),this.parameters.zoomFlag)){"panstart"==d.type&&(this.parameters.onPan=!0);var e=this.getDelta(d);e=this.panForMove(this,e.deltaX,e.deltaY,!0);if(this.options&&this.options.onPan)this.options.onPan();if("panend"==d.type||"pancancel"==d.type)this.parameters.onPan=!1,this.setZoomParameters(this,
e),this.restrictInBoundary(this)}};this.onSwipe=function(d){if(!(this.parameters.resize||this.parameters.eventCancel||this.parameters.zoomming||this.parameters.blockUiPan))if(this.parameters.zoomFlag){var e=this.parameters.tran,f=this.tranLimit(this,this.parameters.scale,this.parameters.tran);if(f.x==parseInt(e.x)&&f.y==parseInt(e.y)){this.animateInterval&&this.animateInterval.stop();this.swipeInterval&&this.swipeInterval.stop();var g=0,h=0;d=this.getVelocity(d);g=d.velocityX;h=d.velocityY;this.swipeInterval=
function(k,l){var m=this.parameters.tran,p=this.tranLimit(this,this.parameters.scale,this.parameters.tran);p.x!=parseInt(m.x)||p.y!=parseInt(m.y)?(this.swipeInterval.stop(),this.restrictInBoundary(this)):(m=(l-k)/l,m=this.panForMove(this,g*m*16.7,h*m*16.7,!0),this.setZoomParameters(this,m),k>=l&&(this.swipeInterval.stop(),this.restrictInBoundary(this)))}.animation(this,320)}}else d=this.getDirection(d),this.options&&this.options.swipeend&&this.options.swipeend(d)};this.getDirection=function(d){var e,
f=bookConfig.upsideOnMobile();d.direction&Hammer.DIRECTION_RIGHT&&!f&&(e="right");d.direction&Hammer.DIRECTION_LEFT&&!f&&(e="left");d.direction&Hammer.DIRECTION_UP&&!f&&(e="up");d.direction&Hammer.DIRECTION_DOWN&&!f&&(e="down");d.direction&Hammer.DIRECTION_RIGHT&&f&&(e="down");d.direction&Hammer.DIRECTION_LEFT&&f&&(e="up");d.direction&Hammer.DIRECTION_UP&&f&&(e="left");d.direction&Hammer.DIRECTION_DOWN&&f&&(e="right");return e};this.getVelocity=function(d){var e=0,f=0,g=bookConfig.upsideOnMobile();
0==d.velocityX||g||(e=d.velocityX);0==d.velocityY||g||(f=d.velocityY);0!=d.velocityX&&g&&(e=d.velocityY);0!=d.velocityY&&g&&(f=-d.velocityX);return{velocityX:e,velocityY:f}};this.getDelta=function(d){var e=0,f=0,g=bookConfig.upsideOnMobile();0==d.deltaX||g||(e=d.deltaX);0==d.deltaY||g||(f=d.deltaY);0!=d.deltaX&&g&&(e=d.deltaY);0!=d.deltaY&&g&&(f=-d.deltaX);return{deltaX:e,deltaY:f}};this.onDoubleTap=function(d){if(!(BookEvent.trigger("beforeDoubleTap",[d])||BookInfo.getBook().status_resize||BookInfo.getBook().flipping||
(BookInfo.getBook().endFlip(),global.windowTapInterval&&window.clearTimeout(global.windowTapInterval),this.parameters.resize||this.parameters.zoomming)))if(BookInfo.getBook().unSelect(),this.status_zoom=!0,!this.parameters.zoomFlag)BookEvent.trigger("zoomIn",["double tap",BookInfo.getCurrentPages().join("-")]),this.zoomIn(this),this.parameters.origin=this.mathOrigin(this,d),this.originObj(this,this.parameters.origin),this.parameters.zoomOut=!1,this.animateToScale(this,this.middleScale,d);else if(this.parameters.zoomFlag){this.beforeZoomOut(this);
BookEvent.trigger("zoomOut",["double tap",BookInfo.getCurrentPages().join("-")]);var e=this.parameters.naturalWidth/this.parameters.width;this.parameters.zoomOut=!0;this.animateToScale(this,e,d)}};this.onPinch=function(d){"pinchstart"==d.type&&(this.pinchStart=!0);if(!(this.parameters.resize||this.parameters.zoomming||!this.parameters.zoomFlag&&1>=d.scale)&&d&&d.pointers){BookInfo.getBook().unSelect();this.animateInterval&&this.animateInterval.stop();this.swipeInterval&&this.swipeInterval.stop();
var e=function(){this.pinchStart=!1;this.parameters.zoomFlag||(this.parameters.zoomOut=!1,this.zoomIn(this));BookEvent.trigger("zoomIn",["pinch",BookInfo.getCurrentPages().join("-")]);this.scale=this.parameters.toScale;this.parameters.origin=this.mathOrigin(this,d);this.originObj(this,this.parameters.origin);this.pinchMoveIn(this,parseFloat(this.scale)*parseFloat(d.scale),d,this.parameters.origin)}.bind(this);"pinchstart"==d.type&&(this.parameters.onPinch=!0,e(d));"pinchend"==d.type&&(this.parameters.scale=
this.parameters.toScale,this.parameters.onPinch=!1,this.exceedScale(this,d),this.pinchStart=!1);"pinchmove"==d.type&&(this.pinchStart&&e(d),this.pinchMoveIn(this,parseFloat(this.scale)*parseFloat(d.scale),d,this.parameters.origin));"pinchcancel"==d.type&&(this.parameters.scale=this.parameters.toScale,this.parameters.onPinch=!1,this.exceedScale(this,d),this.pinchStart=!1)}};this.exceedScale=function(d,e){var f=d.parameters.width*d.parameters.toScale/d.parameters.naturalWidth,g=d.parameters.width*d.parameters.toScale,
h=d.parameters.height*d.parameters.toScale,k=d.parameters.naturalWidth*d.maxScale/d.parameters.width,l=d.parameters.naturalWidth/d.parameters.width,m=d.parameters.toScale;f>d.maxScale&&(m=k);if(1>f||g<windowWidth&&h<windowHeight)d.parameters.zoomOut=!0,m=l;d.animateToScale(d,m,e)};this.zoomIn=function(d){var e=this.getBookOffset($(d));d.parameters.tran=getTransform(d[0]);d.parameters.left=e.left-d.parameters.tran.x;d.parameters.top=e.top-d.parameters.tran.y;d.parameters.width=$(d).width();d.parameters.height=
$(d).height();d.parameters.naturalWidth=$(d).width();d.parameters.naturalHeight=$(d).height();d.setZoomSize();d.parameters.zoomFlag=!0;d.parameters.zoomOut=!1;d.options&&d.options.zoomIn&&d.options.zoomIn(d.parameters)};this.beforeZoomOut=function(d){d.options&&d.options.beforeZoomOut&&d.options.beforeZoomOut()};this.zoomOut=function(d){d.swipeInterval&&d.swipeInterval.stop();d.animateInterval&&d.animateInterval.stop();d.parameters.zoomFlag=!1;d.parameters.zoomOut=!0;d.parameters.toScale=1;d.parameters.scale=
1;d.options&&d.options.zoomOut&&d.options.zoomOut()};this.tranLimit=function(d,e,f){if(f){if(d.parameters.zoomOut){f={x:0,y:0};f.x=d.parameters.width*(e-1)*d.parameters.origin.x/100;f.y=d.parameters.height*(e-1)*d.parameters.origin.y/100;if((bookType==BookType.normal_book||bookType==BookType.catalog_book)&&bookConfig.retainBookCenter&&d.isBook){var g=BookInfo.getCurrentPages();1==g.length&&"issuu"!=bookConfig.FlipStyle&&(!BookInfo.isLeftPage(g[0],!0)&&bookConfig.FlipDirection&&(f.y-=d.parameters.height*
...
100;var p=e*h,q=e*k,v=0,r=0,t=0,u=0;toolBar&&(v=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,r=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,t=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,u=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var x=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-u;l=-l-h*e*d.parameters.zoomArea.left/100+t}else x=-l-h*e*d.parameters.zoomArea.left/100+t,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-
u;q>windowHeight?(h=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-r,d=-m-k*e*d.parameters.zoomArea.top/100+v):(h=-m-k*e*d.parameters.zoomArea.top/100+v,d=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-r);g=Number.between(g,x,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
...
function(l,m){var p=$.easing.easeOutBack(null,l,0,h,m),q=$.easing.easeOutBack(null,l,0,k,m);0<l&&(p-=$.easing.easeOutBack(null,l-1,0,h,m),q-=$.easing.easeOutBack(null,l-1,0,k,m));l>=m&&(q=d.parameters.tran,p=g.x-q.x,q=g.y-q.y);p=d.panForMove(d,p,q);d.setZoomParameters(d,p);l>=m&&(d.animateInterval.stop(),BookInfo.getBook().bookAttachments&&BookInfo.getBook().bookAttachments.Items.find("ZoomMap").each(function(v){v.refreshArea()}),e&&"function"==typeof e&&e())}.animation(this,320)}}};this.transformSetting=
...
$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,q){m(p,q,"Sine")}).animation(this,300)}.bind(this),m=function(p,q,v){if(p<q){v=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,q);var r=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,q);p=k(null,p,this.parameters.scale,d-this.parameters.scale,q);q={};q.scale=
p;q.tran={x:v,y:r};v=transformCSS(q);this.css(v)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=
this.tranLimit(d,e,h.tran);this.zoomTran=h;this.animation(d,e,h,g)}};this.animation=function(d,e,f,g){var h=transformCSS(f);d.originObj(d,f.origin);animateOnce(d,h,void 0==g?600:g,function(){getTransform(d[0]);d.transformSetting(d,f);d.parameters.scale=e;d.parameters.toScale=e;d.parameters.zoomming=!1;var k=(d.parameters.width*d.parameters.toScale).toFixed(2),l=(d.parameters.height*d.parameters.toScale).toFixed(2),m=d.parameters.naturalWidth,p=d.parameters.naturalHeight;if(Number.isBetween(k,m-1,
m+1)||Number.isBetween(l,p-1,p+1)){d.timeout&&(d.timeout=void 0,window.clearTimeout(d.timeout));d.parameters.zoomDelay=!1;if(d.options.onZoomed)d.options.onZoomed(d.zoomTran);d.zoomOut(d)}else if(d.options.onZoomed)d.options.onZoomed(d.zoomTran)}.bind(d),"%stransform","cubic-bezier(0.2150, 0.610, 0.3550, 1)")};this.delayExecuteOnZoomed=function(d){d.timeout=window.setTimeout(function(){if(d.parameters.zoomFlag&&!d.parameters.onPinch&&!d.parameters.zoomming)d.options.onZoomed(d.zoomTran);d.parameters.zoomDelay=
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),p=getHost();if(m&&p!==m){if(g=f.src.replace(m,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(u){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var q=h.getImageData(0,0,k,l),v=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&q){var r=Color(b).split();k=0;for(var t=q.data.length;k<t;k+=4)0<v.data[k+3]&&(q.data[k]!=r.r&&(v.data[k]=q.data[k]/255*r.r),q.data[k+1]!=r.g&&(v.data[k+1]=
q.data[k+1]/255*r.g),q.data[k+2]!=r.b&&(v.data[k+2]=q.data[k+2]/255*r.b));h.putImageData(v,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(u){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(x){}})}}}}};
...
$.fn.speed=function(b){function c(t){t=void 0==t.originalEvent.touches?[t]:t.originalEvent.touches;if(1<t.length)return q=!0;f=h=t[0].pageX;g=k=t[0].pageY;l=new Date;-1!=p&&window.clearInterval(p);p=window.setInterval(function(){f=h;g=k;l=new Date},300)}function d(t){if(-1==p||1==q)return!0;t=void 0==t.originalEvent.touches?[t]:t.originalEvent.touches;h=t[0].pageX;k=t[0].pageY}function e(t){if(-1==p)return!0;t=void 0!=t.originalEvent.touches==0?[t]:t.originalEvent.touches;if(1==q)return q=1<t.length,
!0;m=new Date;t=(m-l)/20;var u=h-f,x=k-g;0==t?r=v=0:(v=u/t,r=x/t);void 0!=b&&b(v,r);window.clearInterval(p);p=-1}var f,g,h,k,l,m,p=-1,q=!1,v=0,r=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(t){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(t){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",p=-1,q,v,r,t=k.length-l;++p<t;)q=k.charCodeAt(p)<<
16,v=k.charCodeAt(++p)<<8,r=k.charCodeAt(++p),q=q+v+r,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q&63);2==l?(q=k.charCodeAt(p)<<8,v=k.charCodeAt(++p),q+=v,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<2&63)+"="):1==l&&(q=k.charCodeAt(p),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,p,q,v="",r=-1;++r<l;)q="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(r)),
p=m%4?64*p+q:q,m++%4&&(v+=String.fromCharCode(255&p>>(-2*m&6)));return v},version:"0.1.0"};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return g});else if(c&&!c.nodeType)if(d)d.exports=g;else for(var h in g)g.hasOwnProperty(h)&&(c[h]=g[h]);else b.base64=g})(this);function parsHexToNormalString(b){for(var c="";2<=b.length;)c+=String.fromCharCode(parseInt(b.substring(0,2),16)),b=b.substring(2,b.length);return c}
...
(function(b){function c(r,t){var u=(r&65535)+(t&65535);return(r>>16)+(t>>16)+(u>>16)<<16|u&65535}function d(r,t,u,x,z,A){r=c(c(t,r),c(x,A));return c(r<<z|r>>>32-z,u)}function e(r,t,u,x,z,A,F){return d(t&u|~t&x,r,t,z,A,F)}function f(r,t,u,x,z,A,F){return d(t&x|u&~x,r,t,z,A,F)}function g(r,t,u,x,z,A,F){return d(u^(t|~x),r,t,z,A,F)}function h(r,t){r[t>>5]|=128<<t%32;r[(t+64>>>9<<4)+14]=t;var u=1732584193,x=-271733879,z=-1732584194,A=271733878;for(t=0;t<r.length;t+=16){var F=u;var D=x;var L=z;var M=A;
u=e(u,x,z,A,r[t],7,-680876936);A=e(A,u,x,z,r[t+1],12,-389564586);z=e(z,A,u,x,r[t+2],17,606105819);x=e(x,z,A,u,r[t+3],22,-1044525330);u=e(u,x,z,A,r[t+4],7,-176418897);A=e(A,u,x,z,r[t+5],12,1200080426);z=e(z,A,u,x,r[t+6],17,-1473231341);x=e(x,z,A,u,r[t+7],22,-45705983);u=e(u,x,z,A,r[t+8],7,1770035416);A=e(A,u,x,z,r[t+9],12,-1958414417);z=e(z,A,u,x,r[t+10],17,-42063);x=e(x,z,A,u,r[t+11],22,-1990404162);u=e(u,x,z,A,r[t+12],7,1804603682);A=e(A,u,x,z,r[t+13],12,-40341101);z=e(z,A,u,x,r[t+14],17,-1502002290);
x=e(x,z,A,u,r[t+15],22,1236535329);u=f(u,x,z,A,r[t+1],5,-165796510);A=f(A,u,x,z,r[t+6],9,-1069501632);z=f(z,A,u,x,r[t+11],14,643717713);x=f(x,z,A,u,r[t],20,-373897302);u=f(u,x,z,A,r[t+5],5,-701558691);A=f(A,u,x,z,r[t+10],9,38016083);z=f(z,A,u,x,r[t+15],14,-660478335);x=f(x,z,A,u,r[t+4],20,-405537848);u=f(u,x,z,A,r[t+9],5,568446438);A=f(A,u,x,z,r[t+14],9,-1019803690);z=f(z,A,u,x,r[t+3],14,-187363961);x=f(x,z,A,u,r[t+8],20,1163531501);u=f(u,x,z,A,r[t+13],5,-1444681467);A=f(A,u,x,z,r[t+2],9,-51403784);
z=f(z,A,u,x,r[t+7],14,1735328473);x=f(x,z,A,u,r[t+12],20,-1926607734);u=d(x^z^A,u,x,r[t+5],4,-378558);A=d(u^x^z,A,u,r[t+8],11,-2022574463);z=d(A^u^x,z,A,r[t+11],16,1839030562);x=d(z^A^u,x,z,r[t+14],23,-35309556);u=d(x^z^A,u,x,r[t+1],4,-1530992060);A=d(u^x^z,A,u,r[t+4],11,1272893353);z=d(A^u^x,z,A,r[t+7],16,-155497632);x=d(z^A^u,x,z,r[t+10],23,-1094730640);u=d(x^z^A,u,x,r[t+13],4,681279174);A=d(u^x^z,A,u,r[t],11,-358537222);z=d(A^u^x,z,A,r[t+3],16,-722521979);x=d(z^A^u,x,z,r[t+6],23,76029189);u=d(x^
z^A,u,x,r[t+9],4,-640364487);A=d(u^x^z,A,u,r[t+12],11,-421815835);z=d(A^u^x,z,A,r[t+15],16,530742520);x=d(z^A^u,x,z,r[t+2],23,-995338651);u=g(u,x,z,A,r[t],6,-198630844);A=g(A,u,x,z,r[t+7],10,1126891415);z=g(z,A,u,x,r[t+14],15,-1416354905);x=g(x,z,A,u,r[t+5],21,-57434055);u=g(u,x,z,A,r[t+12],6,1700485571);A=g(A,u,x,z,r[t+3],10,-1894986606);z=g(z,A,u,x,r[t+10],15,-1051523);x=g(x,z,A,u,r[t+1],21,-2054922799);u=g(u,x,z,A,r[t+8],6,1873313359);A=g(A,u,x,z,r[t+15],10,-30611744);z=g(z,A,u,x,r[t+6],15,-1560198380);
x=g(x,z,A,u,r[t+13],21,1309151649);u=g(u,x,z,A,r[t+4],6,-145523070);A=g(A,u,x,z,r[t+11],10,-1120210379);z=g(z,A,u,x,r[t+2],15,718787259);x=g(x,z,A,u,r[t+9],21,-343485551);u=c(u,F);x=c(x,D);z=c(z,L);A=c(A,M)}return[u,x,z,A]}function k(r){var t,u="",x=32*r.length;for(t=0;t<x;t+=8)u+=String.fromCharCode(r[t>>5]>>>t%32&255);return u}function l(r){var t,u=[];u[(r.length>>2)-1]=void 0;for(t=0;t<u.length;t+=1)u[t]=0;var x=8*r.length;for(t=0;t<x;t+=8)u[t>>5]|=(r.charCodeAt(t/8)&255)<<t%32;return u}function m(r){return k(h(l(r),
8*r.length))}function p(r,t){var u=l(r),x=[],z=[];x[15]=z[15]=void 0;16<u.length&&(u=h(u,8*r.length));for(r=0;16>r;r+=1)x[r]=u[r]^909522486,z[r]=u[r]^1549556828;t=h(x.concat(l(t)),512+8*t.length);return k(h(z.concat(t),640))}function q(r){var t="",u;for(u=0;u<r.length;u+=1){var x=r.charCodeAt(u);t+="0123456789abcdef".charAt(x>>>4&15)+"0123456789abcdef".charAt(x&15)}return t}function v(r,t,u){t?u?r=p(unescape(encodeURIComponent(t)),unescape(encodeURIComponent(r))):(r=p(unescape(encodeURIComponent(t)),
unescape(encodeURIComponent(r))),r=q(r)):r=u?m(unescape(encodeURIComponent(r))):q(m(unescape(encodeURIComponent(r))));return r}"function"===typeof define&&define.amd?define(function(){return v}):"object"===typeof module&&module.exports?module.exports=v:b.md5=v})(this);String.prototype.MD5=function(b){return md5(this)};
...
for(var d=0;d<b.length;d++){var e=b[d];if(global.selectedLanguage&&selectedLanguage[e])return selectedLanguage[e]}}return c},LANGUAGE_CODE_MAP={arabic:"ar","chinese (traditional)":"zh-TW",chinese:"zh-CN",czech:"cs",danish:"da",dutch:"nl",english:"en",finnish:"fi",french:"fr",german:"de",greek:"el",hebrew:"he",hindi:"hi",hungarian:"hu",indonesian:"id",italian:"it",japanese:"ja",korean:"ko",macedonian:"mk",malay:"ms",persian:"fa",portuguese:"pt",romanian:"ro",russian:"ru",spanish:"es",basque:"eu",bengali:"bn",
polish:"pl",swedish:"sv",thai:"th",turkish:"tr",ukrainian:"uk",vietnamese:"vi"},LANGUAGE_VALUE_MAP={en:"en","de-DE":"de",fr:"fr","es-ES":"es","pt-PT":"pt","it-IT":"it","ar-SA":"ar","ja-JP":"ja",ko:"ko","nl-NL":"nl","ru-RU":"ru","sv-SE":"sv","da-DK":"da","pl-PL":"pl","fi-FI":"fi","tr-TR":"tr","el-GR":"el","cs-CZ":"cs","hu-HU":"hu","ro-RO":"ro","uk-UK":"uk","he-IL":"he",th:"th",hi:"hi","ms-MY":"ms",id:"id","vi-VI":"vi","zh-CN":"zh-cn","zh-TW":"zh-tw"},LANGUAGE_VALUE_NORMALIZED_MAP={};
Object.keys(LANGUAGE_VALUE_MAP).forEach(function(b){LANGUAGE_VALUE_NORMALIZED_MAP[b.toLowerCase()]=LANGUAGE_VALUE_MAP[b]});var LANGUAGE_CODE_REVERSE_MAP={};Object.keys(LANGUAGE_CODE_MAP).forEach(function(b){LANGUAGE_CODE_REVERSE_MAP[LANGUAGE_CODE_MAP[b].toLowerCase()]=b});
var resolveLanguageInput=function(b){if(!b)return"";b=b.toLowerCase().trim();if(LANGUAGE_CODE_MAP[b])return b;LANGUAGE_VALUE_NORMALIZED_MAP[b]&&(b=LANGUAGE_VALUE_NORMALIZED_MAP[b]);if(LANGUAGE_CODE_REVERSE_MAP[b])return LANGUAGE_CODE_REVERSE_MAP[b];var c=b.split("-")[0];return c!==b&&LANGUAGE_CODE_REVERSE_MAP[c]?LANGUAGE_CODE_REVERSE_MAP[c]:b},getLanguageCode=function(b){b=resolveLanguageInput(b);return LANGUAGE_CODE_MAP[b]?LANGUAGE_CODE_MAP[b]:""},getFullLanguageName=function(b){return resolveLanguageInput(b)},
REMOTE_LANGUAGE_BASE_URL="/resourceFiles/html5_templates/language/",fetchRemoteLanguage=function(b){return b?fetch(REMOTE_LANGUAGE_BASE_URL+b+".json").then(function(c){return c.ok?c.json():null}).catch(function(){return null}):Promise.resolve(null)},selectedLanguage,selectLanguage=function(b){var c,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress){b||(b="");global.language||(global.language=[]);selectedLanguage=[];c="";if(b&&0<b.length){d=[];try{d="string"===
typeof b?b.toLowerCase().split(";"):b,d=0<d.length?d:[],c=d[0]}catch(l){c=""}}if(c)for(e=getFullLanguageName(c),f=0;f<language.length;f++){if(language[f].language.toLowerCase()==e){selectedLanguage=language[f];break}}else 0<language.length&&(selectedLanguage=language[0]);return selectedLanguage&&selectedLanguage.language?k.jumpTo(2):k.yield(fetchRemoteLanguage(getLanguageCode(c)),3)}2!=k.nextAddress&&(g=k.yieldResult)&&(language.push(g),selectedLanguage=g);BookEvent.trigger("selectedLanguage",[]);
global.selectedLanguage&&global.selectedLanguage.language&&(h=getLanguageCode(global.selectedLanguage.language))&&document.querySelector("html").setAttribute("lang",h);k.jumpToEnd()})},handleData=function(b,c){if(100>b.length)return b;if(!c||!c.trim())return 100<b.length?b.substring(0,100)+"..":b;var d=HTMLString.containsChinese(c),e=b.length,f=-1;if(d){var g=(d="Chinese"!==UserGroups)?HTMLString.removeSpacesNewlinesAndPunctuation.bind(HTMLString):HTMLString.removeSpacesAndNewlines.bind(HTMLString);
d=d?/[\s\r\n\u3000-\u303f\uff00-\uffef.,;:?!'"()\-\[\]{}\uff0c\u3002\u3001\uff1b\uff1a\uff1f\uff01""''\uff08\uff09\u3010\u3011\u300a\u300b\u2014\u2026\u00b7]/:/[\s\r\n]/;var h=g(b.toLowerCase());c=g(c.toLowerCase());c=h.indexOf(c);if(-1!==c){g=[];for(h=0;h<b.length;h++)d.test(b[h])||g.push(h);c<g.length&&(f=g[c])}}else f=b.toLowerCase().indexOf(c.toLowerCase());if(-1===f)return 100<b.length?b.substring(0,100)+"..":b;50<=f?(d=Math.max(50<=e-f?f-50:e-100,0),d=".."+b.substring(d,f)):d=b.substring(0,
f);b=50<e-f?b.substring(f,50<=f?f+50:100)+"..":b.substring(f,e);return d+b},onWindowTap=function(b){b=BookInfo.getBook&&BookInfo.getBook();b&&(b.status_zoom||b.isZoomming||b.status_resize||b.flipping)||(Log.print("onWindowTapEnter"),global.windowTapInterval&&window.clearTimeout(global.windowTapInterval),global.windowTapInterval=window.setTimeout(function(){if("Modern"!==_get(htmlConfig,"phoneTemplate.name"))if(global.moreBar&&moreBar.visible)moreBar.hide();else{if(isPhone()||isPad()){if(bookConfig.toolbarAlwaysShow)return;
global.phoneSearchBar&&global.phoneSearchBar.showOrHide();global.toolBar&&global.toolBar.showOrHide()}global.windowTapInterval&&window.clearTimeout(global.windowTapInterval)}},401))},stopEvent=function(b){try{var c=b||window.event;c.preventDefault?(c.preventDefault(),c.stopPropagation()):(c.returnValue=!1,c.cancelBubble=!0)}catch(d){}return!1},getPagesByRange=function(b){function c(k){for(var l=0;l<d.length;l++)if(d[l]==k)return!0;return!1}var d=[];if(!b||"string"!==typeof b||""==b.trim())return d;
b=b.split(",");for(var e=0;e<b.length;e++){var f=b[e];if(!isNaN(f))f=getRealPageNumber(f),!c(f)&&f<=bookConfig.totalPageCount&&d.push(f);else if(-1<f.indexOf("-")){var g=f.split("-");if(!(2>g.length)){f=getRealPageNumber(g[0]);var h=getRealPageNumber(g[1]);g=Math.max(f,h);for(f=Math.min(f,h);f<=g;f++)f>bookConfig.totalPageCount||c(f)||d.push(f)}}}return d},isSlideBook=function(){return"slide"==bookConfig.FlipStyle.toLowerCase()||isBelowIE9()?!0:!1};
...
"px",width:bookConfig.adSenseWidth+"px",height:bookConfig.adSenseHeight+"px"});c.bind(_event._down,function(){BookEvent.trigger("googleAdSense",[bookConfig.adSenseClientId,bookConfig.adSenseSlotId,bookConfig.adSenseLeft,bookConfig.adSenseTop,bookConfig.adSenseWidth,bookConfig.adSenseHeight])});tmpContainer.append(c);c.append(b);(window.adsbygoogle=window.adsbygoogle||[]).push({})})}
var changeLanguage=function(b){return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(selectLanguage(b),2);global.toolBar&&toolBar.changeLanguage&&toolBar.changeLanguage();global.printBody&&printBody.changeLanguage();global.helpBody&&helpBody.changeLanguage();global.aboutBody&&aboutBody.changeLanguage();global.sharePanel&&sharePanel.changeLanguage();global.languagePanel&&languagePanel.changeLanguage();global.videoGallery&&videoGallery.changeLanguage();global.photoGallery&&
photoGallery.changeLanguage();global.bookmark&&bookmark.changeLanguage();global.frmTableOfContent&&frmTableOfContent.changeLanguage();global.frmSearch&&frmSearch.changeLanguage();global.thumbnail&&thumbnail.changeLanguage();global.bookInstructions&&global.bookInstructions.changeLanguage&&global.bookInstructions.changeLanguage();global.telephoneNumberForm&&global.telephoneNumberForm.changeLanguage();global.settingBody&&global.settingBody.changeLanguage();global.doubleSinglePageForm&&global.doubleSinglePageForm.changeLanguage();
global.downLoadBody&&global.downLoadBody.changeLanguage();global.annotationPannel&&global.annotationPannel.changeLanguage();global.jsLoadingBar&&global.jsLoadingBar.changeLanguage(b);global.reportPanel&&global.reportPanel.changeLanguage(b);global.chatbotPanel&&global.chatbotPanel.changeLanguage(b);global.accessiblePanel&&global.accessiblePanel.changeLanguage();global.modernSearch&&global.modernSearch.changeLanguage();global.modernBookmarkPanel&&global.modernBookmarkPanel.changeLanguage();global.modernThumbnailsPanel&&
global.modernThumbnailsPanel.changeLanguage();global.modernSelectTextPanel&&global.modernSelectTextPanel.changeLanguage();global.modernSettingBody&&global.modernSettingBody.changeLanguage();global.modernTelephonePanel&&global.modernTelephonePanel.changeLanguage();global.modernSecondaryPanel&&global.modernSecondaryPanel.changeLanguage();BookEvent.trigger("changeLanguage",[]);c.jumpToEnd()})},baiduAnalytics=function(){bookConfig.baiduAnalyticsID&&window.setTimeout(function(){var b=document.createElement("script");
b.src=baiduUrl+"?"+bookConfig.baiduAnalyticsID;var c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(b,c)},3E3)},controlAudioVolume=function(){if(!isNaN(bookConfig.bgSoundVol)){var b=parseFloat(bookConfig.bgSoundVol/100);global.bgSound&&global.bgSound.setVolume(b);flipAudio&&(flipAudio[0].volume=b)}},TurnonAutoFlip=function(){bookConfig.autoFlipOnStart&&window.setTimeout(function(){auto_player&&auto_player.start();toolBar&&toolBar.changeAutoPlayIcon&&toolBar.changeAutoPlayIcon()},
1E3)},playFlipSound=function(){if(global.flipSoundIsPlaying)if(!isPhone()&&!isPad()&&!isIE()){var b="flipsound";if(bookType==BookType.slide_book||bookType==BookType.singleSlide_book)b="slidesound";var c=soundBaseURL+b+".mp3";b=soundBaseURL+b+".ogg";bookConfig.flipSoundURL&&(b=c=bookConfig.flipSoundURL);0<$("#flippingSound").length&&$("#flippingSound").remove();c=$("<audio id='flippingSound' preload style='display:none;'>\n        \"<source src='"+b+"?2024070101' type='audio/ogg'>\n        \"<source src='"+
c+"?2024070101' type='audio/mpeg'>\n        </audio>");$("body").append(c);b=parseFloat(bookConfig.bgSoundVol/100);c[0].volume=b;c.bind("ended",function(){$(this).remove()});try{c[0].currentTime=0,c[0].play()}catch(d){}}else if(!isPlaying||!isAndroidDefault())try{flipAudio[0].currentTime=0,flipAudio[0].play()}catch(d){}},initFlipSound=function(){if(isPhone()||isPad()||isIE()){var b="flipsound";if(bookType==BookType.slide_book||bookType==BookType.singleSlide_book)b="slidesound";var c=soundBaseURL+
b+".mp3";b=soundBaseURL+b+".ogg";bookConfig.flipSoundURL&&(b=c=bookConfig.flipSoundURL);flipAudio=$("<audio preload id='flipSound'>\n      <source src='"+b+"?2024081201' type='audio/ogg'>\n      <source src='"+c+"?2024081201' type='audio/mpeg'>\n      </audio>");$("body").append(flipAudio)}},initSettingBody=function(){(isPhone()||isPad())&&"neat"===_get(htmlConfig,"phoneTemplate.name")&&"Chinese"==UserGroups?global.toolBar&&global.toolBar.$morePanel&&global.toolBar.$morePanel.appendMusicButton&&global.toolBar.$morePanel.appendMusicButton():
global.settingBody?global.settingBody.reset&&global.settingBody.reset():isPhone()||isPad()?global.settingBody=new PhoneSettingForm({parent:tmpContainer,formType:"setting",rightToLeft:rightToLeft}):global.settingBody=new PcSoundSettingForm({parent:tmpContainer,formType:"brief"==global.templeteName?"setting":"settingpc",rightToLeft:rightToLeft})};function copyFromObj(b){if(b){b.focus();b.select();try{document.execCommand("Copy")}catch(c){b=b.val(),copyToClipboard(b)}}}
function mergeCurrentPageIntoUrlHash(b){if(!b||"undefined"===typeof BookInfo||!BookInfo.getCurrentPageIndex)return b;var c=BookInfo.getCurrentPageIndex();c="function"===typeof getEncodedPageHashValue?getEncodedPageHashValue(c):"function"===typeof getShownPageNumber?encodeURIComponent(String(getShownPageNumber(c))):String(c);var d=b.indexOf("#"),e=0<=d?b.slice(0,d):b;b=0<=d?b.slice(d+1):"";b=b.length?b.split("&"):[];d=[];for(var f=0;f<b.length;f++)/^p=/i.test(b[f])||d.push(b[f]);b=d.join("&");return e+
"#"+(b.length?"p="+c+"&"+b:"p="+c)}function getShareUrlWithCurrentPageIfNeeded(b){b=b||("undefined"!==typeof share_url?share_url:window.location.href);return bookConfig.addCurrentPage?mergeCurrentPageIntoUrlHash(b):b}
...
function resizeIssuuBook(){if("issuu"==bookConfig.FlipStyle&&(bookType==BookType.normal_book||bookType==BookType.single_book)){if(global.flipBook){var b=flipBook.getCurrentPageIndex(),c=flipBook.getSpace(),d=flipBook.getFitWHByIndex(b),e=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);var f=(windowWidth-c.left-c.right-e)/2+c.left;c=(windowHeight-c.top-c.bottom-d)/2+c.top;var g=-e/4,h=e/4,k=0,l=!1;flipBook.getMovedXByIndex?(b={tran:{x:0,y:0},scale:1,origin:{x:0,y:0},top:c,left:f},flipBook.setCSS(b),l=!0):
1==bookConfig.retainBookCenter&&(BookInfo.isCoverPage(b)&&BookInfo.isLeftPage(b,!0)&&(k=h),BookInfo.isCoverPage(b)&&!BookInfo.isLeftPage(b,!0)&&(k=g),b={tran:{x:parseInt(k),y:0},scale:1,origin:{x:0,y:0},top:c,left:f},flipBook.setCSS(b),l=!0);bookType==BookType.normal_book&&useTheAliCloudChartOnIsuuBook(e,d);flipBook.onResize(e,d);l&&flipBook.resizeAttachments&&flipBook.resizeAttachments(e,d);flipBook.resetZoomConfig()}global.singlePageBook&&(bookConfig.isSingleBookFullWindowOnMobile&&(isPhone()||
isPad())?(e=windowWidth,d=windowHeight,f=b=0):(b=singlePageBook.getCurrentPageIndex(),d=singlePageBook.getFitWHByIndex(b),e=d[0].x,d=d[0].y,c=singlePageBook.getSpace(!0),b=(windowWidth-c.left-c.right-e)/2+c.left,f=(windowHeight-c.top-c.bottom-d)/2+c.top),bookType==BookType.single_book&&useTheAliCloudChartOnIsuuBook(e,d),singlePageBook.setCSS({top:f,left:b,tran:{x:0,y:0},scale:1,origin:{x:0,y:0}}),singlePageBook.onResize(e,d),singlePageBook.resizeAttachments&&singlePageBook.resizeAttachments(e,d),
singlePageBook.resetZoomConfig())}}
...
new PcSingleDocViewBook(c)}function shouldShowMiniFullscreen(){var b=isPhone()||isPad()?bookConfig.isShowMobileBottomFullscreenPrompts:bookConfig.isShowBottomFullscreenPrompts;return void 0===b?!bookConfig.hideMiniFullscreen:!!b}
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this;k=d(h);var m=void 0!==k&&null!==k?k:"__default__";e[m]&&clearTimeout(e[m]);return new Promise(function(p,q){f[m]||(f[m]=[]);f[m].push({resolve:p,reject:q});e[m]=setTimeout(function(){var v,r,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:return v=f[m],u.setCatchFinallyBlocks(2,3),u.yield(b.apply(l,
h),5);case 5:r=u.yieldResult,v&&v.forEach(function(x){return x.resolve(r)});case 3:u.enterFinallyBlock();delete e[m];delete f[m];u.leaveFinallyBlock(0);break;case 2:t=u.enterCatchBlock(),v&&v.forEach(function(x){return x.reject(t)}),u.jumpTo(3)}})},c)})}}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d",{willReadFrequently:!0});l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var p=m.getImageData(0,0,l.width,l.height),q=p.data,v=c?e(c):null,r=d?e(d):{r:0,g:0,b:0,a:0},t=0;t<q.length;t+=4){var u=q[t+3];0===u?(q[t]=r.r,q[t+1]=r.g,q[t+2]=r.b,q[t+3]=void 0!==r.a?r.a:0):0<u&&255>u?v&&(q[t]=Math.round((v.r*u+r.r*(255-u))/255),q[t+1]=Math.round((v.g*u+r.g*(255-u))/255),q[t+2]=Math.round((v.b*u+r.b*(255-u))/255),
q[t+3]=255):v&&(q[t]=v.r,q[t+1]=v.g,q[t+2]=v.b,q[t+3]=void 0!==v.a?v.a:255)}m.putImageData(p,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}var getRandomColor=function(){return"#"+Math.floor(1118481+14540253*Math.random()).toString(16)};function normalizeUrl(b){return b&&"string"===typeof b?b.replace(/\\\//g,"/"):b}
var LANGUAGE_NATIVE_NAMES={english:"English",german:"Deutsch",french:"Fran\u00e7ais",spanish:"Espa\u00f1ol",portuguese:"Portugu\u00eas",italian:"Italiano",arabic:"\u0639\u0631\u0628\u064a","chinese (traditional)":"\u7e41\u9ad4\u4e2d\u6587","chinese(traditional)":"\u7e41\u9ad4\u4e2d\u6587",japanese:"\u65e5\u672c\u8a9e",korean:"\ud55c\uad6d\uc5b4",dutch:"Nederlands",russian:"\u0420\u0443\u0441\u0441\u043a\u0438\u0439",swedish:"Svenska",danish:"Dansk",polish:"Polski",finnish:"Suomi",turkish:"T\u00fcrk\u00e7e",
hebrew:"\u05e2\u05b4\u05d1\u05e8\u05b4\u05d9\u05ea",czech:"\u010ce\u0161tina",hungarian:"Magyar",romanian:"Rom\u00e2n\u0103",ukrainian:"\u0423\u043a\u0440\u0430\u0457\u043d\u0441\u044c\u043a\u0430",greek:"\u0395\u03bb\u03bb\u03b7\u03bd\u03b9\u03ba\u03ac",thai:"\u0e44\u0e17\u0e22",hindi:"Hindi",malay:"Bahasa Melayu",malaysian:"Bahasa Melayu",indonesian:"Bahasa Indonesia",vietnamese:"Ti\u1ebfng Vi\u1ec7t",chinese:"\u7b80\u4f53\u4e2d\u6587","chinese (simplified)":"\u7b80\u4f53\u4e2d\u6587","chinese(simplified)":"\u7b80\u4f53\u4e2d\u6587",
basque:"Euskara",persian:"\u0641\u0627\u0631\u0633\u06cc",bengali:"\u0411\u0435\u043d\u0433\u0430\u043b\u0441\u043a\u0438",macedonian:"\u043c\u0430\u043a\u0435\u0434\u043e\u043d\u0441\u043a\u0438"};function getLanguageDisplayName(b){if(!b)return"";var c=b.toLowerCase().trim();return LANGUAGE_NATIVE_NAMES[c]||b}global.getLanguageDisplayName=getLanguageDisplayName;
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(q,v){var r=c();try{var t=v&&"object"===typeof v?Object.assign({},v):v;if(t&&"object"===typeof t){t.page=Number(q+1);var u=r[q];u&&u.positions&&t.positions?t.positions=u.positions.concat(t.positions):u&&u.positions&&(t.positions=u.positions);null!=l?t.realPage=Number(l):u&&u.realPage&&(t.realPage=u.realPage);u&&Object.keys(u).forEach(function(x){"page"===x||"realPage"===x||"positions"===
x||x in t||(t[x]=u[x])})}r[q]=t;return!0}catch(x){return console.error("writeToTarget error",x),!1}}function e(q,v,r){if(!q||0===q.length)return null;for(var t=q[0].left,u=q[0].top,x=q[0].right,z=q[0].bottom,A="",F=0;F<q.length;F++){var D=q[F];t=Math.min(t,D.left);u=Math.min(u,D.top);x=Math.max(x,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=t/v;u/=r;x/=v;r=z/r;r=[F,r,x,r,x,u,F,u];z=[];for(F=0;F<q.length;F++)z.push(q[F].width/v);if(!A||0===A.trim().length)return null;q=r.concat(z);return{w:A,p:q}}
function f(q){b._pageReaderExtracted||(b._pageReaderExtracted={});q=Array.isArray(q)?q:[q];for(var v=0,r=0;r<q.length;r++){var t=q[r];if(t&&!(1>t)&&!b._pageReaderExtracted[t])if(b._pageReaderExtracted[t]=!0,window._getPage&&"function"===typeof window._getPage)try{var u=window._getPage(t-1);if(u){var x=null;if(u.items&&Array.isArray(u.items)){x=u.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<x.length;D++){var L=x[D];if(L&&"text"===L.type&&
L.positionText&&L.style){var M=L,I=t,G=z,O=A,K=c();b.pageTextPositions||(b.pageTextPositions=[]);var J=M;if(J&&J.positionText&&J.style){M=[];var Q=parseFloat(J.style.left)||0,U=parseFloat(J.style.top)||0,T=J.positionText;for(J=0;J<T.length;J++){var S=T[J];if(S&&S.rowText&&0!==S.rowText.length){for(var ia=S.rowText,W=[],ea=null,ma=0;ma<ia.length;ma++){var P=ia[ma];if(P&&P.text){var ja=Q+(P.left||0),na=U+(P.top||0),aa=P.width||0,R=P.height||0,fa=ja+aa,ka=!1;null!==ea&&ja-ea>.5*aa&&(ka=!0);if(ka&&0<
W.length){var ba=e(W,G,O);ba&&M.push(ba);W=[]}W.push({text:P.text,left:ja,top:na,width:aa,height:R,right:fa,bottom:na+R});ea=fa}}0<W.length&&(ba=e(W,G,O))&&M.push(ba)}}var X=M}else X=[];if(0!==X.length){G=I-1;var ca=K[G];ca?(ca.positions&&Array.isArray(ca.positions)?K[G].positions=ca.positions.concat(X):K[G].positions=X,K[G].page=I):K[G]={page:I,positions:X}}F++}}v+=F;0<F?console.log("PageTextExtractor: \u6210\u529f\u63d0\u53d6\u5e76\u6dfb\u52a0 "+F+" \u4e2a\u6587\u672c\u914d\u7f6e\u5230 positionForPages (\u9875\u9762 "+
(t-1)+")"):console.log("PageTextExtractor: \u9875\u9762 "+(t-1)+" \u4e2d\u6ca1\u6709\u627e\u5230\u6587\u672c\u5143\u7d20")}else console.warn("PageTextExtractor: \u9875\u9762\u6570\u636e\u683c\u5f0f\u4e0d\u6b63\u786e\uff0c\u671f\u671b {items: [...]}")}else console.warn("PageTextExtractor: \u65e0\u6cd5\u83b7\u53d6\u9875\u9762 "+(t-1)+" \u7684\u6570\u636e")}catch(la){b._pageReaderExtracted[t]=!1,console.error("PageTextExtractor: \u63d0\u53d6\u9875\u9762 "+(t-1)+" \u7684\u6587\u672c\u914d\u7f6e\u65f6\u51fa\u9519",
la)}else console.warn("PageTextExtractor: window._getPage \u65b9\u6cd5\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u63d0\u53d6\u6587\u672c\u914d\u7f6e")}return v}function g(q){var v,r,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(!q||1>q)return u.return(!1);b._positionScriptLoaded||(b._positionScriptLoaded={});b._positionScriptLoadPromises||(b._positionScriptLoadPromises={});v=b.getSearchRealPageIndex(q);if(0>=v||-1===v||b._positionScriptLoaded[v])return u.return(!1);if(r=b._positionScriptLoadPromises[v])return u.return(r);
t=function(){var x,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.setCatchFinallyBlocks(2,3),x=String.format(bookConfig.searchPositionJS,v),1<v&&(x=x.replace("[1]","["+v+"]")),z=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi,A=/\.*\/?(\w+\/)*\w+?\.js/gi,x.match(z)||x.match(A)?D.yield(getArticleImage(fixURLValue(x)),5):D.return(!1);case 5:return(x=D.yieldResult)?D.yield(h(q,x,v),6):D.return(!1);case 6:return b._positionScriptLoaded[v]=!0,D.return(!0);
case 3:D.enterFinallyBlock();delete b._positionScriptLoadPromises[v];D.leaveFinallyBlock(0);break;case 2:return F=D.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),D.return(!1)}})}();b._positionScriptLoadPromises[v]=t;return u.return(t)})}function h(q,v,r){var t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){t=function(){var x,z,A,F,D,L,M,I;return $jscomp.asyncExecutePromiseGeneratorProgram(function(G){switch(G.nextAddress){case 1:k=q;l=r;if(x=
"undefined"!==typeof location&&"file:"===location.protocol){G.jumpTo(2);break}G.setCatchFinallyBlocks(3);return G.yield(fetch(v),5);case 5:z=G.yieldResult;if(!z.ok){console.warn("fetch returned non-ok",z.status,v);G.jumpTo(6);break}return G.yield(z.text(),7);case 7:return A=G.yieldResult,F=A.match(/positionForPages\[(\d+)\]/),D=A,F&&(D=D.replace(new RegExp("positionForPages\\["+F[1]+"\\]","g"),"positionForPages["+(q-1)+"]")),D=D.replace(/("page"\s*:\s*)"?\d+"?/g,"$1"+q),L="undefined"!==typeof window?
window:"undefined"!==typeof b?b:null,L&&L.document?G.yield(new Promise(function(O,K){var J="";try{var Q=new Blob([D],{type:"application/javascript;charset=utf-8"});J=URL.createObjectURL(Q)}catch(U){l=k=null;K(U);return}Q=L.document.createElement("script");Q.dataset.positionSource=v;Q.onload=function(){if(J)try{URL.revokeObjectURL(J)}catch(U){}setTimeout(function(){l=k=null;O()},0)};Q.onerror=function(){if(J)try{URL.revokeObjectURL(J)}catch(U){}l=k=null;K(Error("Blob script load failed: "+v))};Q.src=
J;L.document.head.appendChild(Q)}),8):(console.warn("PageTextExtractor: \u65e0 document\uff0c\u65e0\u6cd5\u6267\u884c\u4f4d\u7f6e\u811a\u672c"),l=k=null,G.return());case 8:return G.return();case 6:G.leaveTryBlock(2);break;case 3:M=G.enterCatchBlock(),console.warn("fetch failed, fallback to script tag (likely file://). Error:",M&&M.message);case 2:return I="undefined"!==typeof window?window:"undefined"!==typeof b?b:null,I?G.yield(new Promise(function(O,K){var J=I.document.createElement("script");J.dataset.positionSource=
v;J.onload=function(){setTimeout(function(){l=k=null;O()},0)};J.onerror=function(Q){l=k=null;console.log("Script load failed:",v,Q);K(Error("Script load failed: "+v))};J.src=v;I.document.head.appendChild(J)}),0):(console.log("\u65e0\u6cd5\u627e\u5230 window \u6216 global \u5bf9\u8c61"),G.return())}})};m=m.then(function(){return t()}).catch(function(x){console.log("queue error:",x&&x.message)});return u.return(m)})}"undefined"!==typeof b&&null==b.pageTextPositions&&(b.pageTextPositions=[]);var k=null,
l=null,m=Promise.resolve(),p=new Proxy({},{get:function(q,v){var r=c();return"string"===typeof v&&/^\d+$/.test(v)?r[Number(v)]:"length"===v?r.length:"function"===typeof Array.prototype[v]?Array.prototype[v].bind(r):q[v]},set:function(q,v,r){return"string"===typeof v&&/^\d+$/.test(v)?(q=Number(v),null!=k?d(k-1,r):d(q,r),!0):!1},has:function(q,v){var r=c();return"string"===typeof v&&/^\d+$/.test(v)?Number(v)in r:v in q},ownKeys:function(){var q=c();return Object.keys(q).concat(Object.getOwnPropertyNames(Object.prototype))},
getOwnPropertyDescriptor:function(q,v){var r=c();return"string"===typeof v&&/^\d+$/.test(v)?{configurable:!0,enumerable:!0,value:r[Number(v)],writable:!0}:Object.getOwnPropertyDescriptor(q,v)}});"undefined"!==typeof window?Object.defineProperty(window,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:p}):"undefined"!==typeof b&&Object.defineProperty(b,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:p});"undefined"!==typeof b&&null==b._positionScriptLoadPromises&&
(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(q){var v,r,t,u,x,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),v=Array.isArray(q)?q:[q],r=[],t=!1,u=0;case 2:if(!(u<v.length)){D.jumpTo(4);break}x=v[u];if(!x||1>x){D.jumpTo(3);break}z={pageIndex:x,hasText:!1,
positionCount:0};D.setCatchFinallyBlocks(5);return D.yield(g(x),7);case 7:b._pageReaderExtracted[x]||f(x);(A=c()[x-1])&&A.page===x&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,t=!0);D.leaveTryBlock(6);break;case 5:F=D.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+x+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:r.push(z);case 3:u++;D.jumpTo(2);break;case 4:return D.return({hasText:t,pageResults:r})}})};
b.hasPageText=function(q){b.pageTextPositions||(b.pageTextPositions=[]);var v=!Array.isArray(q),r=[],t=!1;q=$jscomp.makeIterator(v?[q]:q);for(var u=q.next();!u.done;u=q.next())if(u=u.value,!u||1>u)v||r.push({pageIndex:u,hasText:!1,positionCount:0});else{var x={pageIndex:u,hasText:!1,positionCount:0},z=u-1;(z=c()[z])&&z.page===u&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(x.hasText=!0,x.positionCount=z.positions.length,t=!0);if(v)return x.hasText;r.push(x)}return{hasText:t,pageResults:r}};
b.loadPagePositionScript=g;b.loadAndFixPositionScript=h;b.clearPageTextPositions=function(){b.pageTextPositions&&(b.pageTextPositions.length=0);b._positionScriptLoaded&&(b._positionScriptLoaded={});b._positionScriptLoadPromises&&(b._positionScriptLoadPromises={});b._pageReaderExtracted&&(b._pageReaderExtracted={})}})("undefined"!==typeof window?window:"undefined"!==typeof global?global:this);
...
function hasReaderPageItems(b){return b?Object.values(b).some(function(c){return Array.isArray(c)&&c.length})?!0:[b.subtitle||b.IQr,b.camera||b.ED3,b.foreground||b.Xly,b.background||b.uCf].some(function(c){if(!c||"object"!==typeof c)return!1;c=c.items||c.BSi;return Array.isArray(c)&&0<c.length}):!1}
...
vimeoPlayerUrl="https://player.vimeo.com/api/player.js",cMapUrl="https://unpkg.com/pdfjs-dist@latest/cmaps/",emailLinkUrl="http://gmail.google.com";yunzhanMainDomainList=["www.yunzhan365.com","test.yunzhan365.com"];yunzhanBookDomainList="book.yunzhan365.com test2.yunzhan365.com book.asflip.com bookh.yunzhan365.com online.fliphtml5.com t.flipbuilder.com".split(" ");logoBrandDomainList=["yunzhan365","fliphtml5"];brandHostRegex=/fliphtml5|yunzhan365|anyflip|pubhtml5/;fliphtml5HostRegex=/fliphtml5/;
facebookBrandDomains=["fliphtml5.com","pubhtml5.com","anyflip.com","flipbuilder.com"];shareTitleBrandSuffix=" on FlipHTML5";shareTitleBrandDomains=["fliphtml5.com"];facebookAppIdFliphtml5="759223277462081";facebookAppIdPubhtml5="552959651503135";facebookAppIdAnyflipShare="3188867394510608";facebookAppIdFlipbuilder="506045156879233";yunzhanBrandDomain="yunzhan365.com";fliphtml5BrandDomain="fliphtml5.com";fliphtml5OnlineDomain="online.fliphtml5.com";yunzhanCookieDomain=".yunzhan365.com";
fliphtml5CookieDomain=".fliphtml5.com";chatbotDefaultDomain="https://fliphtml5.com";
function getTarget(){var b=1,c=window.location.host;var d=window.location.pathname;var e="",f="";if(window.yz_temp_link)e=window.yz_temp_uLink,f=window.yz_temp_bLink;else{if(yunzhanMainDomainList.some(function(k){return c.match(k)})){if(yunzhanMainDomainList[0]&&c.match(yunzhanMainDomainList[0]+"/view"))return;b=d.indexOf("/",1)+1;var g=d.indexOf("/",b);var h=d.indexOf("/",g+1);e=d.substring(b,g);f=d.substring(g+1,h)}else 0<=yunzhanBookDomainList.indexOf(c)&&(g=d.indexOf("/",1),h=d.indexOf("/",g+
1),e=d.substring(b,g),f=d.substring(g+1,h));try{/^https?:\/\/[^/]+\/books(?:\/|$)/.test(location.href)&&(g=d.indexOf("/",1),h=d.indexOf("/",g+1),e=window.userInfo.d,f=d.substring(g+1,h))}catch(k){}return{uLink:e,bLink:f}}}
var shareItemDefaultTitles={email:"Email",copy:"Copy",qrcode:"QRcode",poster:"Poster",share_more:"More",facebook:"Facebook",twitter:"Twitter",instagram:"Instagram",pinterest:"Pinterest",whatsapp:"WhatsApp",linkedin:"LinkedIn"},restrictedMap={"aU3e!G7sD":"","qR2j^H5fZ":"loadingPicture","bJ8w&K3tP":"loadingVideo","dT9e#X1sC":"googleAnalyticsID","yO4u*L2xF":"AnnotationButtonVisible","nL7j@V5rB":"aboutButtonVisible","tT3e&Z4yC":"HomeButtonVisible","hY6w%P9gD":"HomeURL","kA8q!R5jH":"googleTagManagerID",
"eX1z@S8kT":"language","cK5t#D2fP":"BookMarkButtonVisible","jN2z^W8hS":"TableOfContentButtonVisible","rF6e&K4bJ":"PhoneButtonVisible",zC9u$P3lF:"LeftShadowWidth;LeftShadowAlpha;RightShadowWidth;RightShadowAlpha;ShowTopLeftShadow;pageHighlightType;","wV5t#G1nQ":"thicknessWidthType;thicknessColor","gF4w!D1qR":"haveAdSense","hJ5m#L3dT":"staticAd","xY4z9F@kL":"appLogoIcon","vA6qM8!bN":"appLogoLinkURL"},newRestrictedMap={BOOK_LOADING_IMAGE:"loadingPicture",BOOK_LOADING_VIDEO:"loadingVideo",ADD_GOOGLE_ANALYSIS:"googleAnalyticsID",
SET_ANNOTATION_BUTTON:"AnnotationButtonVisible",SHOW_ABOUT_BUTTON:"aboutButtonVisible",SET_HOME_BUTTON:"HomeButtonVisible",SET_HOME_LINK:"HomeURL",ADD_GTM:"googleTagManagerID",SET_BOOK_LANGUAGE:"language",SET_BOOKMARK:"BookMarkButtonVisible",SET_TOC:"TableOfContentButtonVisible",SHOW_PHONE_BUTTON:"PhoneButtonVisible",SET_SHADOW:"LeftShadowWidth;LeftShadowAlpha;RightShadowWidth;RightShadowAlpha;ShowTopLeftShadow;pageHighlightType;",SET_THICKNESS:"thicknessWidthType;thicknessColor",SET_GOOGLE_AD:"haveAdSense",
SET_AD_BANNER:"staticAd",SET_BOOK_LOGO:"appLogoIcon",SET_LOGO_LINK:"appLogoLinkURL",OPEN_AUTO_FLIP:"AutoPlayButtonVisible;autoPlayAutoStart;autoPlayDuration;autoPlayLoopCount",OTHERS_DOWNLOAD_FILE:"downloadFullPublication",OTHERS_DOWNLOAD_ATTACHMENT:"downloadAttachments",COPY_TEXT:"SelectTextButtonVisible",SET_VIDEO_LIST_BUTTON:"VideoButtonVisible",SET_BACKGROUND_IMG:"backGroundImgURL;backgroundOpacity;backgroundPosition;backgroundScene",SET_BACKGROUND_MUSIC:"BackgroundSoundURL;BackgroundSoundLoop",
SET_HARD_COVER:"HardPageEnable;HardInnerPageEnable;outerCoverBorder;hardCoverBorderWidth;coverTexture"};function parsePowerToken(b){return"string"!==typeof b?null:(b=b.match(/^(.*)_(\d+)_(\d+)$/))?{key:b[1],limitId:Number(b[2]),value:Number(b[3])}:null}function isRecastiaDomain(){return/recastia/i.test(window.location.hostname)}function isRecastiaFreeUser(){var b;return 0===Number(null==(b=window.userInfo)?void 0:b.c)}
function getRecastiaAppLogoIcon(){return"https://"+(/test|dev/.test(window.location.hostname)?"test.recastia.net":"recastia.net")+"/resourceFiles/slide/h5/assets/recastia.svg"}function getRecastiaAppLogoLinkURL(){return/test|dev/.test(window.location.hostname)?"https://test.recastia.com":"https://recastia.com"}
var specialHandlers={appLogoIcon:function(){return"../../booklogo.png"},appLogoLinkURL:function(){return"https://fliphtml5.com"},staticAd:function(){return!0},downloadAttachments:function(){return!0},DownloadButtonVisible:function(){return!1},DownloadURL:function(){return""},language:function(){var b,c,d=(null==(b=window.bookConfig)?void 0:b.language)||(null==(c=window.tmpBookConfig)?void 0:c.language)||"English";return d.includes(";")?d.split(";")[0]:d}};
function checkPermission(b,c){if(!Array.isArray(c))return!1;for(var d=0;d<c.length;d++){var e=parsePowerToken(c[d]);if(e&&1===e.limitId){var f=newRestrictedMap[e.key];if(f&&f.split(";").includes(b)&&0===e.value)return!0}}for(var g in restrictedMap)if(c.includes(g)&&restrictedMap[g].split(";").includes(b))return!0;return!1}
function checkBookConfigRestrictedKey(b,c){var d=function(){var g,h,k,l,m,p,q,v=[null==(g=window.tmpBookConfig)?void 0:null==(h=g.power_info)?void 0:h.power,null==(k=window.bookConfig)?void 0:null==(l=k.power_info)?void 0:l.power,null==(m=window.UserInfoUtils)?void 0:null==(p=m.getDecryptedPower)?void 0:p.call(m),null==(q=window.userInfo)?void 0:q.power];for(g=0;g<v.length;g++)if(Array.isArray(v[g]))return v[g];return null},e=function(g){var h;if(!("appLogoIcon"===b&&0<Number(null==(h=window.userInfo)?
void 0:h.ai))){if(checkPermission(b,g))return specialHandlers[b]?specialHandlers[b]():c;if(isRecastiaDomain()&&isRecastiaFreeUser()){if("appLogoIcon"===b)return getRecastiaAppLogoIcon();if("appLogoLinkURL"===b)return getRecastiaAppLogoLinkURL()}if("appLogoIcon"===b&&(g=String(window.bookConfig&&window.bookConfig.appLogoIcon||window.tmpBookConfig&&window.tmpBookConfig.appLogoIcon||("undefined"!==typeof c?c:"")).trim(),"string"==typeof g&&(g=g.replaceAll("\\/","/",!0),g=g.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(g)))return""}},
f=d();if(!f&&isRecastiaDomain()&&window.userInfo&&"c"in window.userInfo)return e(d());if(!f&&window.eventEmitter&&"function"===typeof window.eventEmitter.on)window.eventEmitter.on("loadUserInfo",function(g){return e(d())});return e(d())}checkReportConfig=function(){changeBookConfigValue("EnableReportButton",getConfigValue("EnableReportButton",!1))};var tmpBookConfig={};
function runDecryptedScript(b){return new Promise(function(c,d){var e=new Blob([b],{type:"application/javascript"}),f=URL.createObjectURL(e);e=document.createElement("script");e.src=f;e.onload=function(){URL.revokeObjectURL(f);c()};e.onerror=function(){URL.revokeObjectURL(f);d(Error("runDecryptedScript: script load failed"))};document.head.appendChild(e)})}try{window.UserInfoUtils&&"function"===typeof window.UserInfoUtils.primeDecryptedPowerFromBookConfig&&window.UserInfoUtils.primeDecryptedPowerFromBookConfig()}catch(b){}
var checkBookConfig=function(){var b,c,d,e,f,g,h,k,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:m.setCatchFinallyBlocks(2);if(!window.ensureUserInfoReady){m.jumpTo(4);break}return m.yield(window.ensureUserInfoReady(2E3),4);case 4:m.leaveTryBlock(3);break;case 2:m.enterCatchBlock();case 3:b=htmlConfig.bookConfig;c=allocateUTF8(b);window.key_index=Module._DeConfig_Parse(c);void 0==window.aliasConfig&&(window.aliasConfig={});tmpBookConfig.power_info=getConfigValue("power_info",
"");if(tmpBookConfig.power_info&&"string"===typeof tmpBookConfig.power_info)try{tmpBookConfig.power_info=JSON.parse(tmpBookConfig.power_info)}catch(p){console.error("Security: Failed to parse power_info JSON, possibly malformed or malicious data",p),tmpBookConfig.power_info=null}tmpBookConfig.clickBlankToFlip=getConfigValue("clickBlankToFlip",!0);tmpBookConfig.PageModeButtonVisible=getConfigValue("PageModeButtonVisible",!1);tmpBookConfig.isAnnotationCustomIconEnabled=getConfigValue("isAnnotationCustomIconEnabled",
!1);tmpBookConfig.annotationStickerButtonIcon=getConfigValue("annotationStickerButtonIcon","");tmpBookConfig.annotationAddTextButtonIcon=getConfigValue("annotationAddTextButtonIcon","");tmpBookConfig.annotationSelectTextButtonIcon=getConfigValue("annotationSelectTextButtonIcon","");tmpBookConfig.annotationBrushButtonIcon=getConfigValue("annotationBrushButtonIcon","");tmpBookConfig.annotationHighlighterButtonIcon=getConfigValue("annotationHighlighterButtonIcon","");tmpBookConfig.annotationRectangleButtonIcon=
getConfigValue("annotationRectangleButtonIcon","");tmpBookConfig.annotationEllipseButtonIcon=getConfigValue("annotationEllipseButtonIcon","");tmpBookConfig.annotationEraserButtonIcon=getConfigValue("annotationEraserButtonIcon","");tmpBookConfig.annotationClearButtonIcon=getConfigValue("annotationClearButtonIcon","");tmpBookConfig.annotationUndoButtonIcon=getConfigValue("annotationUndoButtonIcon","");tmpBookConfig.annotationRedoButtonIcon=getConfigValue("annotationRedoButtonIcon","");tmpBookConfig.annotationSaveButtonIcon=
getConfigValue("annotationSaveButtonIcon","");tmpBookConfig.annotationExitButtonIcon=getConfigValue("annotationExitButtonIcon","");tmpBookConfig.homeButtonDestinationType=getConfigValue("homeButtonDestinationType","").toLowerCase();tmpBookConfig.isShowBottomFullscreenPrompts=getConfigValue("isShowBottomFullscreenPrompts",void 0);void 0!==tmpBookConfig.isShowBottomFullscreenPrompts&&(tmpBookConfig.isShowBottomFullscreenPrompts=parseBool(tmpBookConfig.isShowBottomFullscreenPrompts));tmpBookConfig.isMobileFirstLastShortcutVisible=
...
void 0);void 0!==tmpBookConfig.isShowMobileBottomFullscreenPrompts&&(tmpBookConfig.isShowMobileBottomFullscreenPrompts=parseBool(tmpBookConfig.isShowMobileBottomFullscreenPrompts));tmpBookConfig.SmallProgramUrl=getConfigValue("SmallProgramUrl","");tmpBookConfig.searchColor=getConfigValue("searchColor","#00ffff");tmpBookConfig.searchAlpha=getConfigValue("searchAlpha",.3);tmpBookConfig.appLogoIcon=getConfigValue("appLogoIcon","");tmpBookConfig.HomeURL=getConfigValue("HomeURL","");tmpBookConfig.bookTitle=
getConfigValue("bookTitle","FLIPBOOK");tmpBookConfig.bookDescription=getConfigValue("bookDescription","");tmpBookConfig.toolbarColor=getConfigValue("toolbarColor","#27181A");tmpBookConfig.iconColor=getConfigValue("iconColor","#FFFFFF");tmpBookConfig.toolbarColor==tmpBookConfig.iconColor&&(tmpBookConfig.iconColor=Color(tmpBookConfig.toolbarColor).reverse());tmpBookConfig.pageNumColor=getConfigValue("pageNumColor","#000000");tmpBookConfig.formBackgroundColor=getConfigValue("formBackgroundColor",tmpBookConfig.toolbarColor);
tmpBookConfig.formFontColor=getConfigValue("formFontColor",tmpBookConfig.iconColor);tmpBookConfig.formBackgroundColor.toLocaleLowerCase()==tmpBookConfig.formFontColor.toLocaleLowerCase()&&(tmpBookConfig.formFontColor=Color(tmpBookConfig.formBackgroundColor).reverse());tmpBookConfig.loadingBackground=getConfigValue("loadingBackground","#1F2232");tmpBookConfig.loadingDisplayTime=getConfigValue("loadingDisplayTime",0);tmpBookConfig.searchHightlightColor=getConfigValue("searchHightlightColor","#fdc606");
tmpBookConfig.searchHighlightHeightScale=getConfigValue("searchHighlightHeightScale",.8);tmpBookConfig.logoHeight=getConfigValue("logoHeight",40);tmpBookConfig.logoTop=getConfigValue("logoTop",0);tmpBookConfig.logoPadding=getConfigValue("logoPadding",0);tmpBookConfig.isFixLogoSize=getConfigValue("isFixLogoSize",!1);tmpBookConfig.HomeButtonVisible=getConfigValue("HomeButtonVisible",!1);tmpBookConfig.ShareButtonVisible=getConfigValue("ShareButtonVisible",!1);tmpBookConfig.facebookAppId=getConfigValue("facebookAppId",
...
getConfigValue("supportSerialsFlip",!0);tmpBookConfig.retainBookCenter=getConfigValue("retainBookCenter",!0);tmpBookConfig.totalPagesCaption=getConfigValue("totalPagesCaption","");tmpBookConfig.pageNumberCaption=getConfigValue("pageNumberCaption","");tmpBookConfig.buttonsSortXML=getConfigValue("buttonsSortXML",[]);tmpBookConfig.toolbarAlwaysShow=getConfigValue("toolbarAlwaysShow",!1);tmpBookConfig.searchbarAlwaysShowOnMobile=getConfigValue("searchbarAlwaysShowOnMobile",!1);"neat"===_get(htmlConfig,
"phoneTemplate.name")&&(tmpBookConfig.searchbarAlwaysShowOnMobile=!1);isPhone()||isPad()||(tmpBookConfig.toolbarAlwaysShow=!0);tmpBookConfig.leftRightPnlShowOption=getConfigValue("leftRightPnlShowOption","").toLowerCase();tmpBookConfig.mobileLeftRightPnlShowOption=getConfigValue("mobileLeftRightPnlShowOption","").toLowerCase();tmpBookConfig.topMargin=getConfigValue("topMargin",10);tmpBookConfig.ORIGIN_TOP_MARGIN=tmpBookConfig.topMargin;tmpBookConfig.bottomMargin=getConfigValue("bottomMargin",10);
tmpBookConfig.ORIGIN_BOTTOM_MARGIN=tmpBookConfig.bottomMargin;tmpBookConfig.leftMargin=getConfigValue("leftMargin",10);tmpBookConfig.rightMargin=getConfigValue("rightMargin",10);tmpBookConfig.topMarginOnMobile=getConfigValue("topMarginOnMobile",10);tmpBookConfig.bottomMarginOnMobile=getConfigValue("bottomMarginOnMobile",10);tmpBookConfig.leftMarginOnMobile=getConfigValue("leftMarginOnMobile",10);tmpBookConfig.rightMarginOnMobile=getConfigValue("rightMarginOnMobile",10);if(isPhone()||isPad()){tmpBookConfig.topMargin=
tmpBookConfig.topMarginOnMobile;tmpBookConfig.bottomMargin=tmpBookConfig.bottomMarginOnMobile;tmpBookConfig.leftMargin=tmpBookConfig.leftMarginOnMobile;if("number"!==typeof tmpBookConfig.rightMarginOnMobile||isNaN(tmpBookConfig.rightMarginOnMobile))tmpBookConfig.rightMarginOnMobile=0;tmpBookConfig.rightMargin=tmpBookConfig.rightMarginOnMobile;tmpBookConfig.phoneFlipShortcutSwitchButtonVisible=getConfigValue("phoneFlipShortcutSwitchButtonVisible",!1);tmpBookConfig.phoneFlipShortcutButton=getConfigValue("phoneFlipShortcutButton",
!1);tmpBookConfig.searchbarAlwaysShowOnMobile&&tmpBookConfig.toolbarAlwaysShow&&(tmpBookConfig.topMargin+=50)}else tmpBookConfig.phoneFlipShortcutButton=!1;tmpBookConfig.visibleAreaLeft=parseFloat(getConfigValue("visibleAreaLeft","0%"));tmpBookConfig.visibleAreaTop=parseFloat(getConfigValue("visibleAreaTop","0%"));tmpBookConfig.visibleAreaRight=parseFloat(getConfigValue("visibleAreaRight","100%"));tmpBookConfig.visibleAreaBottom=parseFloat(getConfigValue("visibleAreaBottom","100%"));tmpBookConfig.visibleAreaLeft=
...
tmpBookConfig.visibleAreaBottom;tmpBookConfig.LinkDownColor=getConfigValue("LinkDownColor","#9C9C9C");tmpBookConfig.LinkAlpha=getConfigValue("LinkAlpha",.4);tmpBookConfig.googleAnalyticsID=getConfigValue("googleAnalyticsID","");tmpBookConfig.googleTagManagerID=getConfigValue("googleTagManagerID","");tmpBookConfig.language=getConfigValue("language","English");tmpBookConfig.language=Array.isArray(tmpBookConfig.language)?tmpBookConfig.language:tmpBookConfig.language.split(";");tmpBookConfig.AboutAddress=
...
tmpBookConfig.searchPositionJS=getConfigValue("searchPositionJS","files/search/text_position.js");tmpBookConfig.userSmallMode=getConfigValue("userSmallMode",!0);tmpBookConfig.maxWidthToSmallMode=getConfigValue("maxWidthToSmallMode",300);tmpBookConfig.maxHeightToSmallMode=getConfigValue("maxHeightToSmallMode",300);tmpBookConfig.backgroundScene=getConfigValue("backgroundScene","None");tmpBookConfig.bgSoundVol=getConfigValue("bgSoundVol",50);tmpBookConfig.bgSoundVol=Number.between(tmpBookConfig.bgSoundVol,
0,100);tmpBookConfig.enablePageBack=getConfigValue("enablePageBack",!1);if(isPhone()||isPad())tmpBookConfig.enablePageBack=tmpBookConfig.isMobilePageBackButtonVisible;tmpBookConfig.userListPath=getConfigValue("userListPath","files/extfiles/users.js");tmpBookConfig.excludeFrontPages=getConfigValue("excludeFrontPages","");tmpBookConfig.isFlipPdf=getConfigValue("isFlipPdf",!1);tmpBookConfig.SingleModeBanFlipToLastPage=getConfigValue("SingleModeBanFlipToLastPage",!1);tmpBookConfig.isSingleBookFullWindowOnMobile=
getConfigValue("isSingleBookFullWindowOnMobile",!1);tmpBookConfig.showGotoButtonsAtFirst=getConfigValue("showGotoButtonsAtFirst",!1);0==tmpBookConfig.isFlipPdf&&void 0!=global.isFlipPdf&&(tmpBookConfig.isFlipPdf=isFlipPdf);tmpBookConfig.FlipSound=getConfigValue("FlipSound",!0);global.flipSoundIsPlaying=tmpBookConfig.FlipSound;tmpBookConfig.CurlingPageCorner=getConfigValue("CurlingPageCorner",!0);tmpBookConfig.BanFlipFromDirection=getConfigValue("BanFlipFromDirection",!1);tmpBookConfig.iconFontColor=
getConfigValue("iconFontColor","#ffffff");tmpBookConfig.updateURLForPage=getConfigValue("updateURLForPage",!0);tmpBookConfig.borderColor=getConfigValue("borderColor","#572f0d");tmpBookConfig.outerCoverBorder=getConfigValue("outerCoverBorder",!1);tmpBookConfig.hardCoverBorderWidth=getConfigValue("hardCoverBorderWidth",0);tmpBookConfig.cornerRound=getConfigValue("cornerRound",0);tmpBookConfig.hardCoverBorderWidth=tmpBookConfig.HardPageEnable?Number.between(0,16,tmpBookConfig.hardCoverBorderWidth):0;
tmpBookConfig.cornerRound=tmpBookConfig.HardPageEnable?Number.between(0,tmpBookConfig.hardCoverBorderWidth,tmpBookConfig.cornerRound):0;tmpBookConfig.coverTexture=getConfigValue("coverTexture","none");tmpBookConfig.passwardPrompt=getConfigValue("passwardPrompt","");tmpBookConfig.SlideshowAutoPlay=getConfigValue("SlideshowAutoPlay",!1);tmpBookConfig.SlideshowPlayInterval=getConfigValue("SlideshowPlayInterval",5);tmpBookConfig.productName=getConfigValue("productName","Flip HTML5");tmpBookConfig.homePage=
getConfigValue("homePage","undefined"!==typeof fliphtml5Url?fliphtml5Url:"");global.productName=tmpBookConfig.productName||"Flip HTML5";global.homePage=tmpBookConfig.homePage||("undefined"!==typeof fliphtml5Url?fliphtml5Url:"");tmpBookConfig.backgroundPosition=getConfigValue("backgroundPosition","Stretch");tmpBookConfig.restorePageVisible=getConfigValue("restorePageVisible",!1);tmpBookConfig.restorePageDuration=getConfigValue("restorePageDuration",86400);tmpBookConfig.toobarClear=getConfigValue("toobarClear",
...
tmpBookConfig.FlipStyle.toLowerCase()&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase())tmpBookConfig.flipshortcutbutton=!1;if("slide"==tmpBookConfig.FlipStyle&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase()||isPhone()||isPad())tmpBookConfig.flipshortcutbutton=!1;void 0===tmpBookConfig.isFirstLastShortcutVisible&&(tmpBookConfig.isFirstLastShortcutVisible=!!tmpBookConfig.flipshortcutbutton);if(global.videoList&&1<=global.videoList.length)for(f=0;f<videoList.length;f++)videoList[f].id||(videoList[f].id=
""),videoList[f].description||(videoList[f].description=""),videoList[f].thumbnail||(videoList[f].thumbnail=""),videoList[f].title||(videoList[f].title=""),videoList[f].type||(videoList[f].type="");try{window.localStorage||(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&(global.pageEditor.setting.shoppingCartHTML=!1))}catch(p){tmpBookConfig.BookMarkButtonVisible=
!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&(global.pageEditor.setting.shoppingCartHTML=!1)}global.templeteName.includes("article")&&(isPhone()||isPad())&&(tmpBookConfig.BookMarkButtonVisible=!1);tmpBookConfig.OpenWindow=(getConfigValue("OpenWindow","_blank")+"").toLowerCase();tmpBookConfig.appLogoOpenWindow=(getConfigValue("appLogoOpenWindow","_blank")+"").toLowerCase();
...
"");tmpBookConfig.appLargeLogoURL&&(tmpBookConfig.appLargeLogoURL=getRealURL(tmpBookConfig.appLargeLogoURL));tmpBookConfig.isFixLogoSize=getConfigValue("isFixLogoSize",!1);tmpBookConfig.logoFixWidth=getConfigValue("logoFixWidth",0);tmpBookConfig.logoFixHeight=getConfigValue("logoFixHeight",0);tmpBookConfig.PhoneButtonVisible=getConfigValue("PhoneButtonVisible",!1);tmpBookConfig.PhoneButtonIcon=getConfigValue("PhoneButtonIcon","");tmpBookConfig.phoneNumber=getConfigValue("phoneNumber","");tmpBookConfig.aboutContactInfoTxt=
getConfigValue("aboutContactInfoTxt","");tmpBookConfig.isEncryptionBook=getConfigValue("isEncryptionBook",!1);tmpBookConfig.useTheAliCloudChart=getConfigValue("useTheAliCloudChart",!1);tmpBookConfig.securityType=getConfigValue("securityType",0);tmpBookConfig.singlePasswordKey=getConfigValue("singlePasswordKey","");tmpBookConfig.singlePasswordMD5=getConfigValue("singlePasswordMD5","");1<=passwardType()&&(tmpBookConfig.useTheAliCloudChart=!1);tmpBookConfig.isEncryptionBook&&(tmpBookConfig.useTheAliCloudChart=
!1);tmpBookConfig.useTheFliphtml5Service=getConfigValue("useTheFliphtml5Service",!1);g=base64.decode("b25saW5lLmZsaXBodG1sNS5jb20");if(document.domain==g||0<=tmpBookConfig.bookResourceBaseURL.indexOf(g))tmpBookConfig.useTheAliCloudChart=!1,tmpBookConfig.useTheFliphtml5Service=!0;tmpBookConfig.isEncryptionBook&&(tmpBookConfig.useTheFliphtml5Service=!1);tmpBookConfig.OnlyOpenInWechat=getConfigValue("OnlyOpenInWechat",!1);tmpBookConfig.NoWechatSharing=getConfigValue("NoWechatSharing",!1);tmpBookConfig.WeChatShareButtonIcon=
getConfigValue("WeChatShareButtonIcon","");tmpBookConfig.isShowAssistantPerson=getConfigValue("isShowAssistantPerson",!0);tmpBookConfig.OnlyOpenInIframe=getConfigValue("OnlyOpenInIframe",!1);tmpBookConfig.OnlyOpenInIframeInfo=getConfigValue("OnlyOpenInIframeInfo","Only open in iframe.");tmpBookConfig.NoWechatSharing&&jQuery(document).ready(function(){window.setTimeout(function(){function p(){WeixinJSBridge.call("hideOptionMenu")}global.wx&&wx.hideOptionMenu();"undefined"==typeof WeixinJSBridge?document.addEventListener?
document.addEventListener("WeixinJSBridgeReady",p,!1):document.attachEvent&&(document.attachEvent("WeixinJSBridgeReady",p),document.attachEvent("onWeixinJSBridgeReady",p)):p()},10)});tmpBookConfig.textClarityEnhancement=getConfigValue("textClarityEnhancement",0);tmpBookConfig.textSharpening=getConfigValue("textSharpening",!0);tmpBookConfig.textSharpening=!1;tmpBookConfig.AboutDescription=tmpBookConfig.AboutDescription.replace(/\n|\\n/g,"<br/>").replace(/\r|\\r/g,"<br/>");watchLateBookConfigPower();
checkBookmarkConfig();checkStaticAdConfig();checkDownloadAttachmentConfig();checkDownloadFullPublicationConfig();isBelowIE9()&&(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.WeChatShareButtonVisible=!1);tmpBookConfig.useTheAliCloudChart&&tmpBookConfig.backGroundImgURL&&(0<=tmpBookConfig.backGroundImgURL.indexOf("?")?tmpBookConfig.backGroundImgURL+="&x-oss-process=image/resize,h_800":tmpBookConfig.backGroundImgURL+="?x-oss-process=image/resize,h_800",
...
getConfigValue("isMouseEnterToDisplayArticleTitle",!1);tmpBookConfig.delayToFlipFirst=getConfigValue("delayToFlipFirst",!1);tmpBookConfig.timeToFlipFirst=getConfigValue("timeToFlipFirst",10);tmpBookConfig.printBackgroundPosition=getConfigValue("printBackgroundPosition","fit");try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(f=0;f<window.ignoreModuleArray.bookConfig.length;f++)h=window.ignoreModuleArray.bookConfig[f],void 0!=tmpBookConfig[h]&&(tmpBookConfig[h]=!1)}catch(p){}checkFlipStyleConfig();
return"issuu"==tmpBookConfig.FlipStyle?m.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/adaptivebook.min.css"),7):m.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/flipbook.min.css"),7);case 7:return checkPageEditorConfig(),recordError(),initHighlightColor(),k=Module._getVerifyString(),l=UTF8ToString(k),Module._free(k),m.yield(runDecryptedScript(l),0)}})};
...
(function(){function b(f,g){f=Number(f);return isNaN(f)?g:f}function c(){try{if(!global.staticAd||!global.staticAd.haveAd||"Chinese"==UserGroups||isPhone()||isPad())return!1;var f=parseInt(global.staticAd.adPosition);return 1!==f&&2!==f?!1:!0}catch(g){return!1}}function d(f){f=f||{};try{var g=b(tmpBookConfig.ORIGIN_TOP_MARGIN,b(tmpBookConfig.topMargin,10)),h=b(tmpBookConfig.ORIGIN_BOTTOM_MARGIN,b(tmpBookConfig.bottomMargin,10)),k=g,l=h,m;for(m in e.contributions)if(e.contributions.hasOwnProperty(m)){var p=
e.contributions[m]||{};null!=p.topReq&&(k=Math.max(k,b(p.topReq,k)));null!=p.bottomReq&&(l=Math.max(l,b(p.bottomReq,l)))}if(c()){var q=b(global.staticAd.height,90),v=parseInt(global.staticAd.adPosition);2===v&&(k=Math.max(k,g+q+20));1===v&&(l=Math.max(l,h+q+20))}tmpBookConfig.topMargin=k;tmpBookConfig.bottomMargin=l;var r=e.lastApplied.topMargin!==tmpBookConfig.topMargin||e.lastApplied.bottomMargin!==tmpBookConfig.bottomMargin;e.lastApplied.topMargin=tmpBookConfig.topMargin;e.lastApplied.bottomMargin=
tmpBookConfig.bottomMargin;try{r&&BookEvent&&BookEvent.trigger&&BookEvent.trigger("layoutMarginChanged",[{topMargin:tmpBookConfig.topMargin,bottomMargin:tmpBookConfig.bottomMargin,reason:e.pendingReason||f.reason||""}])}catch(t){}f.disableResize||e.pendingDisableResize||!r||"function"!=typeof global.onStageResize||onStageResize()}catch(t){console.log("LayoutMarginManager.computeAndApply error",t)}}if(!global.LayoutMarginManager){var e={contributions:{},lastApplied:{topMargin:void 0,bottomMargin:void 0},
pending:!1,pendingReason:"",pendingDisableResize:!1};global.LayoutMarginManager={setContribution:function(f,g){f&&(e.contributions[f]=g||{})},removeContribution:function(f){f&&delete e.contributions[f]},requestUpdate:function(f,g){e.pendingReason=f||e.pendingReason||"";g&&g.disableResize&&(e.pendingDisableResize=!0);if(!e.pending){e.pending=!0;var h=function(){e.pending=!1;d({reason:f,disableResize:g&&g.disableResize});e.pendingReason="";e.pendingDisableResize=!1};window.requestAnimationFrame?requestAnimationFrame(h):
setTimeout(h,0)}},flush:function(f,g){d({reason:f,disableResize:g&&g.disableResize})}}}})();function getLocalBookmarkExists(){try{if(!window.localStorage)return!1;var b=window.location.href.replace(window.location.hash,"").replace(window.location.search,"")+"BookMark";if(!window.localStorage[b])return!1;var c=window.localStorage.getItem(b),d=Instance.parse(c,[]);return Array.isArray(d)&&0<d.length}catch(e){return!1}}
function setBookVerticalMargin(b){b=void 0===b?{}:b;try{var c,d,e,f=!(null==(c=global.bmtConfig)?0:c.onSideEdge)&&0<(null==(d=global.bmtConfig)?void 0:null==(e=d.tabs)?void 0:e.length),g,h=null!=(g=b.bookmarkHeight)?g:70,k,l=!(null==(k=global.bmtConfig)?0:k.onSideEdge)&&getLocalBookmarkExists();f||l?global.LayoutMarginManager&&LayoutMarginManager.setContribution("bookmarkTab",{topReq:h}):global.LayoutMarginManager&&LayoutMarginManager.removeContribution("bookmarkTab");global.LayoutMarginManager&&
LayoutMarginManager.requestUpdate("bookmarkTab",{disableResize:!!b.disableResize})}catch(m){console.log("setBookVerticalMargin error",m)}}function checkDownloadAttachmentConfig(){try{window.downloadconfig&&window.checkBookConfigRestrictedKey&&window.checkBookConfigRestrictedKey("downloadAttachments")&&(downloadconfig.attachments=null)}catch(b){}}
function checkDownloadFullPublicationConfig(){try{if(!window.downloadconfig)return!1;var b=window.downloadconfig.pdf;if(!b||!window.checkBookConfigRestrictedKey||!window.checkBookConfigRestrictedKey("downloadFullPublication",!0))return!1;var c=String(b.url||b.urlOnlink||"").match(/[?&]type=([^&#]*)/);if(c&&"1"!==c[1])return window.downloadconfig.pdf=null,!0}catch(d){}return!1}
function removeDownloadAllAfterLateRestriction(){try{var b=global.modernDownloadPanel;if(b&&b.ui){var c=b.ui;if(c.optFull&&c.optFull.length){var d=c.optFull.hasClass("active");c.optFull.remove();c.optFull=null;if(d){var e=c.root.find(".modern-panel-option").first();e.length&&c.activate(e.attr("data-download-type"))}}}else{var f=global.downLoadBody;if(f&&(f.downloadAll&&f.downloadAll.remove&&f.downloadAll.remove(),f.downloadButton)){var g=window.downloadconfig||{},h=!g.hideDownloadSinglePage,k=!!(g.attachments&&
0<g.attachments.length);if(!h&&!k)f.downloadButton.hide&&f.downloadButton.hide(),f.selectAttachments&&f.selectAttachments.hide&&f.selectAttachments.hide(),f.noFilesAvailablePrompt&&f.content1&&0===f.content1.find(".no-files-prompt").length&&f.content1.append(f.noFilesAvailablePrompt);else if("downloadAll"===f.downloadButton.downloadType){b=h?"downloadCurrent":"downloadAttachments";var l="downloadCurrent"===b?f.downloadCurrent:f.downloadAttachments;f.elements&&"function"===typeof f.elements.buttonEvent&&
l&&l.length?f.elements.buttonEvent(f,l.get(0)):(f.downloadButton.downloadType=b,f.selectAttachments&&f.selectAttachments.toggle&&f.selectAttachments.toggle("downloadAttachments"===b))}}}}catch(m){}}
function checkStaticAdConfig(){if(global.staticAd&&global.staticAd.haveAd)if(window.checkBookConfigRestrictedKey&&window.checkBookConfigRestrictedKey("staticAd"))global.staticAd.haveAd=!1;else{var b="Chinese"==UserGroups?1:0;void 0==global.staticAd.adPosition&&(global.staticAd.adPosition=b);var c,d;b=null==(c=global)?void 0:null==(d=c.staticAd)?void 0:d.adPosition;0===parseInt(b)&&(void 0===tmpBookConfig.ORIGIN_RETAIN_BOOK_CENTER&&(tmpBookConfig.ORIGIN_RETAIN_BOOK_CENTER=tmpBookConfig.retainBookCenter),
tmpBookConfig.retainBookCenter=!1);isPhone()||isPad()||"Chinese"==UserGroups||global.LayoutMarginManager&&LayoutMarginManager.flush("staticAd",{disableResize:!0})}}
function getSideBookmarkColumnSpace(b){var c={left:0,right:0};if(isPhone()||isPad()||window.checkBookConfigRestrictedKey&&window.checkBookConfigRestrictedKey("BookMarkButtonVisible",!0))return c;var d=global.bmtConfig,e=d&&(d.tabs||(Array.isArray(d)?d:null));e=!(!e||!e.length);var f=getLocalBookmarkExists();if(!e&&!f)return c;e=!d||!1!==d.onSideEdge;"undefined"!==typeof bookConfig&&bookConfig.FlipDirection&&(e=!0);if(!e||d&&!1===d.horizontalText)return c;c="undefined"!==typeof BookmarkTab&&BookmarkTab.sideBookmarkColumnWidth?
BookmarkTab.sideBookmarkColumnWidth:136;return!1===b?"undefined"!==typeof rightToLeft&&rightToLeft?{left:c,right:0}:{left:0,right:c}:{left:c,right:c}}
function checkBookmarkConfig(){global.bmtConfig||(bmtConfig=[]);window.checkBookConfigRestrictedKey&&window.checkBookConfigRestrictedKey("BookMarkButtonVisible",!0)?global.bmtConfig=[]:(void 0==bmtConfig.onSideEdge&&(bmtConfig.onSideEdge=!0),void 0==bmtConfig.showPage&&(bmtConfig.showPage=!1),void 0==bmtConfig.hasTexture&&(bmtConfig.hasTexture=!1),void 0==bmtConfig.horizontalText&&(bmtConfig.horizontalText=!1))}
function getBookConfigPowerInfo(){try{var b,c,d,e,f,g,h,k=[null==(b=window.tmpBookConfig)?void 0:null==(c=b.power_info)?void 0:c.power,null==(d=window.bookConfig)?void 0:null==(e=d.power_info)?void 0:e.power,null==(f=window.UserInfoUtils)?void 0:null==(g=f.getDecryptedPower)?void 0:g.call(f),null==(h=window.userInfo)?void 0:h.power];for(b=0;b<k.length;b++)if(Array.isArray(k[b]))return k[b];return null}catch(l){return null}}
function watchLateBookConfigPower(){try{if(!getBookConfigPowerInfo()&&window.eventEmitter&&"function"===typeof window.eventEmitter.on){var b=function(){getBookConfigPowerInfo()&&(window.eventEmitter.off("loadUserInfo",b),reapplyRestrictedBookConfig())};window.eventEmitter.on("loadUserInfo",b)}}catch(c){console.log("watchLateBookConfigPower error",c)}}
function reapplyRestrictedBookConfig(){try{var b=!(!window.checkBookConfigRestrictedKey||!window.checkBookConfigRestrictedKey("staticAd",void 0)),c=!(!window.checkBookConfigRestrictedKey||!window.checkBookConfigRestrictedKey("BookMarkButtonVisible",!0));checkBookmarkConfig();checkStaticAdConfig();checkDownloadAttachmentConfig();checkDownloadFullPublicationConfig()&&removeDownloadAllAfterLateRestriction();b&&removeStaticAdAfterLateRestriction();c&&hideBookmarkTabAfterLateRestriction()}catch(d){console.log("reapplyRestrictedBookConfig error",
d)}}function eachBookAttachment(b,c){try{for(var d=[global.flipBook,global.singlePageBook,global.cardBook,global.invertBook,global.slideBook,global.singleSlideBook,global.catalogBook,global.singleCatalogBook],e=0;e<d.length;e++){var f=d[e]&&d[e].bookAttachments;f&&f.Items&&f.Items.find(b).each(c)}}catch(g){}}
function removeStaticAdAfterLateRestriction(){try{void 0!==tmpBookConfig.ORIGIN_RETAIN_BOOK_CENTER&&(tmpBookConfig.retainBookCenter=tmpBookConfig.ORIGIN_RETAIN_BOOK_CENTER)}catch(b){}try{global.LayoutMarginManager&&LayoutMarginManager.flush("staticAd")}catch(b){}eachBookAttachment("StaticAd",function(b){b&&"function"===typeof b.hide&&b.hide()});try{global.addSlideShow&&"function"===typeof global.addSlideShow.hide&&global.addSlideShow.hide()}catch(b){}}
function hideBookmarkTabAfterLateRestriction(){try{setBookVerticalMargin({disableResize:!0})}catch(b){}eachBookAttachment("BookmarkTab",function(b){b&&"function"===typeof b.hide&&b.hide()});try{"function"==typeof global.onStageResize&&global.onStageResize()}catch(b){}}
var isBool=function(b){if(!0===b||!1===b)return!0;if(void 0==b)return!1;var c=["false","no","hide","disable"];b=b.toLowerCase();return 0>["true","yes","show","enable"].indexOf(b)&&0>c.indexOf(b)?!1:!0},getValueFromConfig=function(b,c){a:{DeConfig_Parse(b);getEditConfig(b);void 0!=c&&"string"==typeof c&&""!=c.trim()&&isBool(c)&&(c=parseBool(c));if("power_info"!==b){var d,e,f=null==(e=(d=window).checkBookConfigRestrictedKey)?void 0:e.call(d,b,c);if(void 0!==f){b=f;break a}}b=void 0!=tmpBookConfig[b]?
tmpBookConfig[b]:getValueFromAliasConfig(b);b=void 0==b?c:void 0==c?b:"number"==typeof c?Number(b):"boolean"==typeof c?parseBool(b):"string"==typeof c&&"#"==c[0]?Color(b).toString():b}if("string"==typeof b&&(b=b.replaceAll("\\/","/",!0),b=b.replaceAll('\\"','"'),b.startsWith("[")&&b.endsWith("]")))try{b=JSON.parse(b)}catch(g){console.log("JSON parse error:",g)}return b},getConfigValue=function(b,c){c=getValueFromConfig(b,c);"string"==typeof c&&0<=c.indexOf("files")&&"normalPath"!=b&&"largePath"!=
b&&"thumbPath"!=b&&(c=fixURLValue(c));return c};function DeConfig_Parse(b){try{var c=Module._DeConfig_Get(window.key_index,allocateUTF8(b)),d=UTF8ToString(c);tmpBookConfig[b]="undefined"==d?void 0:d;return d}catch(e){}}function allocateUTF8(b){var c=lengthBytesUTF8(b)+1,d=_malloc(c);d&&stringToUTF8Array(b,HEAP8,d,c);return d}function getEditConfig(b){try{var c=window.editConfig||window.htmlConfig.editConfig;c&&void 0!=c[b]&&(tmpBookConfig[b]=c[b])}catch(d){}}
...
function initHighlightColor(b){var c=document.documentElement;if(c&&c.style&&c.style.setProperty){b||(tmpBookConfig.searchHightlightColor?b=tmpBookConfig.searchHightlightColor:"undefined"!=typeof bookConfig&&bookConfig&&bookConfig.searchHightlightColor&&(b=bookConfig.searchHightlightColor));b||(b="#0099ff");var d="",e=null;try{d=Color(b).toString(),/^#([0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(d)?e=Color(d).split():d=""}catch(f){d="",e=null}d&&(c.style.setProperty("--highlight-color",d),e&&void 0!==e.r&&
void 0!==e.g&&void 0!==e.b&&c.style.setProperty("--highlight-color-rgb",e.r+" "+e.g+" "+e.b))}}function changeBookConfigValue(b,c){tmpBookConfig[b]=c}
...
function checkFliphtml5PagesConfig(){var b,c,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:b=window.htmlConfig.fliphtml5_pages;if("string"!==typeof b){window.fliphtml5_pages=b;k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(new Promise(function(l,m){setTimeout(function(){try{var p=allocateUTF8(b),q=Module._DeString(p),v=UTF8ToString(q);Module._FreeMemory(q);if(v&&"undefined"!==v){q=v;var r=q.lastIndexOf("]");0<r&&(q=q.substring(0,
r+1));try{window.fliphtml5_pages=JSON.parse(q)}catch(t){console.log("JSON parse error:",t)}}else console.log("pages_value is empty or undefined"),window.fliphtml5_pages=[];Module._free(p);l()}catch(t){console.error("Failed to decrypt fliphtml5_pages:",t),window.fliphtml5_pages=[],m(t)}},0)}),5);case 5:k.leaveTryBlock(2);break;case 3:c=k.enterCatchBlock(),console.error("Failed to decrypt fliphtml5_pages:",c),window.fliphtml5_pages=[];case 2:if(!window.fliphtml5_pages||0==window.fliphtml5_pages.length)return k.return();
d=window.fliphtml5_pages;for(e=0;e<d.length;e++)d[e].w&&d[e].h&&(window.pageList||(window.pageList=[]),f=tmpBookConfig.largePageWidth,g=tmpBookConfig.largePageHeight,h=getAspectRatioDiff(f,g,d[e].w,d[e].h),.04>h||(pageList[e]={width:d[e].w,height:d[e].h}));k.jumpToEnd()}})}
...
return f.yield(loadComponentsJavascript(e),5);case 5:return f.return();case 3:c++,f.jumpTo(2)}})},checkExpandComponentConfig=function(){var b,c,d,e,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:b=["table of contents"==tmpBookConfig.leftRightPnlShowOption,"table of contents"==tmpBookConfig.mobileLeftRightPnlShowOption];c=_get(htmlConfig,"phoneTemplate.name","");if("Modern"===c&&(isPhone()||isPad()))return h.return();d=0;case 2:if(!(d<b.length)){h.jumpTo(0);
break}e=b[d];if(!e){h.jumpTo(3);break}f=tmpBookConfig.UIBaseURL+"javascript/component.min.js";return h.yield(loadComponentsJavascript(f),5);case 5:return g=tmpBookConfig.UIBaseURL+"javascript/colorPanel.min.js",h.yield(loadComponentsJavascript(g),6);case 6:return global.colorPanel||"undefined"===typeof JSColorPanel||(global.colorPanel=new JSColorPanel(tmpContainer)),h.return();case 3:d++,h.jumpTo(2)}})};
...
(function(){function b(l){l+="=";for(var m=decodeURIComponent(document.cookie).split(";"),p=0;p<m.length;p++){var q=m[p].trim();if(0===q.indexOf(l))return JSON.parse(q.substring(l.length))}return null}function c(l,m){try{if(!yunzhanCookieDomain&&!fliphtml5CookieDomain)return;if("Chinese"!=UserGroups&&-1>=window.location.hostname.indexOf(fliphtml5BrandDomain)){console.log("not chinese and not brand domain","setCookie");return}}catch(q){}var p=new Date;p.setTime(p.getTime()+31536E8);document.cookie=
l+"="+m+";expires="+p.toUTCString()+(";domain="+("Chinese"==UserGroups?yunzhanCookieDomain:fliphtml5CookieDomain)+";path=/")}function d(){for(var l={},m=window.location.search.substring(1).split("&"),p=0;p<m.length;p++){var q=m[p].split("="),v=decodeURIComponent(q[0]);q=q[1]?decodeURIComponent(q[1]):null;l[v]=q}return l}function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){var m=16*Math.random()|0;return("x"===l?m:m&3|8).toString(16)})}try{var f=b("first_visit_channel_source");
if(!f||!f.uuid){var g=e(),h={channel:"",referer:document.referrer,page:window.location.href,time:(new Date).getTime(),uuid:g},k=d();k.source?h.channel=k.source:k.i?h.channel="invite_code":k.utm_code?h.channel=k.utm_code:1===Object.keys(k).length&&null===Object.values(k)[0]&&(h.channel=Object.keys(k)[0]);c("first_visit_channel_source",JSON.stringify(h))}}catch(l){}})();
var VERSION_NAME="7.0.0",BUILD_DATE="2026091801",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
MiniStyle=Class({statics:{canShowButton:!0,isMini:function(){if((isPhone()||isPad())&&(!isInTheFrame()||window.location.href.includes("book_edit"))||!bookConfig.MiniStyle||fullScreenApi.isFullScreen()||NeatStyle.isNeat()||windowWidth>this.getMaxMiniWidthHeight().w&&windowHeight>this.getMaxMiniWidthHeight().h)return!1;this.init();return!0},getMaxMiniWidthHeight:function(){for(var b=bookConfig.maxWidthToSmallMode,c=bookConfig.maxHeightToSmallMode,d=window.location.search.split("&"),e=0;e<d.length;e++){var f=
d[e].toLowerCase();0<=f.indexOf("maxwidthtosmallmode")&&(b=parseInt(f.substring(f.indexOf("maxwidthtosmallmode")+19+1,f.length)));0<=f.indexOf("maxheighttosmallmode")&&(c=parseInt(f.substring(f.indexOf("maxheighttosmallmode")+20+1,f.length)))}return{w:b,h:c}},init:function(){if(!bookConfig.hideMiniFullscreen){if(isPhone()||isPad())if(window.self!==window.top){var b=window.innerHeight,c=window.screen.height,d=0;try{d=window.top.innerHeight}catch(e){d=0}if(70<=100*(d?b/d:b/c)||window.location.href.includes("bookcase"))return}else return;
this.caption||(this.caption=$("<div class='clickToRead'></div>"),"Chinese"===UserGroups?this.caption.html(getLanguage("lblFullscreen","Click to view in fullscreen.")):(this.caption.html('\n          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">\n            <path d="M17 1H3C1.89543 1 1 1.89543 1 3V17C1 18.1046 1.89543 19 3 19H17C18.1046 19 19 18.1046 19 17V3C19 1.89543 18.1046 1 17 1Z" stroke="white" stroke-width="2" stroke-linecap="round"/>\n            <rect x="10" y="4" width="6" height="2" rx="1" fill="white"/>\n            <rect x="10" y="16.0005" width="6" height="2" rx="1" transform="rotate(-180 10 16.0005)" fill="white"/>\n            <rect x="16" y="4.00049" width="6" height="2" rx="1" transform="rotate(90 16 4.00049)" fill="white"/>\n            <rect x="4" y="16" width="6" height="2" rx="1" transform="rotate(-90 4 16)" fill="white"/>\n          </svg>'),
...
if(c){var d=new Image;d.src=c;var e=function(){b.initBackgroundPosition();b.backgroundImage&&0!==b.backgroundImage.length||(b.backgroundImage=$("<div style='width:100%;height :100%;position : absolute;z-index : 1;'></div>"),b.bg.append(b.backgroundImage));b.backgroundImage.css({"background-image":"url("+c+")","background-position":"center center","background-repeat":b.backgroundRepeat,"background-size":b.backgroundSize})};d.complete&&0!==d.naturalHeight?e():(d.onload=function(){e()},d.onerror=function(){console.warn("\u9473\u5c7e\u6ad9\u9365\u5267\u5896\u9354\u72ba\u6d47\u6fb6\u8fab\u89e6:",
c);b.backgroundImage&&b.backgroundImage[0].style["background-image"]&&b.backgroundImage.css({"background-image":"none"})});this.initBackgroundPosition()}else this.backgroundImage&&this.backgroundImage[0].style["background-image"]&&this.backgroundImage.css({"background-image":"none"})},initBackgroundPosition:function(){this.backgroundSize="100% 100%";this.backgroundRepeat="no-repeat";switch(bookConfig.backgroundPosition.toLowerCase()){case "stretch":this.backgroundSize="100% 100%";this.backgroundRepeat=
"no-repeat";break;case "fill":this.backgroundSize="cover";this.backgroundRepeat="no-repeat";break;case "fit":this.backgroundSize="contain";this.backgroundRepeat="no-repeat";break;case "tile":this.backgroundSize="auto",this.backgroundRepeat="repeat"}},onFullscreen:function(){fullScreenApi.isFullScreen()?this.bg.css("opacity",1):this.bg.css("opacity",bookConfig.backgroundOpacity/100)},compute:function(b,c,d){d=d*Math.PI/180;return Point(Math.abs(c*Math.sin(d))+Math.abs(b*Math.cos(d)),Math.abs(c*Math.cos(d))+
Math.abs(b*Math.sin(d)))},initEvent:function(){var b=Math.floor(255*Math.random()),c=Math.floor(255*Math.random()),d="rgb("+b+","+b+","+b+")",e="rgb("+c+","+c+","+c+")";bookContainer.bind(_event._down,function(f){f=f.originalEvent.changedTouches?f.originalEvent.changedTouches:[f];var g=void 0==this.doorStas?8:this.doorStas,h=windowWidth-f[0].pageX,k=windowHeight-f[0].pageY;43>f[0].pageX&&52>f[0].pageY&&8===g&&(this.doorStas=9);60>h&&39>k&&9===g&&(f=$("<div>"+skin[300]+skin[12]+"l"+skin[66]+skin.m+
skin.i(22)+skin[42]+skin[60]+"</div>"),g=$("<div>"+skin[300]+skin.y+String.fromCharCode(117)+"n"+skin[11]+skin[26]+skin.i(5)+String.fromCharCode(110)+365+skin[60]+"</div>"),bookContainer.append(f),bookContainer.append(g),h=Math.floor(100*Math.random()),f.css({position:"absolute",top:h+"px",color:d}),g.css({position:"absolute",top:h+30+Math.floor(100*Math.random())+"px",color:e}),this.doorStas=8)}.bind(this))},addBookPlugin:function(){if(!isPhone()){if(window.bookPlugin&&bookPlugin.properties){var b=
{type:bookPlugin.name,opacity:bookPlugin.opacity,controls:!0,style:bookPlugin.properties.basic};$.extend(b,bookPlugin.properties.extended);window.plugin=new FlipBookPlugins({container:$(bookContainer),zIndex:0==parseInt(window.bookPlugin.layout)?10:0,plugins:[b]})}resizePlugin()}},addSlideShow:function(){if(isPhone()||"English"!=UserGroups){var b=parseInt(_get(global,"staticAd.adPosition",1));if(window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2,3].includes(b)){this.slideShow=
$("<div class='slideShow' id='slide-show' style='position:absolute;z-index:1002;'></div>");switch(b){case 1:this.slideShow.css({bottom:"0px",width:"100%"});break;case 2:this.slideShow.css({top:"22px",width:"100%"});break;case 3:b=parseInt(_get(global,"staticAd.top",50));var c=parseInt(_get(global,"staticAd.left",50)),d=parseInt(_get(global,"staticAd.width",50)),e=parseInt(_get(global,"staticAd.height",50));this.slideShow.css({top:b+"%",left:c+"%",width:d+"%",height:e+"%"})}b=window.staticAd.bgColor?
window.staticAd.bgColor:"#fff";c=window.staticAd.bgOpacity?window.staticAd.bgOpacity:0;b=(new Color(b)).rgba(c);this.slideShow.css("background",b);window.staticAd.bgColor||this.slideShow.css("z-index","auto");window.addSlideShow=new SliderShowAd(this.slideShow,window.staticAd)}}},addDynamicBackground:function(){var b=this,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return!bookConfig.backgroundScene||"None"==bookConfig.backgroundScene||isBelowIE9()?d.jumpTo(0):
d.yield(loadComponentsJavascript(bookConfig.UIBaseURL+"javascript/dynamicBackground.min.js"),3);c=$("<div></div>");c.css({width:"100%",height:"100%",position:"absolute","z-index":2});b.bg.append(c);DynamicBackground.create({name:bookConfig.backgroundScene,stage:c,width:windowWidth,height:windowHeight});d.jumpToEnd()})},setRadiusColor:function(){this.gColorA===this.gColorB?this.bgColor.css({background:this.gColorA}):this.bgColor.css({"background-image":_agent_.browser.prefix+"linear-gradient("+this.gAngle+
"deg, "+this.gColorA+", "+this.gColorB+")"})}});
...
"Search");case "setting":return getLanguage("btnSettings","Settings");case "share":return getLanguage("frmShareCaption","Share");case "tableofcontent":return getLanguage("frmToc","Table of Contents");case "thumbnail":return getLanguage("btnThumb","Thumbnail");case "videogallery":return getLanguage("btnVideo","Video Gallery");case "tel":return getLanguage("frmTelephone","Tel");case "download":return getLanguage("btnDownload","Download")}},getFormFavicon:function(b){if(!b)return"";b=b.toLowerCase();
switch(b){case "about":return this.getSrc("about",bookConfig.AboutButtonIcon);case "bookmark":return this.getSrc("bookmark",bookConfig.BookmarkButtonIcon);case "help":return this.getSrc("Help",bookConfig.HelpButtonIcon);case "language":return this.getSrc("languageChange",bookConfig.LanguageButtonIcon);case "print":return this.getSrc("print",bookConfig.PrintButtonIcon);case "search":return this.getSrc("search",bookConfig.SearchButtonIcon);case "setting":return"";case "share":return this.getSrc("sharethis",
bookConfig.ShareButtonIcon);case "tableofcontent":return this.getSrc("tableOfContent",bookConfig.TableOfContentButtonIcon);case "thumbnail":return this.getSrc("thumbnails",bookConfig.ThumbnailButtonIcon);case "videogallery":return this.getSrc("videoGallery",bookConfig.VideoButtonIcon);case "tel":return"";case "download":return this.getSrc("download",bookConfig.DownloadButtonIcon)}},getSrc:function(b,c){return c&&""!=c?c:toolbar_icons&&toolbar_icons[b]?"data:image/png;base64,"+toolbar_icons[b]:phone_toolbar_icons&&
phone_toolbar_icons[b]?"data:image/png;base64,"+phone_toolbar_icons[b]:uiBaseURL+b+".png"}}}),FormManager={stack:[],zIndexBase:2E3,lastActiveElement:null,register:function(b){this.unregister(b);this.stack.push(b);this.updateZIndex();this.lastActiveElement=global.activeButton;window.dispatchEvent&&window.dispatchEvent(new CustomEvent("form:show",{detail:b}))},unregister:function(b){var c=this.stack.indexOf(b);-1<c&&this.stack.splice(c,1);this.updateZIndex();isPhone()||isPad()||!this.lastActiveElement||
"function"!==typeof this.lastActiveElement.focus||(this.lastActiveElement.focus(),this.lastActiveElement=null);window.dispatchEvent&&window.dispatchEvent(new CustomEvent("form:hide",{detail:b}))},getTop:function(){return this.stack.length?this.stack[this.stack.length-1]:null},updateZIndex:function(){for(var b=0;b<this.stack.length;b++){var c=this.stack[b];if(c.stage){var d=c.stage.parent();d.hasClass("appear_win10")?d.css("z-index",this.zIndexBase+b):c.stage.css("z-index",this.zIndexBase+b)}else"function"===
typeof c.setStyle&&c.setStyle({zIndex:this.zIndexBase+b})}},closeTop:function(){var b=this.getTop();b&&"function"===typeof b.hide&&!1!==b.escClosable&&b.hide()}},FormFrame=Class({parent:void 0,rightToLeft:!1,visible:!1,formType:"",mainColor:"",fontColor:"",mainColorObj:null,fontColorObj:null,elements:null,closeUrl:"",disableDrag:!1,skipFormManagerRegister:!1,create:function(b){this.options=b;this.parent=this.options.parent;this.formType=this.options.formType;this.rightToLeft=this.options.rightToLeft;
this.isPhone=this.options.isPhone;this.initColorConfig();wrapFormManagerRegister(this)},onCreate:function(){},resetFormColor:function(){this.initColorConfig();this.resetIconSrc();this.resetColorChanged();this.visible&&this.changeIconColor();this.initColorCss&&this.initColorCss();this.resetFormItems&&this.resetFormItems()},initColorConfig:function(){this.formOpacity=bookConfig.formBackgroundOpacity?bookConfig.formBackgroundOpacity:bookConfig.ToolBarAlpha;this.mainColor=Color(bookConfig.formBackgroundColor?
bookConfig.formBackgroundColor:bookConfig.toolbarColor).toString();this.fontColor=Color(bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor).toString();this.mainColorObj=Color(this.mainColor);this.fontColorObj=Color(this.fontColor)},resetColorChanged:function(){this.close&&(this.close.find("img")[0]?this.close.find("img")[0].colorChanged=!1:this.close[0].colorChanged=!1);this.favicon&&(this.favicon[0].colorChanged=!1)},resetIconSrc:function(){FormInfo.getFormFavicon(this.formType)&&
this.favicon&&this.favicon.attr("src",FormInfo.getFormFavicon(this.formType));this.close.find("img")[0]?this.close.find("img").attr("src",this.closeUrl):this.close.attr("src",this.closeUrl)},changeIconColor:function(){this.close&&this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor)},setStyle:function(b){this.stage.css(b)},getShowStatu:function(){return this.visible},showOrHide:function(){this.visible?this.hide():this.show()},show:function(b){void 0===
b&&(b=!0);this.visible=!0;this.stage.show();this.onShow(b);this.setA11yAndFocus(b)},hide:function(){this.visible=!1;this.stage.hide();$(tmpContainer).removeAttr("tabindex");this.onHide();this.favicon&&this.favicon.off("keydown.a11y");this.stage&&this.stage.find("button, [role=button], [tabindex]").off("keydown.a11y")},onShow:function(b){void 0===b&&(b=!0);b&&this.stage.focus();this.changeIconColor()},onHide:function(){},onResize:function(){},destroy:function(){},beforeShow:function(){},beforeHide:function(){},
changeLanguage:function(){this.elements&&this.elements.changeLanguage();this.title&&this.title.find("span").html(FormInfo.getFormTitle(this.formType))},setA11y:function(){this.stage&&this.stage.find(".btn, .button").each(function(){$(this).attr("tabindex",0);$(this).attr("role","button");$(this).off("keydown.a11y").on("keydown.a11y",function(b){"Enter"!==b.key&&" "!==b.key||$(this).trigger("click")})})},setA11yAndFocus:function(b){void 0===b&&(b=!0);this.setA11y();b&&(this.stage.attr("tabindex",-1),
$(tmpContainer).attr("tabindex",-1),this.stage.focus())}}),FadeOutFadeForm=Class({create:function(b){this._super(b);this.closeUrl=window.form_icons&&form_icons.close?"data:image/png;base64,"+form_icons.close:uiBaseURL+"close.png";this.stage=$("<div class='"+FormInfo.getFormCssClassName(this.formType,this.isPhone)+"'></div>");this.title=$("<p class='form_title'></p>");FormInfo.getFormTitle(this.formType)&&this.title.append($("<span>"+FormInfo.getFormTitle(this.formType)+"</span>"));FormInfo.getFormFavicon(this.formType)&&
(this.favicon=$("\n        <img alt=\"\" aria-hidden=\"true\" width='auto' height='auto' class='favicon' src='"+FormInfo.getFormFavicon(this.formType)+"'/>\n      "));this.close=$('\n      <button class="close aria-label-button" aria-label="Close '+FormInfo.getFormTitle(this.formType)+'">\n        <img src="'+this.closeUrl+'" alt="" aria-hidden="true">\n      </button>\n    ');this.rightToLeft&&this.stage.addClass("rightToLeft");this.initHtml();this.initEvent();this.onCreate()},onCreate:function(){var b=
this;this.stage.appearance("",function(){b.visible=!1});this.parent.append(this.stage.getDom());this.title&&this.title.css({cursor:"default"});this.hide()},initEvent:function(){var b=this;this.disableDrag||this.stage.drag();this.stage.on(_event._down,function(c){c.stopPropagation()});this.close.on("click",function(){return b.hide()});this.close.on("mouseenter",function(){return b.close.css({background:"rgba(255,255,255,0.25)"})});this.close.on("mouseleave",function(){return b.close.css({background:""})})},
...
getLanguage("lblConfirm","confirm")+"</div>");this.content.append(this.title);this.content.append(this.btnCancle);this.content.append(this.btnConfirm);this.stage.append(this.content)},initEvent:function(){var b=this;this._super();this.btnCancle.on(_event._click,function(c){c.stopPropagation();b.hide()});this.btnConfirm.on(_event._click,function(c){c.stopPropagation();b.options.callback&&b.options.callback();b.hide()})},destroy:function(){this.stage.getDom().remove()},hide:function(){this._super();
window.localStorage.setItem(realLocation+"?historySubmmit",(new Date).getTime())}}).extend(FadeOutFadeForm),showMessage=function(b,c,d){(new ShowMessage({parent:bookContainer,formType:"message",rightToLeft:rightToLeft,message:b,callback:c})).show(d)};
function getArticleEditor(){function b(u){if(window.isExecuteGetInverseEditor)var x=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(x),u()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),u(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(z){d(z,u)},u,"")}function c(u,x,z,A,F){var D=new XMLHttpRequest;D.responseType=
void 0===A?"json":A;D.open("GET",u);D.send();D.onreadystatechange=function(){4===D.readyState&&(200===D.status||304===D.status?x&&x(D):"bookinfo"===F&&x?x():z&&z(x))};D.error=function(){z&&z(x)}}function d(u,x){t&&(clearTimeout(t),t=null);if(window.Module.isReady){var z=allocateUTF8(u.responseText),A=Module._DeString(z),F=UTF8ToString(A);F=eval(F);Module._free(z);Module._FreeMemory(A);e(F);x();window.runArticleEditor&&delete window.runArticleEditor}else t=setTimeout(function(){d(u,x)},100)}function e(u){(window.articleListConfig=
u)?g(u):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&p(function(u){window.articleConfig=u.response})}function g(u){for(var x=[],z=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],F=0;F<z;F++){for(var D=A&&A.length&&A[F]?A[F].index:F,L=[],M=0;M<u.length;M++)(u[M].articles?u[M].articles:[]).forEach(function(I){if(I.isShowLinkSplited){if(I.articleTextList&&
I.articleTextList.length){var G=l(I.articleTextList,D);console.log(G,D);I=k(I);for(var O=0;O<G.length;O++){var K=h(I,G[O]);L.push(K)}}}else{G="";if(""===I.activePage||void 0===I.activePage||I.activePage&&(-2===parseFloat(I.activePage)||parseFloat(I.activePage)===D))a:{G=D;O={};I.collapseArea&&(O=JSON.parse(I.collapseArea));if(O[G])G={rect:O[G]};else{if(!I.articleTextList||!I.articleTextList.length){G="";break a}G=m(I.articleTextList,G)}G="[object Object]"===Object.prototype.toString.call(G)?{tannoName:"link1",
x:G.rect.x,y:G.rect.y,width:G.rect.width,height:G.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:G.rect.pageWidth,pageHeight:G.rect.pageHeight}:""}G&&I.articleTextList&&I.articleTextList.length&&(I=k(I),K=h(I,G),L.push(K))}});x.push(L)}console.log("currentPageEditor",JSON.parse(JSON.stringify(x)));window.inverseEditor=x}function h(u,x){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
downColor:"#4997ee",outColor:"#4997ee",overAlpha:"0.3",downAlpha:"0.5",outAlpha:"0"});var z=window.articleConfig.hotArea;return{action:{triggerEventType:"mouseDown",actionType:"com.mobiano.flipbook.pageeditor.TAnnoActionShowArticle",articleConfig:u,linkTarget:"showArticle"},annotype:"com.mobiano.flipbook.pageeditor.TAnnoLink",annoId:"202211710188056",isInverse:!0,alpha:"1",overColor:z.overColor,downColor:z.downColor,outColor:z.outColor,overAlpha:z.overAlpha,downAlpha:z.downAlpha,outAlpha:z.outAlpha,
...
(x.text=x.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return x});return{articleId:u.articleId,newTime:u.newTime,title:u.title,subTitle:u.subTitle,author:u.author,categoryId:u.categoryId,articleTextList:u.articleTextList}}function l(u,x){var z=[];u.forEach(function(A){-1!==x&&(A.pageIndex===x||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===x}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,x),A.length&&(z=[].concat($jscomp.arrayFromIterable(z),$jscomp.arrayFromIterable(A)))):
z.push(A.rect))});return z}function m(u,x){var z="";u.forEach(function(A){if(-1!==x&&(A.pageIndex===x||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(D){return D.pageIndex===x}).length))if(""===z)z=A.mergeList&&A.mergeList.length?m(A.mergeList,x):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var F=[z].concat(A.mergeList);z=m(F,x)}z.rect.x>A.rect.x&&(z.rect.x=A.rect.x);z.rect.y>A.rect.y&&(z.rect.y=A.rect.y);z.rect.endX<A.rect.endX&&(z.rect.endX=A.rect.endX);z.rect.endY<
A.rect.endY&&(z.rect.endY=A.rect.endY);z.rect.width=z.rect.endX-z.rect.x;z.rect.height=z.rect.endY-z.rect.y}});return z}function p(u){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,u,q):q(u)}function q(u){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,u,v):v(u)}function v(u){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var x=bookConfig.periodsConfigPath;x=x.replace("%periodicalId%",window.book_visit.periodicalId);c(x,u,r)}else r(u)}
function r(u){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,u):u&&u()}var t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){return u.return(new Promise(function(x,z){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?x():window.runArticleEditor||window.inverseEditor?x():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(z=bookConfig.bookBaseURL)?(z.endsWith("/")||(z+="/"),c(z+"bookinfo.js",function(A){A&&A.response&&
...
Class("BookmarkTabItem",{$body:null,$parent:null,zIndex:0,_currentPageActive:!1,bookmarkTabPointerInside:!1,_horizBookmarkIdleWidthPx:null,_layoutTabZIndex:null,_SIDE_COL_HOVER_DELTA:36,_SIDE_COL_CSS_IDLE_WIDTH_PX:66,create:function(b){this.data=b;this.$body=$("<span class='bookmark_item bookmark_caption'></span>");this.initStyle();this.update()},initStyle:function(){bmtConfig.showPage&&this.$body.attr("title",getShownPageNumber(this.data.pageIndex));bmtConfig.hasTexture&&this.$body.css({"background-image":"url("+
(uiBaseURL+"leather1.png)"),"background-repeat":"repeat"});!bookConfig.enableCustomizedBookmarkWidth||!bookConfig.customizedBookmarkWidth||bmtConfig.horizontalText&&(bmtConfig.onSideEdge||bookConfig.FlipDirection)||this.$body.css({width:bookConfig.customizedBookmarkWidth+"px"})},getData:function(){return this.data},setData:function(b){this.data=b;this.update()},update:function(){var b=(bookConfig.tabAlpha?bookConfig.tabAlpha:100)/100;this.$body.css("background-color",Color(this.data.color).rgba(b));
this.data.fontColor&&this.$body.css("color",Color(this.data.fontColor).toString());this.$body.html(this.data.caption)},moveTo:function(b){var c=this;this.$parent!=b&&(this.remove(),this.$parent=b,this.$parent.append(this.$body),this.$body.on("click",function(d){return c.onBookmarkClick(d)}),this.$body.on("mouseenter",function(d){return c.onBookmarkMouseEnter(d)}),this.$body.on("mouseleave",function(d){return c.onBookmarkMouseLeave(d)}),this.$body.on("pointerdown pointermove pointerup pointerenter",
function(d){return d.stopPropagation()}),this.$body.on("mousedown mousemove mouseup mouseenter",function(d){return d.stopPropagation()}))},remove:function(){null!=this.$parent&&(this.bookmarkTabPointerInside=this._currentPageActive=!1,this.$body.remove(),this.$body.off(),this.$parent=null)},setCurrentPageActive:function(b){b=!!b;this._currentPageActive!==b&&(this._currentPageActive=b,this.$parent&&(this._currentPageActive||this.bookmarkTabPointerInside?this._applyBookmarkTabExpandedVisualInstant():
this._applyBookmarkTabCollapsedVisual()))},_bookmarkTabVisualExpanded:function(){return!(!this._currentPageActive&&!this.bookmarkTabPointerInside)},_applyBookmarkTabExpandedVisualInstant:function(){if(this.$parent&&this._bookmarkTabVisualExpanded()){var b=this._SIDE_COL_HOVER_DELTA;if(this._isSideColumnItem()){var c=this._getSideColumnIdleWidthPx();this._horizBookmarkIdleWidthPx=c;this.$body.stop(!0,!0);this.$body.css({width:c+b,"z-index":999})}else null==this._layoutTabZIndex&&(this._layoutTabZIndex=
this.$body.css("z-index")),this.zIndex=this._layoutTabZIndex,this.$body.stop(!0,!0),this.$body.css({top:"0px","align-items":"center","z-index":999})}},_applyBookmarkTabCollapsedVisual:function(){if(this.$parent&&!this._bookmarkTabVisualExpanded())if(this._isSideColumnItem()){var b=this._SIDE_COL_HOVER_DELTA,c=this._horizBookmarkIdleWidthPx,d=Math.floor(this.$body.width()),e=this._SIDE_COL_CSS_IDLE_WIDTH_PX;b=null!=c&&0<c?Math.max(c,e):d>=e+b-1?d-b:Math.max(50,e);this.$body.stop(!0,!0).animate({width:b},
{duration:300,complete:function(){$(this).css("width","")}});this._horizBookmarkIdleWidthPx=null;this.$body.css({"z-index":null!=this._layoutTabZIndex?this._layoutTabZIndex:this.zIndex})}else this.$body.stop(!0,!0).animate({top:"30px"},300),this.$body.css({"align-items":"flex-start","z-index":null!=this._layoutTabZIndex?this._layoutTabZIndex:this.zIndex})},onBookmarkClick:function(b){gotoPageFun(this.data.pageIndex,!1,"bookmark tab");BookEvent.trigger("customEvent",["click_bookmark_on_book_to_"+this.data.pageIndex,
{click_bookmark_on_book_to:this.data.pageIndex}])},onBookmarkMouseEnter:function(b){this.bookmarkTabPointerInside=!0;null==this._layoutTabZIndex&&(this._layoutTabZIndex=this.$body.css("z-index"));this.zIndex=null!=this._layoutTabZIndex?this._layoutTabZIndex:this.$body.css("z-index");if(this._isSideColumnItem()){b=this._SIDE_COL_HOVER_DELTA;var c=this._getSideColumnIdleWidthPx();this._horizBookmarkIdleWidthPx=c;this._currentPageActive||this.$body.stop(!0,!0).animate({width:c+b},300);this.$body.css({"z-index":999})}else this._currentPageActive||
this.$body.stop(!0,!0).animate({top:"0px"},300),this.$body.css({"align-items":"center","z-index":999})},onBookmarkMouseLeave:function(b){this.bookmarkTabPointerInside=!1;this._currentPageActive?this._applyBookmarkTabExpandedVisualInstant():this._applyBookmarkTabCollapsedVisual()},_getSideColumnIdleWidthPx:function(){var b=this._SIDE_COL_CSS_IDLE_WIDTH_PX,c=this._SIDE_COL_HOVER_DELTA,d=parseFloat(this.$body.css("width"));return!isFinite(d)||0>=d||d>=b+c-1?b:Math.round(d)},_isSideColumnItem:function(){return!!(this.$parent&&
bmtConfig.horizontalText&&(bmtConfig.onSideEdge||bookConfig.FlipDirection)&&this.$parent.hasClass&&this.$parent.hasClass("side_bookmark_column"))},setPosition:function(b){this.$body.css({left:"",right:"",top:"",bottom:"","z-index":""});this._isSideColumnItem()&&(this.$body.css({width:"",maxWidth:""}),this._horizBookmarkIdleWidthPx=null,this.$parent&&this.$parent.hasClass&&(this.$parent.hasClass("left_bookmark_bar")||this.$parent.hasClass("up_bookmark_bar")?this.$body.css({left:"auto",right:"0"}):
(this.$parent.hasClass("right_bookmark_bar")||this.$parent.hasClass("down_bookmark_bar"))&&this.$body.css({left:"0",right:"auto"})));this.$body.css(b);Object.prototype.hasOwnProperty.call(b,"z-index")&&(this._layoutTabZIndex=b["z-index"]);this._bookmarkTabVisualExpanded()&&this._applyBookmarkTabExpandedVisualInstant()},getWidth:function(){return this.$body.width()},getSpanAlongBar:function(){if(bmtConfig.horizontalText&&(bmtConfig.onSideEdge||bookConfig.FlipDirection)&&this.$parent&&this.$parent.hasClass&&
this.$parent.hasClass("side_bookmark_column")){if(this.$parent&&this.$parent.css&&"none"===this.$parent.css("display"))return 75;var b=this.$body.outerHeight(!1);b||(b=this.$body.outerHeight());return!b||20>b?75:Math.round(b)}return this.getWidth()}});
...
Class("BookmarkTab",{statics:{sideBookmarkColumnWidth:136},$parent:null,visible:!0,onSideEdge:!0,zIndex:0,create:function(b,c){this.$parent=b;this.hideSmallTab=!!c;this.onSideEdge=bmtConfig.onSideEdge;bookConfig.FlipDirection&&(this.onSideEdge=!0);this.zIndex=6;this.bookmarkPool=new BookmarkItemPool;this.bookmarkList=new BookmarkList;this._bookmarkTabAppliedActiveKey=this._bookmarkTabPendingFlipPages=this._bookmarkTabFlipRafId=null;this.initBookmarkBar();this.reload();isPhone()||isPad()||this.onSideEdge||
!this.bookmarkList.count()||setBookVerticalMargin({bookmarkHeight:70});var d=this;window.requestAnimationFrame?requestAnimationFrame(function(){requestAnimationFrame(function(){if(d.visible&&d.$parent)d.onResize()})}):setTimeout(function(){if(d.visible&&d.$parent)d.onResize()},100);BookEvent.bindEvent("flipPage",function(e,f,g){e=d._parseBookmarkTabPageListFromFlip(g);e.length&&(d._bookmarkTabPendingFlipPages=e,null==d._bookmarkTabFlipRafId&&(d._bookmarkTabFlipRafId=(window.requestAnimationFrame||
function(h){return setTimeout(h,0)})(function(){d._bookmarkTabFlipRafId=null;var h=d._bookmarkTabPendingFlipPages;d._bookmarkTabPendingFlipPages=null;d.visible&&h&&h.length&&d._applyBookmarkTabCurrentPageActive(h)})))})},initBookmarkBar:function(){bookConfig.FlipDirection?(this.leftBar=$("<div class='up_bookmark_bar'></div>"),this.rightBar=$("<div class='down_bookmark_bar'></div>")):(this.leftBar=$("<div class='left_bookmark_bar'></div>"),this.rightBar=$("<div class='right_bookmark_bar'></div>"));
this.leftBar.on("mouseup touchstart",function(b){b.stopPropagation()});this.rightBar.on("mouseup touchstart",function(b){b.stopPropagation()});this.onSideEdge&&(bmtConfig.horizontalText?(this.leftBar.addClass("horizontal_text side_bookmark_column"),this.rightBar.addClass("horizontal_text side_bookmark_column")):(this.leftBar.addClass("vertical"),this.rightBar.addClass("vertical")));this.leftBar.css("z-index",this.zIndex);this.rightBar.css("z-index",this.zIndex);this.$parent.append(this.leftBar);this.$parent.append(this.rightBar)},
reload:function(){0!=this.visible&&(this.bookmarkList.reload(),this.refresh())},refresh:function(){0!=this.visible&&(this.separate(),this.adjustBar(),this.onResize(),this._applyBookmarkTabCurrentPageActive(BookInfo.getCurrentPages(),{force:!0}))},_parseBookmarkTabPageListFromFlip:function(b){var c=[];if(null==b||""===b)return c;b=String(b).split("-");for(var d=0;d<b.length;d++){var e=parseInt(b[d],10);isNaN(e)||c.push(e)}return c},_bookmarkTabNormalizePagesKey:function(b){return b&&b.length?b.slice().sort(function(c,
d){return c-d}).join("-"):""},_applyBookmarkTabCurrentPageActive:function(b,c){if(this.visible&&b&&b.length){var d=this._bookmarkTabNormalizePagesKey(b);if(c&&c.force||d!==this._bookmarkTabAppliedActiveKey){this._bookmarkTabAppliedActiveKey=d;c={};for(d=0;d<b.length;d++)c[b[d]]=!0;b=this.bookmarkPool.items;for(d=0;d<b.length;d++){var e=b[d];e.$parent&&e.setCurrentPageActive(!!c[e.getData().pageIndex])}}}},separate:function(){this.refreshShownPage();this.bookmarkPool.clean(this.bookmarkList);for(var b=
...
this.zIndex);rightToLeft?(this.isTheLastPage()&&this.rightBar.css("z-index",1),this.isTheFirstPage()&&this.leftBar.css("z-index",1)):(this.isTheLastPage()&&this.leftBar.css("z-index",1),this.isTheFirstPage()&&this.rightBar.css("z-index",1))},onResize:function(){if(this.onSideEdge){var b=this.$parent.height(),c=this.$parent.width();bookConfig.FlipDirection&&!this.hideSmallTab&&(b/=2);if(bmtConfig.horizontalText){var d=BookmarkTab.sideBookmarkColumnWidth||136;bookConfig.FlipDirection?(this.leftBar.css({width:d+
"px",height:b+"px",left:-d+"px",top:"0",bottom:"auto",right:"auto"}),this.rightBar.css({width:d+"px",height:b+"px",left:c-d+"px",top:"auto",bottom:"0",right:"auto"})):(this.leftBar.css({width:d+"px",height:b+"px",left:-d+"px",top:"0",bottom:"auto",right:"auto"}),this.rightBar.css({width:d+"px",height:b+"px",left:c+"px",top:"0",bottom:"auto",right:"auto"}));rightToLeft?(this.resizeItemsOfBar(this.rightBar,"top",1,b),this.resizeItemsOfBar(this.leftBar,"top",-1,b)):(this.resizeItemsOfBar(this.leftBar,
"top",1,b),this.resizeItemsOfBar(this.rightBar,"top",-1,b))}else this.leftBar.css({width:b+"px",left:-b+"px"}),this.rightBar.css({width:b+"px",left:c+"px"}),bookConfig.FlipDirection&&this.rightBar.css({left:c-b+"px"}),rightToLeft?(this.resizeItemsOfBar(this.rightBar,"left",1),this.resizeItemsOfBar(this.leftBar,"right",-1)):(this.resizeItemsOfBar(this.leftBar,"right",1),this.resizeItemsOfBar(this.rightBar,"left",-1))}else b=this.$parent.width(),this.$parent.width(),d=c=b,this.hideSmallTab||("issuu"!=
bookConfig.FlipStyle?(c=b/2,d=b/2):(b=flipBook.getCurrentPageIndex(),b=flipBook.getFitWHByIndex(b),c=b[0].x,d=b[1].x)),this.leftBar.css({width:c+"px",left:"0px"}),this.rightBar.css({width:d+"px",left:"auto",right:0}),rightToLeft?(this.resizeItemsOfBar(this.rightBar,"left",1),this.resizeItemsOfBar(this.leftBar,"left",-1)):(this.resizeItemsOfBar(this.leftBar,"left",1),this.resizeItemsOfBar(this.rightBar,"left",-1));this.setScale(1,1,0,0,1,1,0,0);this._applyBookmarkTabCurrentPageActive(BookInfo.getCurrentPages(),
{force:!0})},_computeSideColumnBookmarkTops:function(b,c,d,e,f){var g=b.length;if(!g)return[];d=Math.max(0,d|0);var h=null!=f?f:2;c=Math.max(0,c-2*d);b=b.map(function(l,m){return l+(0===m?h:0)});for(var k=f=0;k<g;k++)f+=b[k];k=Math.max(0,e);e=[];if(1===g)return e.push(d),e.map(function(l){return Math.round(100*l)/100});c=f+(g-1)*k<=c?k:(c-f)/(g-1);e.push(d);for(f=1;f<g;f++)d+=b[f-1]+c,e.push(d);return e.map(function(l){return Math.round(100*l)/100})},resizeItemsOfBar:function(b,c,d,e){if(b&&b.length&&
(!b.is||b.is(":visible"))){var f=("top"===c||"bottom"===c)&&b.hasClass&&b.hasClass("side_bookmark_column"),g=f?2:22;e=f&&null!=e&&0<e?e:"top"===c||"bottom"===c?b.height():b.width();if(f){f=[];for(var h=0;h<this.bookmarkList.count();h++){var k=this.bookmarkList.item(h),l=this.bookmarkPool.getBookmarkItem(k);l.$parent==b&&f.push({bookmark:k,bookmarkItem:l,span:l.getSpanAlongBar()})}if(f.length)for(b=f.map(function(m){return m.span}),g=this._computeSideColumnBookmarkTops(b,e,2,g,2),e=0;e<f.length;e++)b=
{},b[c]=g[e],b["z-index"]=d*f[e].bookmark.pageIndex,f[e].bookmarkItem.setPosition(b)}else{f=[];for(h=0;h<this.bookmarkList.count();h++)k=this.bookmarkList.item(h),l=this.bookmarkPool.getBookmarkItem(k),l.$parent==b&&f.push({bookmark:k,bookmarkItem:l,span:l.getSpanAlongBar()});if(f.length)for(b=f.map(function(m){return m.span}),g=this._computeSideColumnBookmarkTops(b,e,2,g,0),e=0;e<f.length;e++)b={},b[c]=g[e],b["z-index"]=d*f[e].bookmark.pageIndex,f[e].bookmarkItem.setPosition(b)}}},show:function(){this.visible=
!0;this.refresh()},hide:function(){this.hideLeftBar();this.hideRightBar();this.visible=!1},showLeftBar:function(){0<this.leftBar.children().length?this.leftBar.css("display","block"):this.leftBar.css("display","none")},hideLeftBar:function(){this.leftBar.css("display","none")},showRightBar:function(){0<this.rightBar.children().length?this.rightBar.css("display","block"):this.rightBar.css("display","none")},hideRightBar:function(){this.rightBar.css("display","none")},getHeight:function(){if(!this.visible||
!this.bookmarkList.count())return 0;var b,c;return(null==(b=this.leftBar)?void 0:b.height())||(null==(c=this.rightBar)?void 0:c.height())||0},refreshSideEdge:function(){isPad()||isPhone()||this.onSideEdge||!this.bookmarkList.count()||setBookVerticalMargin({disableResize:!0,bookmarkHeight:70})},doSetMovingScale:function(b,c,d,e,f,g,h){this.setScale(1,g,h)},setScale:function(b,c,d,e,f,g,h,k){void 0==c&&(c=1);void 0==d&&(d=0);void 0==g&&(g=1);void 0==h&&(h=0);this.onSideEdge?(f=this.$parent.height(),
bmtConfig.horizontalText?(c=transformCSS({scale:{x:1,y:c},tran:{x:d,y:0},origin:{x:50,y:0}}),g=transformCSS({scale:{x:1,y:g},tran:{x:h,y:0},origin:bookConfig.FlipDirection?{x:50,y:100}:{x:50,y:0}})):(c=transformCSS({scale:{x:c,y:1},tran:{x:d,y:(1-c)*f/2},rotate:-90}),g=transformCSS({scale:{x:g,y:1},tran:{x:h,y:(1-g)*f/2},rotate:90}))):(c=transformCSS({scale:{x:b,y:1},tran:{x:d,y:e},origin:{x:0,y:100}}),g=transformCSS({scale:{x:f,y:1},tran:{x:h,y:k},origin:{x:100,y:100}}));0<this.leftBar.children().length&&
...
v=0;v<canvasData[b].resources.length;v++)if(1!=canvasData[b].resources[v].type)q++,q>=canvasData[b].resources.length&&k();else{var r=new Image;r.src=getResource(b,v);r.alt="";globalImages[b][v]=r;r.onload=function(){q++;q>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(r){bookConfig.largePageWidth/bookConfig.largePageHeight>r[0].naturalWidth/r[0].naturalHeight?r.css({width:"auto",height:"100%"}):r.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)p=c[m],p=p.removeStartFrom("?"),q=$("<img alt='' style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),q.attr("src",p),k.append(q),q[0].onload=function(r){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},q[0].onerror=function(r){h++;h==c.length&&
e&&e(c,c,k,b)};v.jumpToEnd()})},noneLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){h=$("<div style='width:100%;height:100%;background:"+bookConfig.pageBackgroundColor+";'></div>");e&&e(c,c,h,b);return k.return()})},jsLoad=function(b,c,d,e,f,g){var h,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){h=function(q,v){return!q||passwardType()&&bookConfig.excludeFrontPages&&v>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),p.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),m=$("<img alt='' src='"+l+"'/>"),m[0].onload=function(){e&&e(l,c,this,b)},p.return();loadJavascript(c,function(q){var v=dataBase64Str(b,d,q);$("<img alt='' src='"+v+"'/>")[0].onload=function(){e&&e(v,c,this,b)}},
function(){});return p.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(!window.printLoadStack)return p.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;m=new PdfLoadingTask(b,d,k,l,function(q){var v=q.toDataURL("image/png"),r=$("<img alt='' src='"+v+"'/>");r[0].onload=function(){e&&e(v,v,r,b)}}.bind(h));window.printLoadStack.push(m);return p.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),p=b.getContext("2d",{willReadFrequently:!0}),q=p.getImageData(0,0,f,g),v=p.createImageData(c,d);q=q.data;for(var r=v.data,t=0;t<d;t++)for(var u=0;u<c;u++){for(var x=4*(u+t*c),z,A=0,F=0,D=0,L=0,M=0,I=0,G=(t+.5)*k,O=Math.ceil((t+1)*k),K=Math.floor(t*k);K<O;K++){var J=Math.abs(G-(K+.5))/m,Q=(u+.5)*h;J*=J;for(var U=Math.ceil((u+1)*h),T=Math.floor(u*h);T<U;T++)if(z=
Math.abs(Q-(T+.5))/l,z=Math.sqrt(J+z*z),!(1<=z)){z=2*z*z*z-3*z*z+1;var S=4*(T+K*f);I+=z*q[S+3];F+=z;255>q[S+3]&&(z=z*q[S+3]/250);D+=z*q[S];L+=z*q[S+1];M+=z*q[S+2];A+=z}}r[x]=D/A;r[x+1]=L/A;r[x+2]=M/A;r[x+3]=I/F}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(v,0,0)}
...
this.syncSideImageThumbBackgroundLayer();else try{this.canvasDom=document.createElement("canvas");this.canvasDom.setAttribute("id","pageCanvas");this.canvasDom.setAttribute("width",this.width);this.canvasDom.setAttribute("height",this.height);var b=this.canvasDom.getContext("2d");b.width=this.width;b.height=this.height;b.drawImage(this.$image[0],0,0);canvasReload(this.canvasDom,this.pageWidth,this.pageHeight,!0);this.syncSideImageThumbBackgroundLayer();this.callback&&this.callback(this.realImageURL,
this.realImageURL,this.canvasDom,this.index)}catch(c){this.width=this.$image[0].naturalWidth,this.height=this.$image[0].naturalHeight,this.callback&&this.callback(this.realImageURL,this.realImageURL,this.$image[0],this.index),this.onResize(this.pageWidth,this.pageHeight),this.syncSideImageThumbBackgroundLayer()}},shouldAddSideImageThumbBackgroundLayer:function(){if(this.isMirrorSide||!(this.width&&this.height&&this.pageWidth&&this.pageHeight)||PageInfo.pageIsStrech(this.index))return!1;var b=fitPageWidthHeight(this.pageWidth,
this.pageHeight,this.width,this.height),c=this.pageWidth-b.x;b=this.pageHeight-b.y;return(0!==c||0!==b)&&4>=c&&4>=b},syncSideImageThumbBackgroundLayer:function(){if(this.parent&&this.parent.length){var b="string"===typeof this.realImageURL?this.realImageURL:this.imageURL;if(!b||"string"===typeof b&&0===b.indexOf("none"))this.parent.children(".side-image-thumb-bg").remove();else if(this.shouldAddSideImageThumbBackgroundLayer()){var c=this.parent.children(".side-image-thumb-bg");c.length?c=c.first():
(c=$("<div class='side-image-thumb-bg' aria-hidden='true'/>"),this.parent.prepend(c));c.css({position:"absolute",left:0,top:0,width:"100%",height:"100%","z-index":"-1","pointer-events":"none","background-image":"url("+b+")","background-size":"cover","background-position":"center","background-repeat":"no-repeat"});this.parent.css({"background-image":"none"})}else this.parent.children(".side-image-thumb-bg").remove()}},enableRecognizeQRcode:function(){bookConfig.EnableRecognizeQRcodePressOnMobile&&
...
h.return();if(f.page)return f.loaded=!0,f.renderCanvas(f.pageWidth,f.pageHeight).then(function(k){this.callback&&this.callback(k);this.rendered=!0;d(k)}.bind(f)),h.return();f.loadingTask&&(f.loadingTask.destroy(),f.loadingTask=null);return h.yield(getPageDir(b,c,originTotalPageCount),2)}g=h.yieldResult;"object"==typeof g&&(g=g[0]);getBlob(g).then(function(k){this.loadingTask=pdfjsLib.getDocument({url:k.url,cMapUrl:window.cMapUrl,cMapPacked:!0,password:k.password});this.loadingTask.promise.then(function(l){l.getPage(1).then(function(m){this.loaded=
!0;this.page=m;this.renderCanvas(this.pageWidth,this.pageHeight).then(function(p){this.rendered=!0;this.callback&&this.callback(p);d(p)}.bind(this))}.bind(this))}.bind(this))}.bind(f));h.jumpToEnd()})}.bind(this))},renderCanvas:function(b,c){this.rendered=!1;return new Promise(function(d,e){this.renderWidth=b;this.renderHeight=c;this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);var f=$("<canvas><canvas/>")[0],g=f.getContext("2d"),h=window.devicePixelRatio||1,k=this.page,l=k.getViewport({scale:1});
l=fitPageWidthHeight(b,c,l.width,l.height).x/l.width;l=k.getViewport({scale:l});var m=l.width,p=l.height;isPC()||(m>p?3E3<m*h&&(h=3E3/m):3E3<p*h&&(h=3E3/p));f.width=m*h;f.height=p*h;1==h?(f.style.width=f.width+"px",f.style.height=f.height+"px"):(f.style.width=m+"px",f.style.height=p+"px");g={canvasContext:g,transform:1!==h?[h,0,0,h,0,0]:null,viewport:l};try{this.renderTask=k.render(g),this.renderTask.promise.then(function(){this.rendered=!0;d(f)}.bind(this))}catch(q){e(q)}}.bind(this))},remove:function(){},
...
this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),ImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));m.imageURL=
...
function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);bookConfig.textSharpening&&(q="-webkit-optimize-contrast",_agent_.browser.firefox&&(q="-moz-crisp-edges"),_agent_.browser.opera&&(q="-o-crisp-edges"),m.$image.css({"image-rendering":q,"-ms-interpolation-mode":"nearest-neighbor"}));v.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&
...
resetSlider:virtual_function}),BookRestrict=Class({statics:{unLimitPages:[],open:!1,isLoaded:!1,memoryStorage:{},isRestrictPage:function(b){if(!bookConfig.isEncryptionBook)return"none";if(this.open)return"open";var c=this.unLimitPages;return c&&c[b]?c[b]:"restrict"},setRestrictLoaded:function(b){this.isLoaded=b;BookEvent.trigger("onLoadBookRestrict",["onLoadBookRestrict",this.isLoaded])},getRestrictToken:function(){try{if(!bookConfig.isEncryptionBook||!window.bookId)return"";var b="restrictToken_"+
window.bookId;try{var c=window.localStorage.getItem(b);return c?c:""}catch(d){return this.memoryStorage[b]||""}}catch(d){return""}},setRestrictToken:function(b){try{if(!bookConfig.isEncryptionBook||!window.bookId)return"";var c="restrictToken_"+window.bookId;BookEvent.trigger("setRestrictToken",["setRestrictToken",b]);try{window.localStorage.setItem(c,b)}catch(d){this.memoryStorage[c]=b}}catch(d){}},fillBookContent:function(){this.open=!0;this.loading=!1;this.fillBooks("flipBook");this.fillBooks("singlePageBook");
this.fillBooks("catalogBook");this.fillBooks("slideBook");this.fillBooks("singleSlideBook");this.fillBooks("singleDocumentViewBook");this.fillBooks("cardBook");this.fillBooks("invertBook");BookEvent.trigger("fillBookRestrict",["fillBookRestrict",this.open])},fillBooks:function(b){if(b=global[b])b.loading(),b.fillBookContent()},setRestrictPages:function(b){try{for(var c=1;c<=bookConfig.totalPageCount;c++){a:{var d=c;try{for(var e=b.split(";"),f=0;f<e.length;f++){var g=e[f];if(0<=g.indexOf("-")){var h=
g.split("-");if(Number.isBetween(d,parseInt(h[0]),parseInt(h[1]))){var k=!1;break a}}else if(d==parseInt(g)){k=!1;break a}}}catch(l){}k=!0}k?BookRestrict.unLimitPages[c]="restrict":BookRestrict.unLimitPages[c]="open"}}catch(l){}}}}),WatermarkCore=function(b){this.canvas=b;this.ctx=b.getContext("2d",{willReadFrequently:!0});this.observer=null};
WatermarkCore.prototype.applyWatermark=function(b){this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);this.ctx.globalAlpha=b.opacity;WatermarkStrategyFactory.createStrategy(b.position).draw(this.ctx,b);this.currentConfig=b;this.enableProtection()};
...
2-c.width/2,b.canvas.height/2-c.height/2,c.rotation,c)):(e=function(k,l,m,p,q){q=void 0===q?!1:q;var v=h[m],r=Math.abs(l-k);if(!(0>=r)){p=p?v.width:v.height;l=0;if(r>=p)for(l=Math.floor((r+c.spacing)/(p+c.spacing));0<l&&!(l*p+(l-1)*c.spacing<=r);)l--;if(!(0>=l)){r=1<l?(r-l*p)/(l-1):0;for(var t=0;t<l;t++){var u=q?k-t*(p+r):k+t*(p+r),x=void 0,z=void 0;switch(m){case "top":x=u+(v.width-c.width)/2;z=(v.height-c.height)/2+f;break;case "right":x=b.canvas.width-(c.width+v.width)/2-f;z=u+(v.height-c.height)/
2;break;case "bottom":x=u+(v.width-c.width)/2;z=b.canvas.height-(c.height+v.height)/2-f;break;case "left":x=(v.width-c.width)/2+f,z=u+(v.height-c.height)/2}WatermarkStrategy.prototype.drawSingleWatermark.call(d,b,x,z,g[m],c,q)}}}},e(f,b.canvas.width-h.right.width-f,"top",!0,!1),e(f,b.canvas.height-h.bottom.height-f,"right",!1,!1),e(h.left.width,b.canvas.width-f,"bottom",!0,!1),e(h.top.height,b.canvas.height-f,"left",!1,!1))};var WatermarkStrategyFactory=function(){};
...
this.sideImage=this.side=void 0;this.hasReader&&this.destroySlider()},hasReader:function(){return window.readerConfig&&0<window.readerConfig.pages.length&&window.readerConfig.pages.length>=this.pageIndex&&(hasReaderPageItems(window.readerConfig.pages[this.pageIndex-1])||window.inverseEditor&&window.inverseEditor.length&&window.inverseEditor[this.pageIndex-1]&&window.inverseEditor[this.pageIndex-1].length)?!0:!1},loading:function(){if("restrict"!=BookRestrict.isRestrictPage(this.pageIndex)){if(this.originalImageLoaded)if(this.hasReader()){if(this.pageReaderLoaded)return}else return;
this.removeLoad||(this.loadingImage||(this.loadingImage=$("<div class='loadingOuter'><img alt='loadingOuter' width='auto' height='auto' class='loadingImage' src='"+bookConfig.pageLoadingUrl+"'/></div>")),this.sideContent.append(this.loadingImage))}},unLoading:function(b){this.hasReader()&&!b||!this.loadingImage||(this.loadingImage.css({display:"none"}),this.loadingImage.remove(),this.loadingImage=null)},restrict:function(){if(!this.restrictImage){this.restrictImage=$("<div class='loadingOuter'></div>");
...
isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),this.sideImage&&(this.clearSideImageContent(),this.sideImage.append(d)))},onOriginalImageLoaded:function(b,c,d){var e=this,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(!b)return l.return();e.originalImageLoaded=!0;e.hasReader()||e.unLoading(!0);e.unRestrict();if(e.sideImage&&("string"==typeof c&&!c.startsWith("none")||
"string"!=typeof c))if("string"==typeof c||"object"==typeof c&&0<=c[0].indexOf(".zip"))isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),e.clearSideImageContent(),e.sideImage.append(d);else for(e.clearSideImageContent(),f=0;f<d.length;f++)isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),
e.sideImage.append(d[f]);g=fitPageWidthHeight(e.pageWidth,e.pageHeight,e.imageWidth,e.imageHeight);!bookConfig.isSingleBookFullWindowOnMobile||1!=e.bookType||!isPhone()&&!isPad()||e.imageWidth||e.imageHeight||(g=fitPageWidthHeight(e.pageWidth,e.pageHeight,bookConfig.largePageWidth,bookConfig.largePageHeight),h=bookConfig.largePageWidth/bookConfig.largePageHeight,k=e.pageWidth/e.pageHeight,.01>h-k&&-.01<h-k&&(g.x=e.pageWidth,g.y=e.pageHeight),e.imageWidth=g.x,e.imageHeight=g.y);e.pageAttachments||
...
0<global.readerConfig.pages.length&&hasReaderPageItems(window.readerConfig.pages[this.pageIndex-1])?!0:!1};PageAttachmentsParser.prototype.isHiddenEditor=function(){return!bookConfig.isPreview||bookConfig.previewPages&&-1!==(Array.isArray(bookConfig.previewPages)&&bookConfig.previewPages.indexOf(this.pageIndex))?!1:!0};
...
init:function(){isIE()||!shouldShowMiniFullscreen()||!isPhone()&&!isPad()&&MiniStyle.isMini()||fullScreenApi.supportsFullScreen&&fullScreenApi.isFullScreen()||this.miniFullScreen||(this.miniFullScreen=$("<div class='miniFullscreen' id='miniFullscreen'></div>"),this.miniFullScreen.html(getLanguage("lblFullscreen","Click to view in fullscreen.")),this.onResize(),bookContainer.append(this.miniFullScreen),this.miniFullscreenEnter=!1,bookConfig.alwaysShowBottomFullscreenPrompt||(this.miniFullscreenTimeout&&
window.clearTimeout(this.miniFullscreenTimeout),this.miniFullscreenTimeout=window.setTimeout(function(){this.removeMiniFullScreen()}.bind(this),1E3*bookConfig.bottomFullscreenPromptDisplayDuration)),this.initMiniFullScreenEvent())},initMiniFullScreenEvent:function(){this.miniFullScreen.on(_event._end,function(){bookType==BookType.catalog_book&&global.catalogBook&&catalogBook.guidBar&&catalogBook.guidBar.fullscreenBtn?catalogBook.guidBar.fullscreenBtn.trigger(_event._end):readAsFullscreen();this.miniFullScreen.remove();
this.miniFullScreen=void 0;BookEvent.trigger("customEvent",["click_fullscreen_prompt"])}.bind(this));this.miniFullScreen.on(_event._enter,function(){this.miniFullscreenEnter=!0}.bind(this));this.miniFullScreen.on(_event._leave,function(){this.miniFullscreenEnter=!1;bookConfig.alwaysShowBottomFullscreenPrompt||(this.miniFullscreenTimeout&&window.clearTimeout(this.miniFullscreenTimeout),this.miniFullscreenTimeout=window.setTimeout(function(){this.removeMiniFullScreen()}.bind(this),1E3*bookConfig.bottomFullscreenPromptDisplayDuration))}.bind(this))},
removeMiniFullScreen:function(){if(this.miniFullScreen&&!this.miniFullscreenEnter){var b={alpha:1};$(b).animate({alpha:0},{duration:300,easing:"easeOutSine",step:function(){this.miniFullScreen&&this.miniFullScreen.css({opacity:b.alpha})}.bind(this),complete:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen&&(this.miniFullScreen=void 0)}.bind(this)})}},onResize:function(){if(this.miniFullScreen)if(!MiniStyle.isMini()||isPhone()||isPad()){var b=BookInfo.top();this.miniFullScreen.css({top:b+
BookInfo.height()-80+"px"})}else this.miniFullScreen.remove(),this.miniFullScreen=void 0},show:function(){this.miniFullScreen&&this.miniFullScreen.show()},hide:function(){this.miniFullScreen&&this.miniFullScreen.hide()},remove:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen=void 0},setStyle:function(b){b&&this.miniFullScreen&&this.miniFullScreen.css(b)}}),BookPageNumberForFlip=Class({create:function(){},init:function(){if(bookConfig.updatePageNumberForFlip){var b=
-1==BookInfo.getCurrentPageIndex()?1:BookInfo.getCurrentPageIndex();this.miniFullScreen?this.miniFullScreen.html(getShownPageNumberInfo(b)):(this.miniFullScreen=$("<div class='miniFullscreen' id='pageNumberForFlip'></div>"),this.miniFullScreen.html(getShownPageNumberInfo(b)),this.onResize(),bookContainer.append(this.miniFullScreen),this.miniFullscreenEnter=!1,this.miniFullscreenTimeout&&window.clearTimeout(this.miniFullscreenTimeout),this.miniFullscreenTimeout=window.setTimeout(function(){this.removeMiniFullScreen()}.bind(this),
3E3),this.initMiniFullScreenEvent())}},initMiniFullScreenEvent:function(){},removeMiniFullScreen:function(){if(this.miniFullScreen&&!this.miniFullscreenEnter){var b={alpha:1};$(b).animate({alpha:0},{duration:300,easing:"easeOutSine",step:function(){this.miniFullScreen&&this.miniFullScreen.css({opacity:b.alpha})}.bind(this),complete:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen&&(this.miniFullScreen=void 0)}.bind(this)})}},onResize:function(){if(this.miniFullScreen)if(MiniStyle.isMini())this.miniFullScreen.remove(),
this.miniFullScreen=void 0;else{var b=BookInfo.top();this.miniFullScreen.css({top:b+BookInfo.height()-40+"px"})}},show:function(){this.miniFullScreen&&this.miniFullScreen.show()},hide:function(){this.miniFullScreen&&this.miniFullScreen.hide()},remove:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen=void 0},setStyle:function(b){b&&this.miniFullScreen&&this.miniFullScreen.css(b)}}),BookAttachmentsFactory=Class({create:function(b,c,d,e){this.isDoublePage=e;this.container=
b;this.book=d;this.pageIndex=c},createAttachment:function(b,c){switch(b){case "thickness":var d=c?new ThicknessManager(this.container,this.book):new SingleBookThicknessManager(this.container,this.book);d.refreshThickness();break;case "bookshadow":d=new BookShadow(this.container);break;case "zoomhint":d=new ZoomHint(this.parent);break;case "minifullscreen":d=new BookMiniFullscreen;0<=BookInfo.getCurrentPages().indexOf(1)&&d.init();break;case "bookpagenumber":d=new BookPageNumberForFlip;break;case "staticad":d=
new StaticAd(this.container);break;case "zoommap":d=new ZoomMap(this.book);d.fillContent(this.pageIndex);break;case "bookmarktab":d=new BookmarkTab(this.container,!this.isDoublePage);break;case "noteadd":d=new NoteAdd(this.container)}return d}}),BookAttachmentsBuilder=Class({Package:"BookAttachment",create:function(b,c,d,e){this.parent=b;this.pageIndex=c;this.book=d;this.isDoublePage=e;this.Items=this.createAttachmentsForBook()},createAttachmentsForBook:function(){var b=new ObjectPool;this.factory=
new BookAttachmentsFactory(this.parent,this.pageIndex,this.book,this.isDoublePage);return b},thickness:function(b){this.bookThickness=this.factory.createAttachment("thickness",b);this.Items.add(this.bookThickness)},bookshadow:function(){this.bookShadow=this.factory.createAttachment("bookshadow");this.Items.add(this.bookShadow)},grayshadow:function(){_agent_.browser.msie||_agent_.browser.safari||!bookConfig.ShowTopLeftShadow||this.book.bookType!=BookType.normal_book||(this.grayshadow=this.factory.createAttachment("grayshadow"),
this.Items.add(this.grayshadow))},miniFullscreen:function(){this.miniFullscreen=this.factory.createAttachment("minifullscreen");this.Items.add(this.miniFullscreen)},bookpagenumber:function(){this.bookPageNumber=this.factory.createAttachment("bookpagenumber");this.bookPageNumber.init();this.Items.add(this.bookPageNumber)},staticad:function(){void 0!=global.staticAd&&1==staticAd.haveAd&&(this.staticAd=this.factory.createAttachment("staticad"),this.Items.add(this.staticAd))},zoommap:function(){isPad()||
isPhone()||!bookConfig.ZoomMapVisible||(this.zoomMap=this.factory.createAttachment("zoommap"),this.Items.add(this.zoomMap))},bookmarktab:function(){(function(){isPhone()||isPad()||(this.bookMarkTab=this.factory.createAttachment("bookmarktab"),this.Items.add(this.bookMarkTab))}).delay(this,1)},noteadd:function(){!bookConfig.AnnotationButtonVisible||isPhone()||isPad()||(this.noteAdd=this.factory.createAttachment("noteadd"),this.Items.add(this.noteAdd))},zoomhint:function(){isTouchDevice()},hide:function(){this.Items.find("StaticAd").each(function(b){b.hide()});
this.Items.find("ZoomMap").each(function(b){b.hide()});this.Items.find("BookMiniFullscreen").each(function(b){b.hide()});this.Items.find("BookPageNumberForFlip").each(function(b){b.hide()})},show:function(){this.Items.find("BookMiniFullscreen").each(function(b){b.show()});this.Items.find("BookPageNumberForFlip").each(function(b){b.show()});this.Items.find("BookmarkTab").each(function(b){b.refresh()});this.Items.find("StaticAd").each(function(b){b.show()});this.book.flipping||1!=this.book.currentPageIndex||
...
BookInfo.getBook();if(c.status_zoom&&!this.flipBook.parameters.zoomming&&c.controlBar&&c.controlBar.moveByMousePosition&&!c.controlBar._sliderDragging&&!this.flipBook.parameters.blockUiPan){c=this.flipBook;var d=c.width(),e=c.height(),f=b.pageX;b=b.pageY;d=f-f*d/windowWidth;e=b-b*e/windowHeight;b={};b.origin=c.parameters.origin;b.scale=c.parameters.scale;d-=c.parameters.left;e-=c.parameters.top;b.tran={x:d,y:e};e=transformCSS(b);c.css(e);this.bookAttachments&&this.bookAttachments.zoomMap&&this.bookAttachments.zoomMap.refreshArea()}}.bind(this))}});
...
getSpace:function(b){var c=bookConfig.leftMargin+templateArea.getLeftWidth(),d=bookConfig.rightMargin+templateArea.getRightWidth(),e=bookConfig.topMargin+templateArea.getTopHeight(),f=bookConfig.bottomMargin+templateArea.getBottomHeight();b&&(c+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),d+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);b=getSideBookmarkColumnSpace(!0);c+=b.left;d+=b.right;return{left:c,right:d,
top:e,bottom:f}},getMinPageIndex:function(b){return b=bookConfig.isTheBookOpen?2*Math.ceil(b/2)-1:2*Math.floor(b/2)},getMaxPageIndex:function(b){return b=bookConfig.isTheBookOpen?2*Math.ceil(b/2):2*Math.floor(b/2)+1}}).extend(FlipBook),SingleFlipBook=Class({pageBackArray:null,create:function(b){this.pageBackArray=[];this._super(b)},newFlipPage:function(){return new SingleFlipPage(this)},resetPages:function(b){isNaN(b)||0>=b||(this.unWrapPageBackExcludeArray([b,b+1]),this.unWrapPageExcludeArray([b,
b+1]),this.addPageArray([b,b+1]),this.addPageBackArray([b]),this.currentPage=this.pageArray[b],this.currentPage2=this.pageBackArray[b],this.nextPage=this.pageArray[b+1],this.previousPage=this.pageArray[b-1],this.previousPage2=this.pageBackArray[b-1],this.setPageCss(),this.loading())},setPageCss:function(){var b=transformCSS({rotate:0,tran:{x:0,y:0}});this.currentPage&&(this.setZIndexByPageIndex(this.currentPage),this.currentPage.setCSSByStyle(b));this.previousPage&&(this.setZIndexByPageIndex(this.previousPage),
this.previousPage.setCSSByStyle(b));this.previousPage2&&(this.setZIndexByPageIndex(this.previousPage2),this.previousPage2.setCSSByStyle(b));this.currentPage2&&(this.setZIndexByPageIndex(this.currentPage2),this.currentPage2.setCSSByStyle(b));this.nextPage&&(this.setZIndexByPageIndex(this.nextPage),this.nextPage.setCSSByStyle(b));rightToLeft?(this.currentPage&&this.currentPage.setLeftOrRight(!0),this.previousPage&&this.previousPage.setLeftOrRight(!0),this.previousPage2&&this.previousPage2.setLeftOrRight(!0),
this.currentPage2&&this.currentPage2.setLeftOrRight(!0),this.nextPage&&this.nextPage.setLeftOrRight(!0)):(this.currentPage&&this.currentPage.setLeftOrRight(!1),this.previousPage&&this.previousPage.setLeftOrRight(!1),this.previousPage2&&this.previousPage2.setLeftOrRight(!1),this.currentPage2&&this.currentPage2.setLeftOrRight(!1),this.nextPage&&this.nextPage.setLeftOrRight(!1))},addPageBackArray:function(b){if(b&&this.pageBackArray)for(var c=0;c<b.length;c++)if(!(0>=b[c]||b[c]>originTotalPageCount||
(!this.pageBackArray[b[c]]||this.flipping&&!imageLoaded[b[c]]||this.fillContent(b[c],!0),this.pageBackArray[b[c]]))){var d=this.newPageBack(b[c]),e=this.pageInfoArray[b[c]];d.mirrorSide();d.onResize(this.pageWidth*e.pageWidth,this.pageHeight*e.pageHeight,e.opacity);this.pageBackArray[b[c]]=d;this.flipping&&!imageLoaded[b[c]]||this.fillContent(b[c],!0);this.flipBook.append(d.$page)}},getDownUpPage:function(b,c){var d=b;b>c&&(d=c);this.addPageArray([d]);this.addPageBackArray([d]);this.pageArray[d]&&
this.pageArray[d].beginToFlip();this.pageBackArray[d]&&this.pageBackArray[d].beginToFlip();this.pageArray[d]&&this.pageArray[d].page.setCSSByName("right-flip-side");this.pageBackArray[d]&&(this.pageBackArray[d].page.setCSSByName("flip-side"),this.pageBackArray[d].page.side.addClass("boxShadow"));return[this.pageArray[d],this.pageBackArray[d]]},getDownUpHardPage:function(b,c){var d=b;b>c&&(d=c);this.addPageArray([d]);this.addPageBackArray([d]);rightToLeft?(this.pageArray[d]&&this.pageArray[d].setCSSByName("flip-hard-left-side"),
...
totalThicknessWidth(!1),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);b=getSideBookmarkColumnSpace(!1);c+=b.left;d+=b.right;return{left:c,right:d,top:e,bottom:f}},getTranX:function(b){if(!bookConfig.retainBookCenter)return 0;b=this.getCssLeft();var c=this.getSpace(!0);return c.left+(windowWidth-c.left-c.right-this.width)/2-b},getTranY:function(){var b=this.getCssTop(),c=this.getSpace(!0);return c.top+(windowHeight-c.top-c.bottom-this.pageWidthHeight.y)/2-b}}).extend(FlipBook),
...
Tooltip=Class({create:function(b){this.options=$.extend({target:null,content:"",placement:"bottom",trigger:"hover",showArrow:!0,delay:0,hideDelay:0,disabled:!1,zIndex:10001,wrapContent:!1,contentMaxWidth:null,boundary:null,boundaryPadding:0},b);this.visible=!1;this.timer=null;this.target=this.options.target;this.tooltip=null;this.init()},init:function(){this.createTooltip();this.bindEvents()},createTooltip:function(){this.tooltip=$('<div class="tooltip-container"></div>');this.tooltip.css({position:"absolute",
zIndex:this.options.zIndex,display:"none",pointerEvents:"none"});var b=$('<div class="tooltip-content"></div>');b.html(this.options.content);b.css({background:"rgba(0, 0, 0, 0.8)",color:"#fff",padding:"10px",borderRadius:"4px",fontSize:"14px",lineHeight:"1.4",maxWidth:null!=this.options.contentMaxWidth?this.options.contentMaxWidth:this.options.wrapContent?"280px":"200px",wordWrap:"break-word",whiteSpace:this.options.wrapContent?"normal":"nowrap"});this.tooltip.append(b);this.options.showArrow&&(b=
$('<div class="tooltip-arrow"></div>'),b.css({position:"absolute",width:"0",height:"0",border:"4px solid transparent"}),this.tooltip.append(b));$("body").append(this.tooltip)},bindEvents:function(){var b=this;"hover"===this.options.trigger?(this.target.on("mouseenter",function(){b.options.disabled||(clearTimeout(b.timer),b.timer=setTimeout(function(){b.show()},b.options.delay))}),this.target.on("mouseleave",function(){clearTimeout(b.timer);b.timer=setTimeout(function(){b.hide()},b.options.hideDelay)})):
"click"===this.options.trigger&&(this.target.on("click",function(c){c.preventDefault();b.options.disabled||(b.visible?b.hide():b.show())}),b._documentClickHandler=function(c){$(c.target).closest(b.target).length||$(c.target).closest(b.tooltip).length||b.hide()},$(document).on("click",b._documentClickHandler))},show:function(){this.visible||this.options.disabled||(this.visible=!0,this.tooltip.show(),this.updatePosition())},hide:function(){this.visible&&(this.visible=!1,this.tooltip.hide())},getBoundaryRect:function(){var b=
"number"===typeof this.options.boundaryPadding?this.options.boundaryPadding:0;if(this.options.boundary&&$(this.options.boundary).length){var c=$(this.options.boundary),d=c.offset(),e=c.outerWidth();c=c.outerHeight();b={left:d.left+b,top:d.top+b,right:d.left+e-b,bottom:d.top+c-b}}else d=$(window),e=d.scrollLeft(),c=d.scrollTop(),b={left:e+b,top:c+b,right:e+d.width()-b,bottom:c+d.height()-b};b.right<b.left&&(b.right=b.left);b.bottom<b.top&&(b.bottom=b.top);return b},_rectFullyInside:function(b,c,d,
e,f){return b>=f.left&&c>=f.top&&b+d<=f.right&&c+e<=f.bottom},_intersectionArea:function(b,c,d,e,f){var g=Math.max(b,f.left),h=Math.max(c,f.top);b=Math.min(b+d,f.right);c=Math.min(c+e,f.bottom);return b<=g||c<=h?0:(b-g)*(c-h)},_clampTooltipPosition:function(b,c,d,e,f){var g=f.bottom-f.top;d<=f.right-f.left?b<f.left?b=f.left:b+d>f.right&&(b=f.right-d):b=f.left;e<=g?c<f.top?c=f.top:c+e>f.bottom&&(c=f.bottom-e):c=f.top;return{left:b,top:c}},_computePositionForPlacement:function(b,c,d,e,f,g,h){var k=
{top:0,left:0};switch(b){case "top":k.top=c.top-g-h;k.left=c.left+(d-f)/2;break;case "bottom":k.top=c.top+e+h;k.left=c.left+(d-f)/2;break;case "left":k.top=c.top+(e-g)/2;k.left=c.left-f-h;break;case "right":k.top=c.top+(e-g)/2;k.left=c.left+d+h;break;default:k.top=c.top+e+h,k.left=c.left+(d-f)/2}return k},updatePosition:function(){function b(t){return m._computePositionForPlacement(t,c,d,e,f,g,h)}if(this.target&&this.tooltip){var c=this.target.offset(),d=this.target.outerWidth(),e=this.target.outerHeight(),
f=this.tooltip.outerWidth(),g=this.tooltip.outerHeight(),h=this.options.showArrow?8:0,k=this.getBoundaryRect(),l=this.options.placement,m=this,p=l;if("top"===l||"bottom"===l){p="top"===l?"bottom":"top";var q=b(l),v=b(p);if(m._rectFullyInside(q.left,q.top,f,g,k))p=l,l=q;else if(m._rectFullyInside(v.left,v.top,f,g,k))l=v;else{var r=m._intersectionArea(q.left,q.top,f,g,k);m._intersectionArea(v.left,v.top,f,g,k)>r?l=v:(p=l,l=q)}}else"left"===l||"right"===l?(p="left"===l?"right":"left",q=b(l),v=b(p),m._rectFullyInside(q.left,
q.top,f,g,k)?(p=l,l=q):m._rectFullyInside(v.left,v.top,f,g,k)?l=v:(r=m._intersectionArea(q.left,q.top,f,g,k),m._intersectionArea(v.left,v.top,f,g,k)>r?l=v:(p=l,l=q))):(l=b("bottom"),p="bottom");k=m._clampTooltipPosition(l.left,l.top,f,g,k);this._effectivePlacement=p;this.tooltip.css({top:k.top+"px",left:k.left+"px"});this.updateArrow(k)}},updateArrow:function(b){if(this.options.showArrow){b=this.tooltip.find(".tooltip-arrow");var c=null!=this._effectivePlacement?this._effectivePlacement:this.options.placement;
b.css({position:"absolute",width:"0",height:"0",border:"4px solid transparent"});switch(c){case "top":b.css({top:"100%",left:"50%",marginLeft:"-4px",borderTopColor:"rgba(0, 0, 0, 0.8)",borderBottom:"none"});break;case "bottom":b.css({bottom:"100%",left:"50%",marginLeft:"-4px",borderBottomColor:"rgba(0, 0, 0, 0.8)",borderTop:"none"});break;case "left":b.css({top:"50%",left:"100%",marginTop:"-4px",borderLeftColor:"rgba(0, 0, 0, 0.8)",borderRight:"none"});break;case "right":b.css({top:"50%",right:"100%",
marginTop:"-4px",borderRightColor:"rgba(0, 0, 0, 0.8)",borderLeft:"none"})}}},setContent:function(b){this.options.content=b;var c=this.tooltip.find(".tooltip-content");c.html(b);c.css({maxWidth:null!=this.options.contentMaxWidth?this.options.contentMaxWidth:this.options.wrapContent?"280px":"200px",whiteSpace:this.options.wrapContent?"normal":"nowrap"})},setTarget:function(b){this.target=$(b);this.bindEvents()},destroy:function(){this._documentClickHandler&&($(document).off("click",this._documentClickHandler),
this._documentClickHandler=null);this.tooltip&&this.tooltip.remove();this.timer&&clearTimeout(this.timer)}});global.createTooltip=function(b){return new Tooltip(b)};bdor[500]=global.bdor[404];bdor[13]="p";
var ZOOM_STEPS=[1,1.5,2,2.5,3,4,5,6,8,10],ZOOM_SHORTCUT_TIP_KEY="flipbook_zoom_shortcut_tip_shown",ZOOM_EMPHASIZE_MS=5E3,ZOOM_TIP_MS=3E3,ZOOM_BUBBLE_HIDE_MS=3E3,ZoomControlBar=Class({create:function(b){this.moveByMousePosition=!1;this.moveByPositionUrl=this.getImageUrl("moveByPos");this.moveByDragUrl=this.getImageUrl("moveByDrag");this.desiredFactor=null;this._sliderDragging=!1;this._btnTooltips=this._bubbleHideTimer=this._tipTimer=this._tipEl=this._syncTimer=this._emphasizeTimer=null;this._onUserActionBound=
this.onUserActionForTip.bind(this);this._onFlipBound=this.onFlipWhileZoomed.bind(this);this.initButtons();this.initSlider();this.initBar(b);this.initEvent();this.setA11y();this.applyButtonTooltips();this.syncSliderFromPage()},initButtons:function(){this.btnZoomDown=$("<button type='button' class='button zoom-control-btn'><img alt='' src='"+this.getImageUrl("ZD")+"'/></button>");this.btnZoomUp=$("<button type='button' class='button zoom-control-btn'><img alt='' src='"+this.getImageUrl("ZU")+"'/></button>");
this.btnZoomOut=$("<button type='button' class='button zoom-control-btn'><img alt='' src='"+this.getImageUrl("ZO")+"'/></button>");this.btnPre=$("<button type='button' class='button zoom-control-btn'><img alt='' src='"+this.getImageUrl("PR")+"'/></button>");this.btnNext=$("<button type='button' class='button zoom-control-btn'><img alt='' src='"+this.getImageUrl("NE")+"'/></button>");this.btnMoveMode=$("<button type='button' class='button zoom-control-btn'><img alt='' src='"+this.moveByPositionUrl+
"'/></button>");this.btnClose=$("<button type='button' class='button zoom-control-btn'><img alt='' src='"+this.getImageUrl("zoom_close")+"'/></button>")},canUseCustomTooltip:function(){return"function"!==typeof global.createTooltip||"function"===typeof isPhone&&isPhone()||"function"===typeof isPad&&isPad()||"function"===typeof isPadDesktopMode&&isPadDesktopMode()?!1:!0},setButtonTooltip:function(b,c,d,e){b&&b.length&&(d=getLanguage(d,e),b.attr("aria-label",d).removeAttr("title"),this.canUseCustomTooltip()&&
(this._btnTooltips=this._btnTooltips||{},(e=this._btnTooltips[c])&&e.setContent?e.setContent(d):this._btnTooltips[c]=global.createTooltip({target:b,content:d,placement:"bottom",zIndex:10060})))},applyButtonTooltips:function(){this.setButtonTooltip(this.btnZoomDown,"zoomOut","btnZoomOut","Zoom Out");this.setButtonTooltip(this.btnZoomUp,"zoomIn","btnZoomIn","Zoom In");this.setButtonTooltip(this.btnZoomOut,"resetView","lblZoomBarResetView","Reset View");this.setButtonTooltip(this.btnPre,"prePage","btnPrePage",
"Previous Page");this.setButtonTooltip(this.btnNext,"nextPage","btnNextPage","Next Page");this.applyMoveModeTooltip();this.setButtonTooltip(this.btnClose,"exit","lblZoomBarExit","Exit")},applyMoveModeTooltip:function(){this.moveByMousePosition?this.setButtonTooltip(this.btnMoveMode,"moveMode","lblZoomBarExitLensMode","Exit Lens Mode"):this.setButtonTooltip(this.btnMoveMode,"moveMode","lblZoomBarLensMode","Lens Mode")},destroyButtonTooltips:function(){if(this._btnTooltips){for(var b in this._btnTooltips)if(Object.prototype.hasOwnProperty.call(this._btnTooltips,
b)){var c=this._btnTooltips[b];c&&c.destroy&&c.destroy()}this._btnTooltips=null}},initSlider:function(){this.sliderTrack=$("<div class='zoom-slider-track' role='slider' aria-valuemin='1' aria-valuemax='10' tabindex='0'></div>");this.sliderFill=$("<div class='zoom-slider-fill'></div>");this.sliderThumb=$("<div class='zoom-slider-thumb'></div>");this.sliderBubble=$("<div class='zoom-slider-bubble'><span class='zoom-slider-bubble-text'>1x</span><i class='zoom-slider-bubble-arrow'></i></div>");this.sliderBubbleText=
this.sliderBubble.find(".zoom-slider-bubble-text");$(document.body).append(this.sliderBubble);this.sliderTrack.append(this.sliderFill);this.sliderTrack.append(this.sliderThumb);this.sliderGroup=$("<div class='zoom-slider-group'></div>");this.sliderGroup.append(this.btnZoomDown);this.sliderGroup.append(this.sliderTrack);this.sliderGroup.append(this.btnZoomUp)},initBar:function(b){this.height=40;this.bar=$("<div class='zoomControlBar'></div>");this.bar.append(this.sliderGroup);this.bar.append(this.btnZoomOut);
this.bar.append(this.btnPre);this.bar.append(this.btnNext);this.bar.append(this.btnMoveMode);this.bar.append(this.btnClose);this.bar.css({"background-color":bookConfig.toolbarColor});bookConfig.FlipStyle&&"slide"==bookConfig.FlipStyle.toLowerCase()&&this.btnMoveMode.css({display:"none"});b.append(this.bar);this.width=this.bar.outerWidth()||this.bar.width()||320},getImageUrl:function(b){return window.zoom_icons&&zoom_icons[b]?"data:image/png;base64,"+zoom_icons[b]:uiBaseURL+b+".png"},getZoomPage:function(){var b=
BookInfo.getBook();return b?bookType===BookType.documentView_book||bookType===BookType.singleDocumentView_book?b.docViewBook:b.showPage:null},getEffectiveFactor:function(b){b=b||this.getZoomPage();if(!b||!b.parameters)return 1;var c=b.parameters;b=parseFloat(null!=c.toScale?c.toScale:c.scale);isNaN(b)&&(b=1);var d=parseFloat(c.naturalHeight)||parseFloat(c.naturalWidth)||1;return(c=parseFloat(c.height)||parseFloat(c.width)||d)?c*b/d:1},getScaleBounds:function(b){b=b||this.getZoomPage();if(!b||!b.parameters)return{minScale:1,
maxScale:1,maxFactor:1,minFactor:1};var c=b.parameters,d=parseFloat(c.height)||1;c=parseFloat(c.naturalHeight)||d;return{minScale:c/d,maxScale:c*b.maxScale/d,maxFactor:b.maxScale||ZOOM_STEPS[ZOOM_STEPS.length-1],minFactor:1}},factorToScale:function(b,c){b=b||this.getZoomPage();if(!b||!b.parameters)return 1;var d=b.parameters,e=parseFloat(d.naturalHeight)||parseFloat(d.naturalWidth)||1;d=parseFloat(d.height)||parseFloat(d.width)||e;b=this.getScaleBounds(b);return Math.max(b.minScale,Math.min(b.maxScale,
c*e/d))},nearestStep:function(b){var c=this.reachableSteps();b=parseFloat(b);isNaN(b)&&(b=c[0]);b=Math.max(c[0],Math.min(c[c.length-1],b));for(var d=c[0],e=Math.abs(b-d),f=1;f<c.length;f++){var g=Math.abs(b-c[f]);g<e&&(e=g,d=c[f])}return d},getCurrentStepIndex:function(b){var c=this.reachableSteps();b=null!=this.desiredFactor?this.desiredFactor:this.getEffectiveFactor(b);b=this.nearestStep(b);for(var d=0;d<c.length;d++)if(1E-6>Math.abs(c[d]-b))return d;return 0},stepListIndex:function(b){return this.getCurrentStepIndex()},
resolveStepReference:function(b){return this.nearestStep(null!=this.desiredFactor?this.desiredFactor:this.getEffectiveFactor(b))},reachableSteps:function(){var b=this.getScaleBounds();b=Math.min(b.maxFactor,ZOOM_STEPS[ZOOM_STEPS.length-1]);for(var c=[],d=0;d<ZOOM_STEPS.length;d++)ZOOM_STEPS[d]<=b+1E-6&&c.push(ZOOM_STEPS[d]);0===c.length&&c.push(1);return c},interruptZoomAnimation:function(b){if((b=b||this.getZoomPage())&&b.parameters&&b.parameters.zoomming){b.parameters.zoomming=!1;try{b.off("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd")}catch(c){}if("function"===
typeof setAnimation)try{setAnimation(b,0)}catch(c){}null!=b.parameters.scale&&(b.parameters.toScale=b.parameters.scale)}},factorFromSliderRatio:function(b){var c=this.reachableSteps();b=Math.max(0,Math.min(1,b));if(1===c.length)return c[0];var d=b*(c.length-1);b=Math.floor(d);d-=b;return c[b]*(1-d)+c[Math.min(c.length-1,b+1)]*d},sliderRatioFromFactor:function(b){var c=this.reachableSteps();if(1===c.length)return 0;b=Math.max(c[0],Math.min(c[c.length-1],b));for(var d=0;d<c.length-1;d++)if(b>=c[d]-
1E-6&&b<=c[d+1]+1E-6)return(d+(b-c[d])/(c[d+1]-c[d]))/(c.length-1);return b>=c[c.length-1]?1:0},formatFactorLabel:function(b){b=this.nearestStep(b);b=Math.round(10*b)/10;return 1E-6>Math.abs(b-Math.round(b))?Math.round(b)+"x":b+"x"},updateSliderUi:function(b){if(this.sliderTrack){null==b&&(b=null!=this.desiredFactor?this.desiredFactor:this.getEffectiveFactor());var c=100*this.sliderRatioFromFactor(b);this.sliderFill.css({width:c+"%"});this.sliderThumb.css({left:c+"%"});this.sliderBubbleText&&this.sliderBubbleText.text(this.formatFactorLabel(b));
this.sliderTrack.attr("aria-valuenow",String(this.nearestStep(b)));this._bubbleVisible&&this.positionSliderBubble()}},positionSliderBubble:function(){if(this.sliderBubble&&this.sliderThumb&&this.sliderThumb[0]){var b=this.sliderThumb[0].getBoundingClientRect(),c=b.left+b.width/2,d=this.sliderBubble.outerHeight()||36;8<=b.top-8-d?(this.sliderBubble.removeClass("is-below"),this.sliderBubble.css({left:c+"px",top:b.top-8+"px"})):(this.sliderBubble.addClass("is-below"),this.sliderBubble.css({left:c+"px",
top:b.bottom+8+"px"}))}},clearBubbleHideTimer:function(){this._bubbleHideTimer&&(window.clearTimeout(this._bubbleHideTimer),this._bubbleHideTimer=null)},showSliderBubble:function(b){this.sliderBubble&&(b=b||{},this._bubbleVisible=!0,this.positionSliderBubble(),this.sliderBubble.addClass("is-visible"),b.hold||this._sliderDragging?this.clearBubbleHideTimer():this.scheduleHideSliderBubble(ZOOM_BUBBLE_HIDE_MS))},scheduleHideSliderBubble:function(b){var c=this;this.clearBubbleHideTimer();this._bubbleHideTimer=
window.setTimeout(function(){c._bubbleHideTimer=null;c.hideSliderBubble(!0)},null==b?ZOOM_BUBBLE_HIDE_MS:b)},hideSliderBubble:function(b){!this.sliderBubble||this._sliderDragging&&!b||(this.clearBubbleHideTimer(),this._bubbleVisible=!1,this.sliderBubble.removeClass("is-visible"))},pulseSliderBubble:function(){this.updateSliderUi(null!=this.desiredFactor?this.desiredFactor:this.getEffectiveFactor());this.showSliderBubble()},stopSliderEvent:function(b){b&&("function"===typeof stopEvent?stopEvent(b):
(b.preventDefault&&b.preventDefault(),b.stopPropagation&&b.stopPropagation()),b.stopImmediatePropagation&&b.stopImmediatePropagation(),b.originalEvent&&(b.originalEvent.preventDefault&&b.originalEvent.preventDefault(),b.originalEvent.stopPropagation&&b.originalEvent.stopPropagation()))},getEnterZoomSeedFactor:function(){var b=this.getZoomPage();return b&&null!=b.middleScale&&!isNaN(b.middleScale)&&1<b.middleScale?b.middleScale:"undefined"!==typeof bookConfig&&bookConfig.defaultZoomScale?Math.max(bookConfig.defaultZoomScale,
1.5):2},applyEnterZoomFactor:function(){var b=this.nearestStep(this.getEnterZoomSeedFactor());this._enterZoomTarget=this.desiredFactor=b;this.updateSliderUi(b)},clearEnterZoomLock:function(){this._enterZoomTarget=null;this._enterLockTimer&&(window.clearTimeout(this._enterLockTimer),this._enterLockTimer=null)},showEnterZoomBubble:function(){this.applyEnterZoomFactor();this.showSliderBubble()},syncSliderFromPage:function(b){b=b||{};if(!this._sliderDragging){var c=this.getEffectiveFactor();null!=this._enterZoomTarget?
(this.desiredFactor=this._enterZoomTarget,this.updateSliderUi(this.desiredFactor),.35>=Math.abs(c-this._enterZoomTarget)&&(this._enterZoomTarget=null)):(null!=this.desiredFactor&&.35>=Math.abs(this.desiredFactor-c)||(this.desiredFactor=this.nearestStep(c)),this.updateSliderUi(this.desiredFactor));b.showBubble&&this.showSliderBubble()}},scheduleSyncFromPage:function(b,c){this._syncTimer&&window.clearTimeout(this._syncTimer);this._syncTimer=window.setTimeout(function(){this._syncTimer=null;this.syncSliderFromPage(c)}.bind(this),
null==b?220:b)},scheduleEnterZoomSettle:function(){var b=this;this._enterLockTimer&&window.clearTimeout(this._enterLockTimer);this._enterLockTimer=window.setTimeout(function(){b._enterLockTimer=null;if(null!=b._enterZoomTarget){var c=b.getEffectiveFactor();b.desiredFactor=.35<Math.abs(c-b._enterZoomTarget)&&1.1<c?b.nearestStep(c):b._enterZoomTarget;b._enterZoomTarget=null;b.updateSliderUi(b.desiredFactor);b.showSliderBubble()}else b.syncSliderFromPage({showBubble:!0})},700)},defaultEvt:function(b){return b?
b:{pointers:[{pageX:windowWidth/2,pageY:windowHeight/2},{pageX:windowWidth/2,pageY:windowHeight/2}]}},applyLiveScale:function(b,c,d){b&&b.parameters&&!b.parameters.eventCancel&&!b.parameters.zoomming&&(d=this.defaultEvt(),this._sliderLockOrigin?b.parameters.origin=this._sliderLockOrigin:(b.parameters.origin=b.mathOrigin(b,d),this._sliderLockOrigin={x:b.parameters.origin.x,y:b.parameters.origin.y}),b.originObj(b,b.parameters.origin),d={origin:b.parameters.origin,scale:c,tran:b.mathTran(b,d,b.parameters.origin)},
d.tran=b.tranLimit(b,c,d.tran),b.zoomTran=d,b.transformSetting(b,d),b.parameters.scale=c,b.parameters.toScale=c)},setZoomPagePanBlocked:function(b){var c=this.getZoomPage();c&&c.parameters&&(c.parameters.blockUiPan=!!b,b||(c.parameters.onPan=!1))},beginSliderDrag:function(b){this._sliderDragging=!0;this._sliderLockOrigin=null;this.sliderTrack.addClass("is-dragging");this.setZoomPagePanBlocked(!0);this.showSliderBubble({hold:!0});try{var c=b&&(b.originalEvent||b);c&&null!=c.pointerId&&this.sliderTrack[0].setPointerCapture&&
(this.sliderTrack[0].setPointerCapture(c.pointerId),this._sliderPointerId=c.pointerId)}catch(d){}},endSliderDrag:function(){this._sliderDragging=!1;this._sliderLockOrigin=null;this.sliderTrack.removeClass("is-dragging");this.setZoomPagePanBlocked(!1);try{null!=this._sliderPointerId&&this.sliderTrack[0].releasePointerCapture&&this.sliderTrack[0].releasePointerCapture(this._sliderPointerId)}catch(b){}this._sliderPointerId=null;this.showSliderBubble()},setZoomFactor:function(b,c,d){d=d||{};var e=!1!==
d.snap,f=!0===d.live,g=this.getZoomPage();if(g&&g.parameters&&!g.parameters.eventCancel){bookConfig.AnnotationButtonVisible&&global.annotationEditor&&global.annotationEditor.saveCookie();var h=e?this.nearestStep(b):b,k=this.getScaleBounds(g);h=Math.max(ZOOM_STEPS[0],Math.min(Math.min(k.maxFactor,ZOOM_STEPS[ZOOM_STEPS.length-1]),h));e&&(h=this.nearestStep(h));f||(this._enterZoomTarget=null,this._enterLockTimer&&(window.clearTimeout(this._enterLockTimer),this._enterLockTimer=null));this.desiredFactor=
e?h:b;this.updateSliderUi(this.desiredFactor);f?this.showSliderBubble({hold:!0}):this.showSliderBubble();g.scale=null!=g.parameters.toScale?g.parameters.toScale:g.parameters.scale;b=this.factorToScale(g,h);k=this.getEffectiveFactor(g);e&&!f&&.05>Math.abs(k-h)||(f?this.applyLiveScale(g,b,c):(this.interruptZoomAnimation(g),c=this.defaultEvt(c),g.parameters.origin=g.mathOrigin(g,c),g.originObj(g,g.parameters.origin),d=null!=d.duration?d.duration:150,g.animateToScale(g,b,c,d),this.scheduleSyncFromPage(d+
80)))}},setVisible:function(b){b&&this.buttonChangeColor();b&&this.applyEnterZoomFactor();this.bar.css({display:b?"flex":"none"});if(b)this.width=this.bar.outerWidth()||this.bar.width()||this.width||320,b=parseFloat(this.bar.css("top")),isNaN(b)&&(b=0),this.setPosition((windowWidth-this.width)/2,b),this.bar.attr("tabindex",0),this.bar.focus(),this.emphasizeBar(),this.showShortcutTipIfNeeded(),this.showSliderBubble(),this.scheduleEnterZoomSettle(),this.bindFlipKeepZoom();else{this.clearEmphasize();
this.hideShortcutTip();this.clearEnterZoomLock();if(this._syncStageTimers){for(b=0;b<this._syncStageTimers.length;b++)window.clearTimeout(this._syncStageTimers[b]);this._syncStageTimers=null}this._sliderDragging&&this.endSliderDrag();this.hideSliderBubble();this.unbindFlipKeepZoom()}},emphasizeBar:function(){this.clearEmphasize();this.bar.addClass("is-emphasize");this.bar.css({opacity:1});this._emphasizeTimer=window.setTimeout(function(){this.bar.removeClass("is-emphasize");this.bar.css({opacity:""});
this._emphasizeTimer=null}.bind(this),ZOOM_EMPHASIZE_MS)},clearEmphasize:function(){this._emphasizeTimer&&(window.clearTimeout(this._emphasizeTimer),this._emphasizeTimer=null);this.bar.removeClass("is-emphasize");this.bar.css({opacity:""})},showShortcutTipIfNeeded:function(){try{if(window.localStorage&&"1"===localStorage.getItem(ZOOM_SHORTCUT_TIP_KEY))return}catch(b){if(this._tipShownSession)return}if(!this._tipEl||!this._tipEl.length){this._tipEl=$("<div class='zoom-shortcut-tip' role='status' aria-live='polite'>"+
getLanguage("lblZoomCtrlScrollTip","Press Ctrl and scroll to zoom in or out.")+"</div>");$(document.body).append(this._tipEl);void 0;this._tipEl.addClass("is-visible");this._tipShownSession=!0;try{window.localStorage&&localStorage.setItem(ZOOM_SHORTCUT_TIP_KEY,"1")}catch(b){}this._tipTimer=window.setTimeout(function(){this.hideShortcutTip()}.bind(this),ZOOM_TIP_MS);window.setTimeout(function(){if(this._tipEl)$(document).off(".zoomShortcutTip").on("mousedown.zoomShortcutTip wheel.zoomShortcutTip DOMMouseScroll.zoomShortcutTip keydown.zoomShortcutTip touchstart.zoomShortcutTip pointerdown.zoomShortcutTip",
this._onUserActionBound)}.bind(this),50)}},onUserActionForTip:function(){this.hideShortcutTip()},hideShortcutTip:function(){this._tipTimer&&(window.clearTimeout(this._tipTimer),this._tipTimer=null);$(document).off(".zoomShortcutTip");if(this._tipEl){this._tipEl.removeClass("is-visible");var b=this._tipEl;this._tipEl=null;window.setTimeout(function(){b.remove()},200)}},bindFlipKeepZoom:function(){this._flipBound||(this._flipBound=!0,"undefined"!==typeof BookEvent&&BookEvent.bindEvent&&BookEvent.bindEvent("flipPage",
this._onFlipBound))},unbindFlipKeepZoom:function(){this._flipBound&&(this._flipBound=!1,"undefined"!==typeof BookEvent&&BookEvent.removeEvent&&BookEvent.removeEvent("flipPage",this._onFlipBound))},onFlipWhileZoomed:function(){if(this.desiredFactor){var b=BookInfo.getBook();b&&b.status_zoom&&window.setTimeout(function(){if(b.status_zoom){var c=this.getZoomPage();c&&c.parameters&&c.parameters.zoomFlag&&(c=this.getEffectiveFactor(c),.05<Math.abs(c-this.desiredFactor)?this.setZoomFactor(this.desiredFactor,
null,{snap:!0,duration:150}):this.syncSliderFromPage())}}.bind(this),120)}},buttonChangeColor:function(){this.hasChanged||(this.btnZoomUp.changeButtonColor(bookConfig.iconColor),this.btnZoomDown.changeButtonColor(bookConfig.iconColor),this.btnZoomOut.changeButtonColor(bookConfig.iconColor),this.btnPre.changeButtonColor(bookConfig.iconColor),this.btnNext.changeButtonColor(bookConfig.iconColor),this.btnMoveMode.changeButtonColor(bookConfig.iconColor),this.btnClose.changeButtonColor(bookConfig.iconColor),
this.hasChanged=!0)},setPosition:function(b,c,d){void 0==d&&(d=["left","top"]);this.bar.css(d[0],b+"px");this.bar.css(d[1],c+"px")},initEvent:function(){this.btnZoomUp.on(_event._click,function(){BookEvent.trigger("zoomIn",["zoom bar",BookInfo.getCurrentPages().join("-")]);this.zoomUp()}.bind(this));this.btnZoomDown.on(_event._click,function(){BookEvent.trigger("zoomOut",["zoom bar",BookInfo.getCurrentPages().join("-")]);this.zoomDown()}.bind(this));this.btnZoomOut.on(_event._click,function(){BookEvent.trigger("zoomOut",
["zoom bar",BookInfo.getCurrentPages().join("-")]);this.zoomOut()}.bind(this));this.btnPre.on(_event._click,function(){rightToLeft?nextPageFun("zoom bar"):previousPageFun("zoom bar")});this.btnNext.on(_event._click,function(){rightToLeft?previousPageFun("zoom bar"):nextPageFun("zoom bar")});this.btnMoveMode.on(_event._click,function(){BookEvent.trigger("zoomMove",["zoom bar",BookInfo.getCurrentPages().join("-")]);this.changeMoveMode()}.bind(this));this.btnClose.on(_event._click,function(){this.hideSliderBubble(!0);
this.bar.hide()}.bind(this));this.initSliderEvents()},initSliderEvents:function(){var b=this,c=function(f){var g=f.pageX;f.originalEvent&&f.originalEvent.touches&&f.originalEvent.touches[0]&&(g=f.originalEvent.touches[0].pageX);null==g&&null!=f.clientX&&(g=f.clientX);f=b.sliderTrack[0].getBoundingClientRect();return f.width?(g-f.left)/f.width:0},d=function(f){b._sliderDragging&&(b.stopSliderEvent(f),b.setZoomPagePanBlocked(!0),f=b.factorFromSliderRatio(c(f)),b.desiredFactor=f,b.updateSliderUi(f),
b.setZoomFactor(f,null,{live:!0,snap:!1}))},e=function(f){b._sliderDragging&&(b.stopSliderEvent(f),f=b.factorFromSliderRatio(c(f)),f=b.nearestStep(f),b.endSliderDrag(),$(document).off(".zoomSliderDrag"),b.setZoomFactor(f,null,{snap:!0,duration:150}))};this.sliderTrack.on("mouseenter.zoomSlider",function(){b.pulseSliderBubble()});this.sliderTrack.on("mouseleave.zoomSlider",function(){b._sliderDragging||b.showSliderBubble()});this.sliderTrack.on("focus.zoomSlider",function(){b.pulseSliderBubble()});
this.sliderTrack.on("blur.zoomSlider",function(){b._sliderDragging||b.showSliderBubble()});this.sliderTrack.on("pointerdown.zoomSlider mousedown.zoomSlider touchstart.zoomSlider",function(f){b.stopSliderEvent(f);b.beginSliderDrag(f);f=b.factorFromSliderRatio(c(f));b.desiredFactor=f;b.updateSliderUi(f);b.setZoomFactor(f,null,{live:!0,snap:!1});$(document).off(".zoomSliderDrag").on("pointermove.zoomSliderDrag mousemove.zoomSliderDrag touchmove.zoomSliderDrag",d).on("pointerup.zoomSliderDrag pointercancel.zoomSliderDrag mouseup.zoomSliderDrag touchend.zoomSliderDrag touchcancel.zoomSliderDrag",
e)});this.bar.on("mousedown.zoomBar touchstart.zoomBar pointerdown.zoomBar",function(f){b.stopSliderEvent(f)});this.sliderTrack.on("keydown",function(f){if("ArrowRight"===f.key||"ArrowUp"===f.key)f.preventDefault(),b.zoomUp();else if("ArrowLeft"===f.key||"ArrowDown"===f.key)f.preventDefault(),b.zoomDown()})},evtFromClient:function(b){var c=b.pageX,d=b.pageY;b.originalEvent&&b.originalEvent.touches&&b.originalEvent.touches[0]&&(c=b.originalEvent.touches[0].pageX,d=b.originalEvent.touches[0].pageY);
null==c&&(c=windowWidth/2);null==d&&(d=windowHeight/2);return{pointers:[{pageX:c,pageY:d},{pageX:c,pageY:d}]}},changeMoveMode:function(){1==this.moveByMousePosition?(this.moveByMousePosition=!1,this.btnMoveMode.empty().append(getImage(this.moveByPositionUrl))):(this.moveByMousePosition=!0,this.btnMoveMode.empty().append(getImage(this.moveByDragUrl)));this.applyMoveModeTooltip();this.btnMoveMode.changeButtonColor(bookConfig.iconColor)},destroy:function(){this.clearEmphasize();this.hideShortcutTip();
this.hideSliderBubble(!0);this.destroyButtonTooltips();this.unbindFlipKeepZoom();this.clearBubbleHideTimer();this.clearEnterZoomLock();this._syncTimer&&window.clearTimeout(this._syncTimer);if(this._syncStageTimers){for(var b=0;b<this._syncStageTimers.length;b++)window.clearTimeout(this._syncStageTimers[b]);this._syncStageTimers=null}this._sliderDragging&&this.endSliderDrag();this.sliderBubble&&this.sliderBubble.remove();$(document).off(".zoomSliderDrag").off(".zoomShortcutTip");this.bar.off(".zoomBar");
this.bar.remove()},zoomByStep:function(b,c){var d=this.getZoomPage();if(d&&d.parameters&&!d.parameters.eventCancel){var e=this.reachableSteps(),f=this.getCurrentStepIndex(d);e=e[Math.max(0,Math.min(e.length-1,f+b))];0>b&&(b=this.factorToScale(d,e),f=this.getScaleBounds(d).minScale,b<=f+1E-6&&(d.parameters.zoomOut=!0));this.setZoomFactor(e,c,{snap:!0,duration:150})}},zoomUp:function(b){this.zoomByStep(1,b)},zoomDown:function(b){this.zoomByStep(-1,b)},zoomOut:function(){var b=this.getZoomPage();b&&
(b.onDoubleTap.bind(b)({pointers:[{pageX:windowWidth/2,pageY:windowHeight/2}]}),StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(c){c.setAsZoomin();c.executeCallback()}),this.desiredFactor=null)},setA11y:function(){this.bar.find(".button").each(function(){$(this).attr("tabindex",0);$(this).attr("role","button");$(this).off("keydown.a11y").on("keydown.a11y",function(b){"Enter"!==b.key&&" "!==b.key||$(this).trigger("click")})})}}),CatalogZoomControlBar=Class({}).extend(ZoomControlBar),
...
this.mapCursor=$("<div class='map_cursor'></div>");this.map.append(this.imageLeft);this.map.append(this.imageRight);this.map.append(this.mapCursor);bookContainer.append(this.map)},show:function(){this.visible=!0;this.onResize();this.refreshArea();this.map.show()},hide:function(){this.visible=!1;this.map.hide()},getTopRightBarClearance:function(){var b=window.toolBar&&toolBar.topRightBar&&toolBar.topRightBar.length?toolBar.topRightBar:"undefined"!==typeof $?$("#topRightBar"):null;if(!b||!b.length||
"none"===b.css("display"))return 0;var c=b.outerHeight();if(!c)return 0;var d=0;try{var e=b.offset(),f="undefined"!==typeof bookContainer&&bookContainer&&bookContainer.offset?bookContainer.offset():null;d=e&&f?e.top-f.top:parseFloat(b.css("top"))||0}catch(g){d=parseFloat(b.css("top"))||0}0>d&&(d=0);return d+c+10},onResize:function(){bookConfig.largePageWidth/bookConfig.largePageHeight<this.maxWidth/this.maxHeight?(this.pageWidth=this.maxWidth,this.pageHeight=bookConfig.largePageHeight*this.maxWidth/
bookConfig.largePageWidth):(this.pageHeight=this.maxHeight,this.pageWidth=bookConfig.largePageWidth*this.maxHeight/bookConfig.largePageHeight);bookConfig.FlipDirection?(this.height=this.book.doublePage?2*(this.pageHeight+1):this.pageHeight,this.width=this.pageWidth+2):(this.height=this.pageHeight+2,this.width=this.book.doublePage?2*(this.pageWidth+1):this.pageWidth);var b=20+bookConfig.rightMargin,c=templateArea.getTopHeight()+10+bookConfig.topMargin;c=Math.max(c,this.getTopRightBarClearance());this.map.css({left:"auto",
...
0<e.length?e:"error":-1!=e?e:isNaN(parseInt(b))||void 0!==d[parseInt(b)]?"error":parseInt(b)};function getEncodedPageHashValue(b){var c="function"===typeof getShownPageNumber?getShownPageNumber(b):b;if(void 0===c||null===c)c=b;return encodeURIComponent(String(c))}function shouldReadPageIndexFromUrlHash(){return!(!bookConfig.addCurrentPage&&!bookConfig.updateURLForPage)}
function getLocationHashParamValue(b){var c=window.location.hash||"";"#"==c.charAt(0)&&(c=c.substr(1));if(!c)return null;c=c.split("&");for(var d=0;d<c.length;d++){var e=c[d];if(e){var f=e.indexOf("=");if((-1<f?e.substr(0,f):e)==b)return-1<f?e.substr(f+1):""}}return null}function parsePageIndexFromHashValue(b){if(null===b||void 0===b||""===b)return NaN;try{return parseInt(getRealPageNumber(decodeURIComponent(b)))}catch(c){return NaN}}
function parsePageIndexFromLocationHash(b){var c=parsePageIndexFromHashValue(getLocationHashParamValue("page"));if(!isNaN(c))return c;if(!shouldReadPageIndexFromUrlHash())return b;c=parsePageIndexFromHashValue(getLocationHashParamValue("p"));return isNaN(c)?b:c}
var setLocationHash=function(b){bookConfig.updateURLForPage&&(window.location.hash="#p="+getEncodedPageHashValue(b))},nextPageFun=function(b){switch(bookType){case BookType.normal_book:gotoPageFun(BookInfo.getMinPageIndex(flipBook.getCurrentPageIndex())+2,!1,b);break;case BookType.single_book:gotoPageFun(parseInt(singlePageBook.currentPageIndex)+1,!1,b);break;case BookType.slide_book:gotoPageFun(BookInfo.getMinPageIndex(slideBook.getRealPageIndex())+2,!1,b);break;case BookType.singleSlide_book:gotoPageFun(parseInt(singleSlideBook.getRealPageIndex())+
...
1,!1,b);break;case BookType.invert_book:gotoPageFun(parseInt(invertBook.getCurrentPageIndex())-1,!1,b)}},firstPageFun=function(b){gotoPageFun(1,!1,b)},lastPageFun=function(b){gotoPageFun(originTotalPageCount,!1,b)},delayToFlipFirstTimer=null,gotoPageFun=function(b,c,d){if(!(isNaN(b)||BookEvent.trigger("beforeFlipPage",[b])||(window.hashGotoPageTimer&&clearTimeout(window.hashGotoPageTimer),gotoPageVisit(b,d),BookEvent.suspendFlipPage&&0<=BookInfo.getCurrentPagesByIndex(b).indexOf(parseInt(BookEvent.suspendFlipPage))))){b=
parseInt(b);var e=bookConfig.totalPageCount;bookConfig.SingleModeBanFlipToLastPage&&bookType==BookType.single_book&&(e=Math.max(1,bookConfig.totalPageCount-1));if(1>b&&bookConfig.isShowFirstOrLastPagePrompt||b>e&&bookConfig.isShowFirstOrLastPagePrompt){if(0>BookInfo.getCurrentPages().indexOf(e)&&b>e){gotoPageFun(e,c,d);return}if(0>BookInfo.getCurrentPages().indexOf(1)&&1>b){gotoPageFun(1,c,d);return}if(bookConfig.isShowFirstOrLastPagePrompt){b=1>b?getLanguage("lblFirst","This is the first page"):
getLanguage("lblLast","This is the last page");global._tipsBox||(_tipsBox=new TipsBox(b,bookContainer));_tipsBox.setCaption(b);_tipsBox.showTipsBox();return}}e=b;BookInfo.isDoublePage()&&(e=BookInfo.getMaxPageIndex(e));e=Math.max(1,e);if(passwardType()&&bookConfig.excludeFrontPages&&e>=parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()&&(window.PasswardPannel&&!global.passwardPannel&&(global.passwardPannel=new PasswardPannel),global.passwardPannel.show(),e>parseInt(bookConfig.excludeFrontPages)))return;
switch(bookType){case BookType.normal_book:flipBook.gotoPage(b,c);break;case BookType.single_book:singlePageBook.gotoPage(b,c);break;case BookType.slide_book:slideBook.gotoPage(b,c);break;case BookType.singleSlide_book:singleSlideBook.gotoPage(b,c);break;case BookType.catalog_book:catalogBook.gotoPage(b,c);break;case BookType.singleCatalog_book:singleCatalogBook.gotoPage(b,c);break;case BookType.documentView_book:singleDocumentViewBook.gotoPage(b,c);break;case BookType.singleDocumentView_book:singleDocumentViewBook.gotoPage(b,
c);break;case BookType.card_book:cardBook.gotoPage(b,c);break;case BookType.invert_book:invertBook.gotoPage(b,c)}global.bookmark&&global.bookmark.elements.refreshElements();bookConfig.SelectTextButtonVisible&&((c=_get(htmlConfig,"phoneTemplate.name",""))&&"Modern"===c||BookInfo.getBook().unSelect());bookConfig.MagnifierButtonVisible&&BookInfo.getBook().unMagnifierZoom();global.annotationPannel&&global.annotationPannel.clearBtnDownCase();bookConfig.addCurrentPage&&(global.sharePanel&&global.sharePanel.elements&&
global.sharePanel.elements.fillArea(!0,"link"),window.refreshWeixinShareWithCurrentBookMeta&&window.refreshWeixinShareWithCurrentBookMeta(),window.refreshEmailShareOnPageChange&&window.refreshEmailShareOnPageChange());global.downLoadBody&&downLoadBody.gotoPage(b);if(bookConfig.AnnotationButtonVisible&&!isPhone()&&!isPad()&&BookInfo.getBook().bookAttachments.noteAdd)BookInfo.getBook().bookAttachments.noteAdd.onResize();setCurrentIndexTextField(BookInfo.getCurrentPageIndex(),BookInfo.isDoublePage());
"popstate"!==d&&setLocationHash(BookInfo.getCurrentPageIndex());global.phoneGotoPagePanel&&global.phoneGotoPagePanel.visible&&global.phoneGotoPagePanel.refreshSlider();global.NeatStyle&&NeatStyle.refreshSlider();global.assistant&&global.assistant.refresh();global.pcArticlePages&&(global.pcArticlePages.clearHighLight(),global.pcArticlePages.setHighLight(b));global.phoneArticlePages&&(global.phoneArticlePages.clearHighLight(),global.phoneArticlePages.setHighLight(b));global.flipPageAudio&&global.flipPageAudio.playByIndex(b);
global.phoneGotoPagePanel&&global.phoneGotoPagePanel.showFirstOrLast();global.flipShotButton&&global.flipShotButton.showFirstOrLast();global.toolbar&&global.toolBar&&global.toolBar.showFirstOrLast&&global.toolBar.showFirstOrLast();bookConfig.delayToFlipFirst&&1!==b&&(delayToFlipFirstTimer&&clearTimeout(delayToFlipFirstTimer),delayToFlipFirstTimer=setTimeout(function(){firstPageFun("auto flip")},1E3*bookConfig.timeToFlipFirst));global.modernPageBookmarkIndicator&&global.modernPageBookmarkIndicator.refresh()}},
gotoPageVisit=function(b,c){var d=window.lastVisitTime?(new Date).getTime()-window.lastVisitTime:0;window.lastVisitTime=(new Date).getTime();if(!(0>=b||b>bookConfig.totalPageCount)){var e={"phone thumbnail":"thumbnail",thumbnail:"thumbnail","table of content":"toc"};if(e[c]){var f={};BookEvent.trigger("customEvent",["click_"+e[c]+"_page_"+b,(f["click_"+e[c]+"_to_page"]=b,f)])}BookEvent.trigger("flipPage",[c,BookInfo.getCurrentPages().join("-"),BookInfo.getCurrentPagesByIndex(b).join("-"),d])}},BookInfo=
Class({statics:{getCurrentPages:function(){var b=[];if(this.isDoublePage()){var c=this.getCurrentPageIndex();b=this.getPagesByIndex(c)}else c=this.getCurrentPageIndex(),b.push(c);return b},getCurrentPagesByIndex:function(b){var c=[];this.isDoublePage()?c=this.getPagesByIndex(b):c.push(b);return c},getPageCount:function(){return bookConfig.totalPageCount},isRightToLeft:function(){return rightToLeft},getBookType:function(){return bookType},getBook:function(){switch(this.getBookType()){case BookType.normal_book:var b=
...
1].length)?!0:!1},loading:function(){if("restrict"!=BookRestrict.isRestrictPage(this.pageIndex)){if(this.originalImageLoaded)if(this.hasReader()){if(this.pageReaderLoaded)return}else return;this.removeLoad||(this.loadingImage||(this.loadingImage=$("<div class='loadingOuter'><img alt='loadingOuter' width='auto' height='auto' class='loadingImage' src='"+bookConfig.pageLoadingUrl+"'/></div>")),this.sideContent.append(this.loadingImage))}},unLoading:function(b){this.hasReader()&&!b||!this.loadingImage||
...
e.originalImageLoaded=!0;e.hasReader()||e.unLoading(!0);e.unRestrict();if(e.sideImage&&("string"==typeof c&&!c.startsWith("none")||"string"!=typeof c))if("string"==typeof c||"object"==typeof c&&0<=c[0].indexOf(".zip"))isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),e.clearSideImageContent(),e.sideImage.append(d);else{e.clearSideImageContent();for(f=0;f<d.length;f++)isPhone()||isPad()?
bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),e.sideImage.append(d[f]);e.imageWidth=d[0][0].naturalWidth;e.imageHeight=d[0][0].naturalHeight}g=fitPageWidthHeight(e.pageWidth,e.pageHeight,e.imageWidth,e.imageHeight);!bookConfig.isSingleBookFullWindowOnMobile||1!=e.bookType||!isPhone()&&!isPad()||e.imageWidth||e.imageHeight||(g=fitPageWidthHeight(e.pageWidth,e.pageHeight,bookConfig.largePageWidth,bookConfig.largePageHeight),
h=bookConfig.largePageWidth/bookConfig.largePageHeight,k=e.pageWidth/e.pageHeight,.01>h-k&&-.01<h-k&&(g.x=e.pageWidth,g.y=e.pageHeight),e.imageWidth=g.x,e.imageHeight=g.y);e.pageAttachments||(e.pageAttachments=new IssuuPageAttachmentsParser(e.sideContent,e.pageWidth,e.pageHeight,e.pageWidth,e.pageHeight,e.pageIndex,e.bookType,e,function(){if(this.onPageLoaded)this.onPageLoaded(this.pageIndex)}.bind(e)));l.jumpToEnd()})},isReaderConfigLoaded:function(b){try{var c=function(){try{b&&b()}catch(e){}};
(window.readerConfig||window.readerConfigLoaded)&&c();var d=window.setInterval(function(){window.readerConfigLoaded&&(window.clearInterval(d),c())},100)}catch(e){}},onPageLoaded:function(){this.pageReaderLoaded=!0;this.unLoading(!0);var b=this.pageIndex;BookInfo.getBook().getRealBookIndex&&(b=BookInfo.getBook().getRealBookIndex(this.pageIndex));BookInfo.getBook().onBookPageLoaded(b)},enterSide:function(){this._pageEnterTime=Date.now();this.pageAttachments&&this.pageAttachments.enterSide();this.pageBackground&&
...
this.imageWidth=d.naturalWidth,this.imageHeight=d.naturalHeight;else{this.clearSideImageContent();for(b=0;b<d.length;b++)isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),this.sideImage.append(d[b]);this.imageWidth=d[b][0].naturalWidth;this.imageHeight=d[b][0].naturalHeight}},resizeSvg:function(b,c){try{this.pageBackground.resizeSvg(b,c)}catch(d){}}}).extend(Side);
bdor[30]=function(b,c){return bdor[b]-c};bdor[38]=function(){return bdor[30](37,40)}();
...
0<global.readerConfig.pages.length&&hasReaderPageItems(window.readerConfig.pages[this.pageIndex-1])?!0:!1};IssuuPageAttachmentsParser.prototype.isHiddenEditor=function(){return!bookConfig.isPreview||bookConfig.previewPages&&-1!==(Array.isArray(bookConfig.previewPages)&&bookConfig.previewPages.indexOf(this.pageIndex))?!1:!0};
...
var IssuuImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));m.imageURL=p;m.imageObject=new ImageObject;m.imageObject.alt(m.index);
m.imageObject.src(m.imageURL);m.imageObject.css({"z-index":0});m.$image=m.imageObject.$image;bookConfig.EnableRecognizeQRcodePressOnMobile&&m.imageObject.css({"-webkit-touch-callout":"default"});m.loaded=!1;m.$image[0].onload=function(){this.loaded=!0;this.callback&&this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(m);m.$image[0].onerror=function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);
bookConfig.textSharpening&&(q="-webkit-optimize-contrast",_agent_.browser.firefox&&(q="-moz-crisp-edges"),_agent_.browser.opera&&(q="-o-crisp-edges"),m.$image.css({"image-rendering":q,"-ms-interpolation-mode":"nearest-neighbor"}));v.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&isPC()?this.switchNormalImage(b,c):(isPhone()||isPad())&&this.resize()},
...
c,d,e,f,g,h,k,l){var m=this,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&!bookConfig.isEncryptionBook&&(p=p.removeStartFrom("?"));m.imageURL=p;m.$image=$("<img alt='' src='"+m.imageURL+"' style='z-index:0;'/>");bookConfig.EnableRecognizeQRcodePressOnMobile&&m.$image.css({"-webkit-touch-callout":"default"});m.$image[0].onload=function(){this.callback&&
...
c,this.width,this.height),this.scale(b.x,b.y)}}),IssuuImageArrayLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,m,p,q,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==r.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,h.callback=d,h.$images=[],h.loadArray=[],r.yield(getPageDir(b,c,originTotalPageCount),2);k=r.yieldResult;h.imagesURL=k;l=
0;m=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);p=function(t){l++;this.$images.removeElement(t);this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);for(q=0;q<k.length;q++)v=-1<k[q].indexOf(".svg")?new IssuuImageArrayLoadSvg(b,k[q],c,m,p,e,f,g,q):new IssuuImageArrayLoadImage(b,k[q],c,m,p,e,f,g,q),h.$images.push(v.$image),h.loadArray.push(v);r.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&
...
"-ms-interpolation-mode":"nearest-neighbor"})}},zoomIn:function(b){bookConfig.useTheAliCloudChart&&this.switchLargeImage(b);(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&this.switchNormalImage(b,c);(isPhone()||isPad())&&this.resize()},onResize:function(b,c){try{if(!(!0!==bookConfig.canvasRender&&"true"!==bookConfig.canvasRender||isPhone()||isPad())&&this.canvasDom){this.pageWidth=b;this.pageHeight=c;this.canvasDom.setAttribute("width",this.width);
this.canvasDom.setAttribute("height",this.height);var d=this.canvasDom.getContext("2d");d.width=this.width;d.width=this.height;d.drawImage(this.$image[0],0,0);canvasReload(this.canvasDom,this.pageWidth,this.pageHeight,!0);return}}catch(e){console.log("this function cross-domain !")}b&&c&&(this.pageWidth=b,this.pageHeight=c);if((isPhone()||isPad())&&!this.isMirrorSide&&BookInfo.getBook().status_zoom)this.highDefinition();else{this.setImageCss({width:"100%",height:"100%",position:"absolute",top:0,left:0});
b=!1;if(isPhone()||isPad())b=!0;b=transformCSS({scale:1,origin:{x:0,y:0}},b);this.setImageCss(b)}},resize:function(){this.setImageCss({width:"100%",height:"100%",position:"absolute",top:0,left:0});var b=!1;if(isPhone()||isPad())b=!0;b=transformCSS({scale:1,origin:{x:0,y:0}},b);this.setImageCss(b)},highDefinition:function(){this.scale(this.width,this.height)},scale:function(b,c){var d=this.parent.width();var e=this.parent.height()/c;d/=b;this.setImageCss({width:b+"px",height:c+"px",position:"absolute",
left:0,bottom:"auto",top:0,right:"auto"});b=!1;if(isPhone()||isPad())b=!0;e=transformCSS({scale:{x:d,y:e},origin:{x:0,y:0}},b);this.setImageCss(e)},switchLargeImage:function(b){if(bookConfig.useTheAliCloudChart){var c=this.imageURL.removeStartFrom("?");window.isSupportWebp?0>c.indexOf("webp")?c+="?x-oss-process=image/format,webp":bookConfig.textClarityEnhancement&&(c+="?x-oss-process=image"):c+="?x-oss-process=image/format,"+getWebpOriginFormat(c);switch(bookConfig.textClarityEnhancement){case 1:c+=
"/sharpen,100";break;case 2:c+="/sharpen,150";break;case 3:c+="/sharpen,200"}if(isPhone()||isPad())if(this.largeImageObject)this.largeImageObject&&this.largeImageObject.show();else{this.largeImageObject=new ImageObject;this.largeImageObject.attr("id",this.id);this.largeImageObject.alt(this.id);this.largeImageObject.src(c);var d=this.largeImageObject.$image;bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"});d[0].onload=function(){this.onResize();this.parent.append(d)}.bind(this)}else b&&
...
f.jumpToEnd()})},setImageCss:function(b){this.imageObject&&this.imageObject.css(b);this.largeImageObject&&this.largeImageObject.css(b)}}),IssuuPdfLoad=Class({index:0,pageWidth:0,pageHeight:0,create:function(b,c,d,e,f,g,h){var k=this,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return k.index=b,k.type=c,k.pageWidth=e,k.pageHeight=f,k.renderWidth=e,k.renderHeight=f,k.callback=d,k.parent=h,l=k,p.yield(getPageDir(b,c,originTotalPageCount),2);if(3!=p.nextAddress)return l.imageURL=
p.yieldResult,m=k,p.yield(getPageDir(b,"thumb",originTotalPageCount),3);m.thumbUrl=p.yieldResult;k.$content=$("<div style='position:absolute;left:0;top:0;width:100%;height:100%;'></div>");k.pdfLoadingTask=new PdfLoadingTask(k.index,k.type,e,f,k.loaded.bind(k));window.pdfLoadStack||(window.pdfLoadStack=new PdfLoadArray(3));window.pdfLoadStack&&pdfLoadStack.push(k.pdfLoadingTask);p.jumpToEnd()})},enterSide:function(){this.enter=!0},leaveSide:function(){this.enter=!1;this.pdfLoadingTask&&this.pdfLoadingTask.leaveSide()},
...
!0;this.changeImageSrc(b)},changeImageSrc:function(b){this.pdfLoaded&&(this.width=parseFloat(b.style.width),this.height=parseFloat(b.style.height),this.$canvas=$(b),this.$content.empty().append(this.$canvas),this.callback&&this.callback(this.imageURL,this.imageURL,this.$content,this.index),this.resizeImage())},resizeImage:function(){if(this.zoom)b=this.renderWidth,c=this.renderHeight;else{var b=this.parent.width(),c=this.parent.height();this.pageWidth=b;this.pageHeight=c;this.renderWidth=b;this.renderHeight=
c}var d={width:"100%",height:"100%",position:"absolute",top:0,left:0};2>=b-this.width&&(d.width=this.width+"px",d.left=Math.round((b-this.width)/2)+"px");2>=c-this.height&&(d.height=this.height+"px",d.top=Math.round((c-this.height)/2)+"px");this.$canvas.css(d);d=b-this.width;var e=c-this.height;(0!==d||0!==e)&&4>=d&&4>=e&&(this.$thumb||(this.$thumb=$('<img alt="" src="'+this.thumbUrl+'" style="z-index:-1;width:100%;height:100%;position:absolute;top:0;left:0;"/>')),this.$content.append(this.$thumb));
d=transformCSS({scaleX:this.pageWidth/b,scaleY:this.pageHeight/c,origin:{x:0,y:0}},!1);this.$content.css(d);this.$content.css({width:b+"px",height:c+"px"})},resizeSvg:function(b,c){this.renderWidth=b;this.renderHeight=c;this.zoom=this.renderHeight>this.pageHeight?!0:!1;window.pdfLoadStack&&(isPC()||isSlideBook()||0<=BookInfo.getCurrentPages().indexOf(this.index))&&(this.pdfLoadingTask.changeRenderWH(b,c),pdfLoadStack.push(this.pdfLoadingTask))},destroy:function(){this.pdfLoadingTask&&(window.pdfLoadStack&&
pdfLoadStack.pop(this.pdfLoadingTask),this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),IsuuPageBackground=Class({create:function(b,c,d,e,f,g,h){var k=this,l,m,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress){if(!b||!c)return q.return();k.type=c;k.pageWidth=e;k.pageHeight=f;return q.yield(getPageDir(b,c,originTotalPageCount),2)}l=q.yieldResult;m=getPageSize(b,c);k.imageURL=l;k.load=null;k.parent=h;p=k.getUrlType(l,m);k.urlType=p;switch(p){case 0:k.load=
new CanvasLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 1:k.load=new IssuuImageLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 2:k.load=new JsLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 3:k.load=new SvgLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 4:k.load=new IssuuImageArrayLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 5:k.load=new IssuuPdfLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 6:k.load=new ImageStageLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 7:k.load=
new NoneLoad(b,c,d,k.pageWidth,k.pageHeight,g,h)}q.jumpToEnd()})},getUrlType:function(b,c){return this.isPdf(b)?5:c&&isPC()?6:"object"==typeof b?4:"normal"==this.type&&bookConfig.usePdfJs?0:-1<b.indexOf("none")?7:-1<b.indexOf(".js")?2:-1<b.indexOf(".svg")?3:1},isPdf:function(b){return-1<b.indexOf(".pdf")||-1<b.indexOf(".zip")?!0:!1},onResize:function(b,c){this.pageWidth=b;this.pageHeight=c;if(this.load&&this.load.onResize)this.load.onResize(b,c)},zoomIn:function(b,c){this.load&&this.load.zoomIn&&
this.load.zoomIn(b,c)},zoomOut:function(b,c){this.load&&this.load.zoomOut&&this.load.zoomOut(b,c)},destroy:function(){this.load&&this.load.destroy&&this.load.destroy()},resizeSvg:function(b,c){this.load&&this.load.resizeSvg&&this.load.resizeSvg(b,c)},enterSide:function(){this.load&&this.load.enterSide&&this.load.enterSide()},leaveSide:function(){this.load&&this.load.leaveSide&&this.load.leaveSide()}}),IssuuPageFlipShadow=Class({create:function(b,c){this.parent=b;this.pageIndex=c;this.init()},init:function(){this.flipShadowContent=
$("<div style='pointer-events:none;width:100%;height:100%;position:absolute;z-index:100;left:0;top:0;'></div>");bookConfig.FlipDirection?(this.flipBackShadow=$("<div class='flip-vertical-shadowB'></div>"),this.flipFrontShadow=$("<div class='flip-vertical-topshadow'></div>")):(this.flipBackShadow=$("<div class='flip-shadowB'></div>"),this.flipFrontShadow=$("<div class='flip-topshadow'></div>"));this.flipShadowContent.append(this.flipBackShadow);this.flipShadowContent.append(this.flipFrontShadow);this.parent.append(this.flipShadowContent)},
setCSSByStyle:function(b){this.flipShadowContent.css(b)},flip:function(b,c,d){var e=b.shadowRate;d=b.rotate;var f=.9<e?1+2*(1-e)/.1:3*e/.9;if(isPhone()||isPad())f=1;e=.9<e?.2*(1-e)/.1:.1>e?.2*e/.1:.2;if(bookConfig.FlipDirection){var g=transformCSS({scaleY:f,rotate:-d,tran:{x:0,y:(b.frontShadowDistance-100*(90<d?0:f))/Math.cos(d*Math.PI/180)}});b=transformCSS({scaleY:f,rotate:d,tran:{x:-b.maskTranY,y:b.maskTranX}})}else g=transformCSS({scaleX:f,rotate:-d,tran:{x:(b.frontShadowDistance-100*(90<d?0:
f))/Math.cos(d*Math.PI/180),y:0}}),b=transformCSS({scaleX:f,rotate:d,tran:{x:b.maskTranX,y:b.maskTranY}});this.flipFrontShadow.css(g);this.flipBackShadow.css(b);this.beforeFlip(d,c);isPhone()||isPad()||(this.flipFrontShadow.css({opacity:e}),this.flipBackShadow.css({opacity:e}))},beforeFlip:function(b,c){c?(this.flipBackShadow&&this.flipBackShadow.css({visibility:"hidden"}),this.flipFrontShadow&&this.flipFrontShadow.css({visibility:"visible"})):(this.flipBackShadow&&this.flipBackShadow.css({visibility:"visible"}),
this.flipFrontShadow&&this.flipFrontShadow.css({visibility:"hidden"}));bookConfig.FlipDirection?(90<b?(this.flipFrontShadow.css({bottom:"0px"}),this.flipBackShadow.css({top:"100%"})):(this.flipFrontShadow.css({bottom:"auto"}),this.flipBackShadow.css({top:"0px"})),c=0<=b&&180>b?100/3:100*(this.width+this.maskWidth)/(3*this.maskWidth),b=90<b?100:0):(90<b?(this.flipFrontShadow.css({right:"0px"}),this.flipBackShadow.css({left:"100%"})):(this.flipFrontShadow.css({right:"auto"}),this.flipBackShadow.css({left:"0px"})),
c=90<b?100:0,b=0<=b&&180>b?100*(this.height+this.maskWidth)/(3*this.maskWidth):100/3);this.flipFrontShadow.css({"transform-origin":c+"% "+b+"%","-webkit-transform-origin":c+"% "+b+"%","-moz-transform-origin":c+"% "+b+"%","-ms-transform-origin":c+"% "+b+"%"})},clear:function(){this.flipBackShadow&&this.flipBackShadow.css({visibility:"hidden"});this.flipFrontShadow&&this.flipFrontShadow.css({visibility:"hidden"})},resize:function(b,c){this.width=b;this.height=c;this.maskWidth=parseInt(Math.sqrt(Math.pow(b,
2)+Math.pow(c,2)));bookConfig.FlipDirection?(this.flipFrontShadow.css({width:3*this.maskWidth,left:-this.maskWidth}),this.flipBackShadow.css({width:this.maskWidth,left:(this.width-this.maskWidth)/2})):(this.flipFrontShadow.css({height:3*this.maskWidth,top:-this.maskWidth}),this.flipBackShadow.css({height:this.maskWidth,top:(this.height-this.maskWidth)/2}))}});
...
l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,v){if(!b)return!1;var r=b.pageWidth,t=b.pageHeight,u=$.easing["easeInOut"+v],x=$.easing["easeOut"+v];v=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(v=u(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(t*t-v*v):t-f*Math.sqrt(r*r-v*v));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:v,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
templateArea.getBottomHeight();b&&(c+=rightToLeft?bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1):0,d+=rightToLeft?0:bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);b=getSideBookmarkColumnSpace(!1);c+=b.left;d+=b.right;return{left:c,right:d,top:e,bottom:f}},getTranX:function(b){if(!bookConfig.retainBookCenter)return 0;b=this.getCssLeft();var c=this.getSpace(!0);return c.left+(windowWidth-c.left-c.right-this.width)/
2-b},getTranY:function(){var b=this.getCssTop(),c=this.getSpace(!0);return c.top+(windowHeight-c.top-c.bottom-this.pageWidthHeight.y)/2-b}}).extend(FlipBook),IssuuDoubleFlipBook=Class({create:function(b){this._super(b)},newFlipPage:function(){return new IssuuDoubleFlipPage(this)},resetPages:function(b){isNaN(b)||0>=b||(b=this.getMinPageIndex(b),this.unWrapPageExcludeArray([b,b+1,b+2,b+3,b-1,b-2]),this.addPageArray([b,b+1,b+2,b+3,b-1,b-2]),this.currentPage=this.pageArray[b],this.currentPage2=this.pageArray[b+
1],this.nextPage=this.pageArray[b+2],this.nextPage2=this.pageArray[b+3],this.previousPage=this.pageArray[b-1],this.previousPage2=this.pageArray[b-2],this.setPageCss(),this.loading())},setPageCss:function(){this.currentPage&&(this.setZIndexByPageIndex(this.currentPage),this.currentPage.clearTran());this.previousPage&&(this.setZIndexByPageIndex(this.previousPage),this.previousPage.clearTran());this.previousPage2&&(this.setZIndexByPageIndex(this.previousPage2),this.previousPage2.clearTran());this.currentPage2&&
(this.setZIndexByPageIndex(this.currentPage2),this.currentPage2.clearTran());this.nextPage&&(this.setZIndexByPageIndex(this.nextPage),this.nextPage.clearTran());this.nextPage2&&(this.setZIndexByPageIndex(this.nextPage2),this.nextPage2.clearTran());rightToLeft?(this.currentPage&&this.currentPage.setLeftOrRight(!1),this.previousPage&&this.previousPage.setLeftOrRight(!1),this.previousPage2&&this.previousPage2.setLeftOrRight(!1),this.currentPage2&&this.currentPage2.setLeftOrRight(!0),this.nextPage&&this.nextPage.setLeftOrRight(!0),
this.nextPage2&&this.nextPage2.setLeftOrRight(!0)):(this.currentPage&&this.currentPage.setLeftOrRight(!0),this.previousPage&&this.previousPage.setLeftOrRight(!0),this.previousPage2&&this.previousPage2.setLeftOrRight(!0),this.currentPage2&&this.currentPage2.setLeftOrRight(!1),this.nextPage&&this.nextPage.setLeftOrRight(!1),this.nextPage2&&this.nextPage2.setLeftOrRight(!1))},getDownUpHardPage:function(b,c,d){this.addPageArray([b,c]);d?(this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-left-side"),
this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-right-side")):(this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-right-side"),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-left-side"));return[this.pageArray[b],this.pageArray[c]]},getDownUpPage:function(b,c){this.addPageArray([b,c]);this.pageArray[b]&&this.pageArray[b].beginToFlip();this.pageArray[c]&&this.pageArray[c].beginToFlip();this.pageArray[b]&&(this.pageArray[b].page.setCSSByName("right-flip-side"),this.setZIndexByPageIndex(this.pageArray[b]));
...
b=parseInt(c[0].x+c[1].x);c=parseInt(c[0].y);return{x:b,y:c}},getSpace:function(b){var c=bookConfig.leftMargin+templateArea.getLeftWidth(),d=bookConfig.rightMargin+templateArea.getRightWidth(),e=bookConfig.topMargin+templateArea.getTopHeight(),f=bookConfig.bottomMargin+templateArea.getBottomHeight();b&&(c+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),d+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);b=getSideBookmarkColumnSpace(!0);
c+=b.left;d+=b.right;return{left:c,right:d,top:e,bottom:f}},getMinPageIndex:function(b){return b=bookConfig.isTheBookOpen?2*Math.ceil(b/2)-1:2*Math.floor(b/2)},getMaxPageIndex:function(b){return b=bookConfig.isTheBookOpen?2*Math.ceil(b/2):2*Math.floor(b/2)+1},getTranX:function(b){if(!bookConfig.retainBookCenter)return 0;b=this.getCssLeft();var c=this.getSpace(!0);return c.left+(windowWidth-c.left-c.right-this.width)/2-b},getTranY:function(){var b=this.getCssTop(),c=this.getSpace(!0);return c.top+
(windowHeight-c.top-c.bottom-this.pageWidthHeight.y)/2-b}}).extend(FlipBook),IssuuBook=Class({bookType:BookType.normal_book,doublePage:!0,create:function(b){bookConfig.bookPageStretch=!0;this._super(b);this.resetZoomArea();bookConfig.supportSerialsFlip=!1},initBook:function(){this._super()},resetBookShadow:function(b){},hasTwoSingleFlipPage:function(b){for(var c=this.flipPageManager.array.length,d,e=0;e<c;e++){var f=this.flipPageManager.array[e],g=this.flipPageManager[f].nextIndex;f=this.flipPageManager[f].currentIndex;
1==BookInfo.getPagesByIndex(g).length&&(d=g);1==BookInfo.getPagesByIndex(f).length&&(d=f)}return d&&(d!=b&&1==BookInfo.getPagesByIndex(b).length||d!=this.currentPageIndex&&1==BookInfo.getPagesByIndex(this.currentPageIndex).length)?!0:!1},newPage:function(b){return new IssuuNormalPage(b,"page",!1,this.bookType)},flippingTo:function(b){this.currentPageIndex=b;this.currentPageIndex=Math.max(1,this.currentPageIndex);this.currentPageIndex=Math.min(originTotalPageCount,this.currentPageIndex);this.resetZoomArea()},
...
2,2,{x:1,y:1},{x:1,y:1},{x:100,y:50})},afterCurling:function(){this._super();this.getTranScaleByIndex(this.currentPageIndex);this.scalePages(BookInfo.getRightPages(this.currentPageIndex),2,2,{x:1,y:1},{x:1,y:1},{x:0,y:50});this.scalePages(BookInfo.getLeftPages(this.currentPageIndex),2,2,{x:1,y:1},{x:1,y:1},{x:100,y:50})},movetoCenter:function(b,c,d){if(bookConfig.retainBookCenter){var e=this.getMovedXByIndex(c).x-this.getMovedXByIndex(b).x,f=this.width;if(void 0==d||d>f)d=f;if(!isNaN(d)){this.movedLength=
d;var g=this.getFitWHByIndex(b),h=this.getFitWHByIndex(c);this.status_zoom&&(g=this.getFitWHByIndex(b,this.width,this.height),h=this.getFitWHByIndex(c,this.width,this.height));this.getFlipTo(c);var k=BookInfo.getMinPageIndex(b),l=BookInfo.getMaxPageIndex(b);if(bookConfig.RightToLeft)if(b<c){var m=this.scalePages([k,k-1,k-2],d,f,g[1],h[1],{x:0,y:50});k=this.scalePages([l,c],d,f,g[0],h[1],{x:100,y:50},!1,0,{x:-g[1].x,y:0});var p=this.scalePages([c+1],d,f,g[0],h[0],{x:100,y:50},!0,k);this.scalePages([c+
2],d,f,g[0],h[0],{x:100,y:50})}else k=this.scalePages([k,c],d,f,g[1],h[0],{x:100,y:50},!1,0,{x:-g[1].x,y:0}),m=this.scalePages([c-1],d,f,g[1],h[1],{x:0,y:50},!0,k),this.scalePages([c-2],d,f,g[1],h[1],{x:0,y:50}),p=this.scalePages([l,l+1,l+2],d,f,g[0],h[0],{x:100,y:50});else b<c?(p=this.scalePages([k,k-1,k-2],d,f,g[0],h[0],{x:100,y:50}),k=this.scalePages([l,c],d,f,g[1],h[0],{x:100,y:50},!1,0,{x:-g[1].x,y:0}),m=this.scalePages([c+1],d,f,g[1],h[1],{x:0,y:50},!0,k),this.scalePages([c+2],d,f,g[1],h[1],
{x:0,y:50})):(k=this.scalePages([k,c],d,f,g[0],h[1],{x:100,y:50},!1,0,{x:-g[1].x,y:0}),p=this.scalePages([c-1],d,f,g[0],h[0],{x:100,y:50},!0,k),this.scalePages([c-2],d,f,g[0],h[0],{x:100,y:50}),m=this.scalePages([l,l+1,l+2],d,f,g[1],h[1],{x:0,y:50}));this.movedX=$.easing.easeInOutSine(null,d,0,e+(h[0].x-g[0].x)-0,f);e={tran:{x:parseInt(this.movedX),y:0}};this.status_zoom||this.setCSS(e);this.bookAttachments.Items.find("ThicknessManager").each(function(q){q.leftThickness&&q.leftThickness.doSetMovingScale(b,
c,d,f,!1,p.y,(-p.x+1)*g[0].x);q.rightThickness&&q.rightThickness.doSetMovingScale(b,c,d,f,!1,m.y,(m.x-1)*g[1].x)}.bind(this));this.bookAttachments.Items.find("BookmarkTab").each(function(q){q.setScale(p.x,p.y,(-p.x+1)*g[0].x,(-p.y+1)*g[0].y/2,m.x,m.y,(m.x-1)*g[1].x,(-p.y+1)*g[1].y/2)}.bind(this))}}},getDownUpPage:function(b,c){this.addPageArray([b,c]);var d=this.getFitWHByIndex(this.currentPageIndex);d=transformCSS({tran:{x:-d[1].x,y:0},origin:{x:100,y:50}});this.pageArray[b]&&(this.pageArray[b].beginToFlip(),
this.dragToFlip||this.pageArray[b].setCSSByStyle(d));this.pageArray[c]&&(this.pageArray[c].beginToFlip(),this.dragToFlip||this.pageArray[c].setCSSByStyle(d));this.pageArray[b]&&(this.pageArray[b].page.setCSSByName("right-flip-side"),this.setZIndexByPageIndex(this.pageArray[b]));this.pageArray[c]&&(this.pageArray[c].page.setCSSByName("flip-side"),this.pageArray[c].page.side.addClass("boxShadow"),this.setZIndexByPageIndex(this.pageArray[c]));return[this.pageArray[b],this.pageArray[c]]},getMovedXByIndex:function(b){var c=
this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){try{var m=1,p=1;m=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);for(c=0;c<b.length;c++){var q=this.pageArray[b[c]];if(q){var v=transformCSS({tran:l?l:{x:0,y:0},scale:{x:m,y:p},origin:g});this.isCoverPage(b[c])&&(q.tran=l?l:{x:0,y:0},q.scale=
{x:m,y:p},q.rotateY?(q.$page[0].style.removeProperty("transform-origin"),d=void 0,v=transformCSS({scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})):(d=void 0,v=transformCSS({origin:g,scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})));q.setCSSByStyle(v);if(q.page.pageFlipShadow){var r=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});q.page.pageFlipShadow&&q.page.pageFlipShadow.setCSSByStyle(r)}}}return{x:m,y:p}}catch(t){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},
...
b.dataLayer=b.dataLayer||[];b.dataLayer.push({"gtm.start":(new Date).getTime(),event:"gtm.js"});b=document.getElementsByTagName("script")[0];var d=document.createElement("script");d.async=!0;d.src=googletagmanagerUrl+"/gtm.js?id="+c;b.parentNode.insertBefore(d,b)},3E3)};
...
function scrapOriginPageIndex(){window.realLocation=window.location.href.removeStartFrom("?");window.realLocation=realLocation.removeStartFrom("#");var b=parsePageIndexFromLocationHash(bookConfig.OriginPageIndex);b=Number.between(b,1,originTotalPageCount);if(bookConfig.restorePageVisible&&window.localStorage[realLocation+"?historyPageIndex"]){var c=parseInt(window.localStorage[realLocation+"?historyPageIndex"]),d=window.localStorage[realLocation+"?historySubmmit"];c!=b&&(bookConfig.isRestorePageFrameVisible?
(!d||31<d&&(new Date).getTime()-parseInt(d)>=bookConfig.restorePageDuration||31>=d&&(new Date).getDate()!=parseInt(d))&&showMessage(getLanguage("restorePage","Would you like to restore previous session"),function(){window.localStorage.setItem(realLocation+"?historySubmmit",(new Date).getTime());gotoPageFun(window.localStorage[realLocation+"?historyPageIndex"])},!1):setTimeout(function(){gotoPageFun(c)},300))}return b}
function getBookFaviconPower(){try{var b,c,d,e,f,g,h,k=[null==(b=window.tmpBookConfig)?void 0:null==(c=b.power_info)?void 0:c.power,null==(d=window.bookConfig)?void 0:null==(e=d.power_info)?void 0:e.power,null==(f=window.UserInfoUtils)?void 0:null==(g=f.getDecryptedPower)?void 0:g.call(f),null==(h=window.userInfo)?void 0:h.power];for(b=0;b<k.length;b++)if(Array.isArray(k[b]))return k[b];return null}catch(l){return null}}
function canUseFavicon(){var b=getBookFaviconPower();return Array.isArray(b)?b.some(function(c){return"string"!==typeof c?!1:(c=c.match(/^(.*)_(\d+)_(\d+)$/))&&"USE_FAVICON"===c[1]&&1===Number(c[2])&&0!==Number(c[3])}):!0}function setBookFavicon(){if(!canUseFavicon()){var b=document.querySelector('head link[rel~="icon"]');b&&b.removeAttribute("href")}}
...
window.getWidth(),windowHeight=c=window.getHeight(),windowWidth=b,e.yield(checkFliphtml5PagesConfig(),2);case 2:return e.yield(checkBookConfig(),3);case 3:return setBookFavicon(),e.yield(selectLanguage(bookConfig.language),4);case 4:return e.yield(validateDomainAccess(),5);case 5:d=e.yieldResult;if(!d)return e.return();initImageBaseUrl();global.onBookLoad=new LoadingBook(tmpContainer,bookConfig.loadingBackground);if("article4"===global.templeteName){e.jumpTo(6);break}return e.yield(initToolBarBrand(),
6);case 6:delayLoading();var f=document.getElementById("aria-page-title-header");if(f)var g=document.getElementById("aria-page-title");else f=document.createElement("header"),f.id="aria-page-title-header",f.setAttribute("aria-hidden","true"),f.style.cssText="position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);",g=document.createElement("h1"),g.id="aria-page-title",f.appendChild(g),document.body.appendChild(f);g&&(g.textContent=document.title);e.jumpToEnd()}})}
...
originTotalPageCount)}catch(c){}b.jumpToEnd()})}window.__fromBookcase=!1;(function(){try{window.parent!==window.self&&(window.addEventListener("message",function(b){try{b.data&&"FROM_BOOKCASE"===b.data.type&&-1<(new URL(b.origin)).hostname.indexOf("fliphtml5")&&(window.__fromBookcase=!0)}catch(c){}}),window.parent.postMessage({type:"BOOKCASE_QUERY"},"*"))}catch(b){}})();
function validateDomainAccess(b){function c(){try{window.__bookDomainAccessDenied=!0}catch(d){}$("body").empty().removeAttr("style");$("body").css({background:"#ffffff",color:"#000000","text-align":"center","font-size":"20px"}).append($("\n        <main role='main' class='domain-access-box' style='text-align:center;'>\n          <img alt='' style='margin-top:45px;width:98px;height:98px;' src='"+bookConfig.UIBaseURL+"style/icon/only-wechat.svg'/>\n          <h1 style='margin-top:35px;margin-bottom:0;font-size:20px;font-weight:normal;line-height:1.4;'>"+
bookConfig.OnlyOpenInIframeInfo+"</h1>\n        </main>\n      "))}b=void 0===b?5E3:b;return!window.location.href.includes("book_edit")&&bookConfig.OnlyOpenInIframe&&bookConfig.domainAccess&&bookConfig.domainAccess.length&&window.parent!=window.self&&bookConfig.enableDomainAccess&&"undefined"===typeof BookPreviewPublic&&!window.__fromBookcase?new Promise(function(d){function e(){var m=[];"string"===typeof bookConfig.domainAccess?m=bookConfig.domainAccess.replace(/\\n/g,"\n").split(/[,;\n\r]+/).map(function(p){return p.trim()}):
Array.isArray(bookConfig.domainAccess)&&(m=bookConfig.domainAccess.map(function(p){return p.trim()}));return m.map(function(p){return f(p)}).filter(function(p){return p})}function f(m){return m.replace(/^https?:\/\//,"").split(":")[0].split("/")[0].toLowerCase()}function g(m){return e().some(function(p){return p===f(m)})}function h(m){if(m.data&&"FROM_BOOKCASE"===m.data.type)try{-1<(new URL(m.origin)).hostname.indexOf("fliphtml5")&&(window.__fromBookcase=!0,clearTimeout(l),window.removeEventListener("message",
k),window.removeEventListener("message",h),d(!0))}catch(p){}}function k(m){m.data&&"PARENT_DOMAIN"===m.data.type&&(clearTimeout(l),window.removeEventListener("message",k),window.removeEventListener("message",h),g(m.origin)&&g(m.data.domain)?d(!0):(c(),d(!1)))}var l=setTimeout(function(){var m=document.referrer;m?g(m)?d(!0):(c(),d(!1)):d(!0)},b);window.addEventListener("message",k);window.addEventListener("message",h);try{window.parent!==window.self&&window.parent.postMessage({type:"BOOKCASE_QUERY"},
"*")}catch(m){}}):!0};Class("Item",{Package:"PageItem",create:function(b,c,d,e){this.parent=b;this.config=this.parseConfig(c);this.pageWidth=d;this.pageHeight=e;this.pw=d;this.ph=e;this.type=this.config.annotype},parseConfig:function(b){return b},animateConfig:function(){this.config.animation&&this.config.animation.name&&(this.config.animation.duration||(this.config.animation.duration=1),this.config.animation.timeFun||(this.config.animation.timeFun="ease"),this.config.animation.delay||(this.config.animation.delay=0),this.config.animation.count||
...
(function(b){function c(h,k){h=h.querySelectorAll("canvas");var l=k.querySelectorAll("canvas"),m=[];h.forEach(function(p,q){var v=l[q];if(v){v.width=p.width;v.height=p.height;p=p.toDataURL();var r=new Image;q=new Promise(function(t){r.onload=function(){v.getContext("2d").drawImage(r,0,0);t()};r.onerror=function(){return t()}});r.src=p;m.push(q)}});return Promise.all(m).then(function(){})}var d=0,e={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},f={};b.fn.printArea=function(h){b.extend(f,e,h);d++;b("[id^=printArea_]").remove();f.id="printArea_"+d;var k=b(this),l=g.getPrintWindow();g.write(l.doc,k);c(b(this)[0],l.doc).then(function(){function m(){q&&q();g.print(l)}var p=b(l.doc).find("img"),q=h&&"function"===typeof h.onReady?h.onReady:null;if(0===p.length)m();else{var v=0;p.each(function(r,t){if(t.complete)v++,v===p.length&&m();else b(t).on("load error",function(){v++;v===p.length&&
